export const PROVIDER_TEMPLATES = [
  ...
  { id: "together", name: "Together AI", icon: "together-color.svg", baseUrl: "https://api.together.ai/v1" },
  { id: "fireworks", name: "Fireworks AI", icon: "fireworks.svg", baseUrl: "https://api.fireworks.ai/inference/v1" },
  { id: "mistral", name: "Mistral AI", icon: "mistral-color.svg", baseUrl: "https://api.mistral.ai/v1" },
  ...
  { id: "hyperbolic", name: "Hyperbolic", icon: "hyperbolic-color.svg", baseUrl: "https://api.hyperbolic.xyz/v1" },
  { id: "minimax", name: "MiniMax", icon: "minimax-color.svg", baseUrl: "https://api.minimax.chat/v1" },
  { id: "nvidia", name: "NVIDIA", icon: "nvidia.svg", baseUrl: "https://integrate.api.nvidia.com/v1" },
  { id: "sambanova", name: "SambaNova", icon: "sambanova-color.svg", baseUrl: "https://api.sambanova.ai/v1" },
