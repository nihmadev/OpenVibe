...
/** Generic icon component type — used to store icons in maps, pass as props, etc. */
...
/** Copy icon that flips to a success checkmark when `copied` is true. */
export function CopyCheckIcon({ copied }: { copied: boolean }): React.ReactElement {
  if (copied) {
    return (
      <svg
        width="14"
...
// ── Stroke icons (size / strokeWidth configurable) ──────────────────────────
