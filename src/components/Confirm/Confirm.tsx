  ...
  return (
    <div className="confirm">
      ...
      <div className="confirm__buttons">
        <button className="confirm__btn confirm__btn--yes" onClick={() => onDecide("yes")}>
          <kbd>Y</kbd> {t("yesRun")}
        </button>
        <button className="confirm__btn confirm__btn--always" onClick={() => onDecide("always")}>
          <kbd>A</kbd> {t("alwaysAllow")}
        </button>
        <button className="confirm__btn confirm__btn--no" onClick={() => onDecide("no")}>
          <kbd>N</kbd> {t("noSkip")}
        </button>
      </div>
    </div>
