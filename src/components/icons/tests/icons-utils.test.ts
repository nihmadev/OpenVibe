...
import { getFileIcon, getLanguage, getFolderIcon } from "../../components/icons/utils";
...
describe("getFolderIcon", () => {
  ...
  it("returns folder-open.svg for known open folder", () => {
    expect(getFolderIcon("src", true)).toBe("folder-open.svg");
    expect(getFolderIcon("utils", true)).toBe("folder-open.svg");
  });
