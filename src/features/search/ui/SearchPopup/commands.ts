...
export const commands: CommandItem[] = [
  {
    ...
    labelKey: "newSession",
    shortcut: "Ctrl+N",
    keywords: ["new session", "new chat", "новая сессия", "новый чат"],
  },
  {
    id: "prev-session",
  ...
  },
  {
    ...
    shortcut: "Ctrl+`",
    keywords: ["toggle terminal", "terminal", "терминал", "переключить терминал"],
  },
  {
    id: "close-terminal",
  ...
  },
  {
    ...
    keywords: ["show file tree", "open file tree", "показать дерево файлов", "открыть дерево файлов"],
  },
  {
    id: "hide-file-tree",
    labelKey: "hideFileTree",
    keywords: ["hide file tree", "close file tree", "скрыть дерево файлов", "закрыть дерево файлов"],
  },
  {
    id: "toggle-file-tree",
    labelKey: "toggleFileTree",
    shortcut: "Ctrl+Shift+E",
    keywords: ["toggle file tree", "file tree", "дерево файлов", "переключить дерево файлов"],
  },
  {
    id: "toggle-chat-side",
  ...
  },
  {
    ...
    shortcut: "Ctrl+,",
    keywords: ["open settings", "settings", "настройки", "открыть настройки"],
  },
  {
    id: "close-project",
  ...
  },
  {
    ...
    keywords: ["new project", "open project", "новый проект", "открыть проект"],
  },
  {
    id: "close-file",
