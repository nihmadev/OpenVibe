...
import { activeChatId, setActiveChatId } from "@/infrastructure/tauri/state";
import type { ChatMessage, ChatRecord, ChatSummary } from "../model/chat";
