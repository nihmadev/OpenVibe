...
import { CloseXIcon, UploadIcon } from "@/base/browser/ui/icons/iconRegistry";
...
export function EditWorkspaceDialog({ project, onSave, onClose }: EditWorkspaceDialogProps): React.ReactElement {
  ...
  const handleSave = async () => {
    ...
    await workspaceService.setColor(project.id, color);
    await workspaceService.setPhoto(project.id, photo || null);
    await workspaceService.setIcon(project.id, null);
    onSave();
  };
