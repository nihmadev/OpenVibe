...
import { EyeIcon, EyeOffIcon, PlusIcon, TrashIcon } from "@/base/browser/ui/icons/iconRegistry";
import { useI18n } from "@/platform/localization/localizationService";
import { ProviderLogo } from "../../../../services/aiProviders/browser/providerLogo";
import { PROVIDER_TEMPLATES } from "../../../../services/aiProviders/browser/providerTemplates";
import type { KeyValuePair, Provider } from "../../../../services/aiProviders/common/aiProvider";
        ...
        <div className="connect-popup__header">
          {(hasCustomIcon || editIcon || template) && (
            <div className="connect-popup__icon-wrap">
              <ProviderLogo
                icon={form.customIcon || editIcon || template?.icon}
                providerId={template?.id || editProvider?.id}
