...
import type { SearchViewProps } from "../common/search";
import { SearchFileGroup } from "./components/searchFileGroup";
import { SearchFilterBar } from "./components/searchFilterBar";
import { SearchMatchRowMemo } from "./components/searchMatchRow";
import { SearchTreeView } from "./components/searchTreeView";
import { getLanguageFromFilename } from "./highlighting/searchSyntax";
import { useCodeSearch } from "./useCodeSearch";

export function SearchView({ cwd, onOpenFile, onClose }: SearchViewProps): React.ReactElement {
