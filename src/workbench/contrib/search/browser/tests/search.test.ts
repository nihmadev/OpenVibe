...
import type { ContentMatch } from "@/workbench/services/files/common/files";
import {
  buildTree,
  computeTreeNodes,
  filterResults,
...
import { getLanguageFromFilename, LRU, syntaxHighlightLine, tokenizeLine } from "../highlighting/searchSyntax";
