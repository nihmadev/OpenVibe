...
import { getFileIcon, getFolderIcon, getLanguage } from "../iconResolver";
...
describe("getFolderIcon", () => {
  ...
  it("resolves folder icons from paths", () => {
    expect(getFolderIcon("src/components", false)).toBe("folder-app.svg");
    expect(getFolderIcon("@src\\components", false)).toBe("folder-app.svg");
  });
