define("vs/mdx-DEWtB1K5", ["exports", "./editor.api-CalNCsUg"], function (t, e) {
  ...
  const o = {
      ...
      onEnterRules: [
        { beforeText: /^\s*- .+/, action: { indentAction: e.languages.IndentAction.None, appendText: "- " } },
        { beforeText: /^\s*\+ .+/, action: { indentAction: e.languages.IndentAction.None, appendText: "+ " } },
        { beforeText: /^\s*\* .+/, action: { indentAction: e.languages.IndentAction.None, appendText: "* " } },
        { beforeText: /^> /, action: { indentAction: e.languages.IndentAction.None, appendText: "> " } },
  ...
  ((t.conf = o), (t.language = i), Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }));
});
