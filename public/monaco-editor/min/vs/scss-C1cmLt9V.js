...
\r\f]*`,
      ...
      tokenizer: {
        ...
        units: [
          ["(em|ex|ch|rem|fr|vmin|vmax|vw|vh|vm|cm|mm|in|px|pt|pc|deg|grad|rad|turn|s|ms|Hz|kHz|%)?", "number", "@pop"],
        ],
        functiondeclaration: [
  ...
  ((e.conf = t), (e.language = n), Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }));
});
