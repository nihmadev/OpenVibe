      ...
      static getHighPerformanceTimestamp() {
        return (
          this.PERFORMANCE_NOW_PROBED ||
            ...
            (this.HAS_PERFORMANCE_NOW = W.global.performance && typeof W.global.performance.now == "function")),
        ...
        if (!W.Utilities.endsWith(f, ".js") && !W.Utilities.isAbsolutePath(f)) {
          ...
          for (let c = 0, a = p.length; c < a; c++)
            (this.isBuild() && p[c] === "empty:") ||
              ...
              !W.Utilities.endsWith(p[c], ".js") && !W.Utilities.containsQueryString(p[c]) && (p[c] = p[c] + ".js"));
      ...
      requireToUrl(d) {
        ...
        return (
          W.Utilities.isAbsolutePath(f) ||
            ((f = this._applyPaths(f)[0]), W.Utilities.isAbsolutePath(f) || (f = this.options.baseUrl + f)),
    ...
    class A {
      ...
      load(a, m, e, h) {
        if (/^node\|/.test(m)) {
          ...
          if (
            !(/^((http:)|(https:)|(file:))/.test(m) && m.substring(0, self.origin.length) !== self.origin) &&
            this._canUseEval(a)
          ) {
            fetch(m)
              .then((o) => {
...
//# sourceURL=${m}`),
    ...
    class d {
      ...
      _createAndEvalScript(a, m, e, h, r) {
        ...
        return (
          (N.amd = S.amd),
          u.call(W.global, a.getGlobalAMDRequireFunc(), N, e.filename, this._path.dirname(e.filename)),
      ...
      _createAndWriteCachedData(a, m, e, h) {
        let r = Math.ceil(h.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
          s = -1,
          o = 0,
          u;
        const S = () => {
        ...
        if (!m) this._fs.readFile(a, { encoding: "utf8" }, h);
          ...
          (this._fs.readFile(a, { encoding: "utf8" }, (L, N) => {
            ...
            this._fs.readFile(m, (L, N) => {
              (!L && N && N.length > 0 ? ((o = N.slice(0, 16)), (s = N.slice(16)), e.record(60, m)) : e.record(61, m),
                S());
            }));
        }
      }
  ...
  (function (W) {
    ...
    class x {
      ...
      getModuleId(c) {
        ...
        return (
          typeof a > "u" &&
            ((a = this._nextId++), this._strModuleIdToIntModuleId.set(c, a), (this._intModuleIdToStrModuleId[a] = c)),
          a
        );
      }
      getStrModuleId(c) {
    ...
    class f {
      ...
      configure(c, a) {
        ...
        (a ? (this._config = new W.Configuration(this._env, c)) : (this._config = this._config.cloneAndMerge(c)),
      ...
      _onLoad(c) {
        if (this._currentAnonymousDefineCall !== null) {
          ...
          ((this._currentAnonymousDefineCall = null),
            this.defineModule(this._moduleIdProvider.getStrModuleId(c), a.dependencies, a.callback, null, a.stack));
        }
      }
      ...
      _onLoadError(c, a) {
        ...
        this._modules2[c] ||
          (this._modules2[c] = new i(c, this._moduleIdProvider.getStrModuleId(c), [], () => {}, null, null));
        let e = [];
  ...
  ((function (W) {
    ...
    ((W.init = f),
      (typeof W.global.define != "function" || !W.global.define.amd) &&
        ((i = new W.ModuleManager(n, W.createScriptLoader(n), x, d, W.Utilities.getHighPerformanceTimestamp())),
        typeof W.global.require < "u" && typeof W.global.require != "function" && d.config(W.global.require),
        (X = function () {
    ...
    (function () {
      ...
      function d() {
        return new Promise((e, h) => {
          ...
          if (
            !(
              /^((http:)|(https:)|(file:))/.test(r) && r.substring(0, globalThis.origin.length) !== globalThis.origin
            ) &&
            A()
          ) {
            fetch(r)
    ...
    X(J[40], Z([0, 1]), function (W, n) {
      ...
      class A {
        ...
        static _hue2rgb(c, a, m) {
          return (
            m < 0 && (m += 1),
            m > 1 && (m -= 1),
            m < 1 / 6 ? c + (a - c) * 6 * m : m < 1 / 2 ? a : m < 2 / 3 ? c + (a - c) * (2 / 3 - m) * 6 : c
          );
        }
        static toRGBA(c) {
          const a = c.h / 360,
      ...
      class f {
        ...
        makeOpaque(c) {
          ...
          const { r: a, g: m, b: e, a: h } = this.rgba;
          return new f(
            new x(c.rgba.r - h * (c.rgba.r - a), c.rgba.g - h * (c.rgba.g - m), c.rgba.b - h * (c.rgba.b - e), 1),
          );
        }
        toString() {
...
` +
    ...
    X(J[19], Z([0, 1]), function (W, n) {
      ...
      (function (x) {
        ...
        function* P(l, b, g = l.length) {
          for (b < 0 && (b += l.length), g < 0 ? (g += l.length) : g > l.length && (g = l.length); b < g; b++)
            yield l[b];
        }
        x.slice = P;
      ...
      (function () {
        ...
        for (const o of h) {
          ...
          if (
            ...
            if (((r[N] = !0), !P))
              throw new Error(`String representation missing for key code ${N} around scan code ${L}`);
          ...
          if (d.prev !== i.Undefined && d.next !== i.Undefined) {
            ...
            d.prev === i.Undefined && d.next === i.Undefined
              ...
              : d.next === i.Undefined
                ...
                : d.prev === i.Undefined && ((this._first = this._first.next), (this._first.prev = i.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let d = this._first;
        ...
        touch(r, s) {
          ...
          if (!(s !== 1 && s !== 2)) {
            if (s === 1) {
              ...
              const o = r.next,
                u = r.previous;
              (r === this._tail ? ((u.next = void 0), (this._tail = u)) : ((o.previous = u), (u.next = o)),
                (r.previous = void 0),
                (r.next = this._head),
              ...
              const o = r.next,
                u = r.previous;
              (r === this._head ? ((o.previous = void 0), (this._head = o)) : ((o.previous = u), (u.next = o)),
                (r.next = void 0),
    ...
    X(J[22], Z([0, 1]), function (W, n) {
      ...
      class x {
        ...
        constructor(d) {
          ((this._now = i && d === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
          ...
          ((this._size = 0),
            ...
            (this._leakageMon =
              h > 0 || this._options?.leakWarningThreshold
                ? new r(R?.onListenerError ?? i.onUnexpectedError, this._options?.leakWarningThreshold ?? h)
                : void 0),
...
`,
        ...
        _removeListener(R) {
          ...
          if (this._size * L <= D.length) {
            ...
            for (let j = 0; j < D.length; j++)
              D[j]
                ? (D[z++] = D[j])
                : O && (this._deliveryQueue.end--, z < this._deliveryQueue.i && this._deliveryQueue.i--);
            D.length = z;
          }
        }
        _deliver(R, D) {
      ...
      class _ {
        ...
        set input(R) {
          ((this.inputEvent = R),
            this.listening &&
              (this.inputEventListener.dispose(), (this.inputEventListener = R(this.emitter.fire, this.emitter))));
        }
        dispose() {
      ...
      (function (c) {
        function a(m) {
          return m === c.None || m === c.Cancelled || m instanceof d
            ...
            : !m || typeof m != "object"
              ? !1
              : typeof m.isCancellationRequested == "boolean" && typeof m.onCancellationRequested == "function";
        }
        ((c.isCancellationToken = a),
          (c.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: i.Event.None })),
      ...
      class f {
        ...
        dispose(a = !1) {
          (a && this.cancel(),
            ...
            this._token ? this._token instanceof d && this._token.dispose() : (this._token = A.None));
        }
      }
    ...
    X(J[6], Z([0, 1, 39, 43]), function (W, n, i, x) {
      ...
      function o(k, I, V = {}) {
        ...
        (I || (k = a(k)),
          V.wholeWord &&
            (/\B/.test(k.charAt(0)) || (k = "\\b" + k), /\B/.test(k.charAt(k.length - 1)) || (k = k + "\\b")));
        let H = "";
        return (
          V.global && (H += "g"),
          V.matchCase || (H += "i"),
              ...
              : L < 2048
                ...
                : L < 65536
                  ...
                  : ((u[S++] = 240 | ((L & 1835008) >>> 18)),
                    ...
                    (u[S++] = 128 | ((L & 63) >>> 0))),
            S >= 64 &&
              (this._step(), (S -= 64), (this._totalLen += 64), (u[0] = u[64]), (u[1] = u[65]), (u[2] = u[66])),
            S
          );
        }
        digest() {
        ...
        _step() {
          ...
          for (let w = 64; w < 320; w += 4)
            u.setUint32(
              w,
              m(
                u.getUint32(w - 12, !1) ^ u.getUint32(w - 32, !1) ^ u.getUint32(w - 56, !1) ^ u.getUint32(w - 64, !1),
                1,
              ),
              !1,
            );
    ...
    X(J[24], Z([0, 1, 41, 44]), function (W, n, i, x) {
      ...
      class c {
        ...
        MarkNextChange() {
          ((this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
            this.m_changes.push(
              new i.DiffChange(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
            ),
            (this.m_originalCount = 0),
            (this.m_modifiedCount = 0),
            (this.m_originalStart = 1073741824),
      ...
      class a {
            ...
            do {
              ...
              (F === D || (F < T && P[F - 1] >= P[F + 1])
                ...
                : ((E = P[F - 1]),
                  ...
                  (O = F - 1 - o)),
                j >= 0 && ((P = this.m_reverseHistory[j]), (o = P[0]), (D = 1), (T = P.length - 1)));
            } while (--j >= -1);
            C = R.getChanges();
          }
        ...
        ComputeRecursionPoint(e, h, r, s, o, u, S) {
          ...
          for (let O = 1; O <= b / 2 + 1; O++) {
            ...
            for (let q = P; q <= E; q += 2) {
              ...
              if (((w[q] = L), L + N > z + j && ((z = L), (j = N)), !T && Math.abs(q - _) <= O - 1 && L >= M[q]))
                return (
                  (o[0] = L),
                  (u[0] = N),
                  B <= M[q] && O <= 1448 ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S) : null
                );
            }
            const F = (z - e + (j - r) - O) / 2;
            if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(z, F))
              return (
                (S[0] = !0),
                (o[0] = z),
                (u[0] = j),
            ...
            for (let q = v; q <= l; q += 2) {
              ...
              if (((M[q] = L), T && Math.abs(q - y) <= O && L <= w[q]))
                return (
                  (o[0] = L),
                  (u[0] = N),
                  B >= w[q] && O <= 1448 ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S) : null
                );
            }
            if (O <= 1447) {
        ...
        PrettifyChanges(e) {
          for (let h = 0; h < e.length; h++) {
            ...
            for (
              ...
              (!u || this.OriginalElementsAreEqual(r.originalStart, r.originalStart + r.originalLength)) &&
              (!S || this.ModifiedElementsAreEqual(r.modifiedStart, r.modifiedStart + r.modifiedLength));
            ) {
          ...
          for (let h = e.length - 1; h >= 0; h--) {
            ...
            const u = r.originalLength > 0,
              S = r.modifiedLength > 0;
            let L = 0,
              N = this._boundaryScore(r.originalStart, r.originalLength, r.modifiedStart, r.modifiedLength);
            for (let E = 1; ; E++) {
          ...
          if (this._hasStrings)
            for (let h = 1, r = e.length; h < r; h++) {
              ...
              if (u < 5 && N < 20 && v < 20) {
                ...
                if (l) {
                  const [b, g] = l;
                  (b !== s.originalStart + s.originalLength || g !== s.modifiedStart + s.modifiedLength) &&
        ...
        ChangesOverlap(e, h, r) {
          if (
            (f.Assert(e.originalStart <= h.originalStart, "Left change is not less than or equal to right change"),
            f.Assert(e.modifiedStart <= h.modifiedStart, "Left change is not less than or equal to right change"),
    ...
    X(J[25], Z([0, 1]), function (W, n) {
      ...
      function x(u) {
        return (
          typeof u == "object" && u !== null && !Array.isArray(u) && !(u instanceof RegExp) && !(u instanceof Date)
        );
      }
      function A(u) {
        ...
        return (0, i.isObject)(r)
          ? ((0, i.isObject)(s) &&
              Object.keys(s).forEach((u) => {
                u in r
                  ? o && ((0, i.isObject)(r[u]) && (0, i.isObject)(s[u]) ? c(r[u], s[u], o) : (r[u] = s[u]))
                  : (r[u] = s[u]);
              }),
            r)
          : s;
    ...
    X(J[2], Z([0, 1, 4]), function (W, n, i) {
      ...
      class x {
        constructor(d, f, p, c) {
          d > p || (d === p && f > c)
            ? ((this.startLineNumber = p), (this.startColumn = c), (this.endLineNumber = d), (this.endColumn = f))
            : ((this.startLineNumber = d), (this.startColumn = f), (this.endLineNumber = p), (this.endColumn = c));
        }
        isEmpty() {
      ...
      class f {
        ...
        static join(a) {
          ...
          for (let h = 1; h < a.length; h++)
            ((m = Math.min(m, a[h].startLineNumber)), (e = Math.max(e, a[h].endLineNumberExclusive)));
          return new f(m, e);
        }
        static ofLength(a, m) {
          return new f(a, a + m);
        ...
        toInclusiveRange() {
          return this.isEmpty
            ? null
            : new A.Range(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
        }
        toExclusiveRange() {
          ...
          for (; e < this._normalizedRanges.length || h < a._normalizedRanges.length;) {
            ...
            r === null
              ...
              : r.endLineNumberExclusive >= s.startLineNumber
                ? (r = new f(r.startLineNumber, Math.max(r.endLineNumberExclusive, s.endLineNumberExclusive)))
                : (m.push(r), (r = s));
          }
...
`
        ...
        createRange(f) {
          return this.lineCount === 0
            ...
            : new x.Range(f.lineNumber, f.column, f.lineNumber + this.lineCount, this.columnCount + 1);
        }
        addToPosition(f) {
          return this.lineCount === 0
    ...
    X(J[10], Z([0, 1, 7, 3, 5]), function (W, n, i, x, A) {
      ...
      class f {
            ...
            (0, i.forEachAdjacent)(e, (s, o) => {
              r.push(
                f.fromOffsetPairs(
                  ...
                  o ? o.getStarts() : new p(h, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + h),
                ),
              );
            }),
            r
        ...
        static assertSorted(e) {
          let h;
          for (const r of e) {
            if (h && !(h.seq1Range.endExclusive <= r.seq1Range.start && h.seq2Range.endExclusive <= r.seq2Range.start))
        ...
        compute(a, m, e = x.InfiniteTimeout.instance) {
          ...
          e: for (;;) {
            ...
            for (L = l; L <= b; L += 2) {
              ...
              if ((S.set(L, C !== y ? new d(R, y, _, C - y) : R), u.get(L) === h.length && u.get(L) - L === r.length))
                break e;
            }
          }
          let N = S.get(L);
          ...
          for (;;) {
            const l = N ? N.x + N.length : 0,
              b = N ? N.y + N.length : 0;
            if (
              ((l !== E || b !== v) && P.push(new x.SequenceDiff(new i.OffsetRange(l, E), new i.OffsetRange(b, v))), !N)
            )
              break;
    ...
    X(J[52], Z([0, 1, 7, 5, 10]), function (W, n, i, x, A) {
        ...
        for (let N = 1; N < u.length; N++) {
          ...
          if (E.seq1Range.isEmpty || E.seq2Range.isEmpty) {
            ...
            for (
              ...
              l <= v &&
              !(
                s.getElement(E.seq1Range.start - l) !== s.getElement(E.seq1Range.endExclusive - l) ||
      ...
      function a(s, o, u) {
        ...
        for (const L of u) {
          ...
          L.seq1Range.start - N.seq1Range.endExclusive <= 2 || L.seq2Range.start - N.seq2Range.endExclusive <= 2
            ? (S[S.length - 1] = new A.SequenceDiff(N.seq1Range.join(L.seq1Range), N.seq2Range.join(L.seq2Range)))
            : S.push(L);
        }
        return S;
      }
          ...
          for (let E = 1; E < S.length; E++) {
            let b = function (w, M) {
              ...
              return (
                ...
                (w.seq1Range.length + w.seq2Range.length > 5 || M.seq1Range.length + M.seq2Range.length > 5)
              );
            };
            const v = S[E],
              l = P[P.length - 1];
      ...
      class p {
        ...
        translateOffset(r, s = "right") {
          ...
          return new A.Position(
            ...
            1 + this.lineStartOffsets[o] + u + (u === 0 && s === "left" ? 0 : this.trimmedWsLengthsByLineIdx[o]),
          );
        }
        translateRange(r) {
        ...
        extendToFullLines(r) {
          const s = (0, i.findLastMonotonous)(this.firstElementOffsetByLineIdx, (u) => u <= r.start) ?? 0,
            o =
              (0, i.findFirstMonotonous)(this.firstElementOffsetByLineIdx, (u) => r.endExclusive <= u) ??
      ...
      class p {
        ...
        toRangeMapping() {
          ...
          if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
            ...
            return new e(
              new d.Range(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
        ...
        toRangeMapping2(r, s) {
          if (a(this.original.endLineNumberExclusive, r) && a(this.modified.endLineNumberExclusive, s))
            return new e(
              new d.Range(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
              new d.Range(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
            );
          if (!this.original.isEmpty && !this.modified.isEmpty)
            return new e(
              d.Range.fromPositions(
                ...
                c(new A.Position(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), r),
              ),
              d.Range.fromPositions(
                new A.Position(this.modified.startLineNumber, 1),
                c(new A.Position(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), s),
              ),
            );
          if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
            return new e(
        ...
        static assertSorted(r) {
          for (let s = 1; s < r.length; s++) {
            const o = r[s - 1],
              u = r[s];
            if (!(
              o.originalRange.getEndPosition().isBeforeOrEqual(u.originalRange.getStartPosition()) &&
...
`).length >= 15 && r(C, (D) => D.length >= 2) >= 2
      ...
      function s(N, P, E, v) {
        ...
        for (const M of b) {
          ...
          if (
            (y > 0.9 &&
              _ &&
              (g.delete(_), l.push(new x.LineRangeMapping(M.range, _.range)), w.add(M.source), w.add(_.source)),
            !v.isValid())
          )
      ...
      function o(N, P, E, v, l, b) {
        const g = [],
          w = new f.SetMap();
        for (const R of N)
          for (let D = R.original.startLineNumber; D < R.original.endLineNumberExclusive - 2; D++) {
        ...
        for (let R = 0; R < g.length; R++) {
          const D = g[R],
            T = C.findLastMonotonous(($) => $.original.startLineNumber <= D.original.startLineNumber),
          ...
          B > 0 &&
            (_.addRange(new p.LineRange(D.original.startLineNumber - B, D.original.startLineNumber)),
            y.addRange(new p.LineRange(D.modified.startLineNumber - B, D.modified.startLineNumber)));
          let G;
          for (G = 0; G < q; G++) {
          ...
          (G > 0 &&
            (_.addRange(new p.LineRange(D.original.endLineNumberExclusive, D.original.endLineNumberExclusive + G)),
            y.addRange(new p.LineRange(D.modified.endLineNumberExclusive, D.modified.endLineNumberExclusive + G))),
            (B > 0 || G > 0) &&
              (g[R] = new x.LineRangeMapping(
                new p.LineRange(D.original.startLineNumber - B, D.original.endLineNumberExclusive + G),
                new p.LineRange(D.modified.startLineNumber - B, D.modified.endLineNumberExclusive + G),
              )));
        }
        return g;
      }
      ...
      function L(N, P) {
        ...
        return (
          (P = P.filter((v) => {
            const l =
                E.findLastMonotonous((w) => w.original.startLineNumber < v.original.endLineNumberExclusive) ||
          ...
          computeDiff(E, v, l) {
            ...
            if ((E.length === 1 && E[0].length === 0) || (v.length === 1 && v[0].length === 0))
              return new s.LinesDiff(
                [
                  new o.DetailedLineRangeMapping(new A.LineRange(1, E.length + 1), new A.LineRange(1, v.length + 1), [
                    new o.RangeMapping(
            ...
            const b =
                l.maxComputationTimeMs === 0 ? p.InfiniteTimeout.instance : new p.DateTimeout(l.maxComputationTimeMs),
              ...
              D =
                C.length + R.length < 1700
                  ? this.dynamicProgrammingDiffing.compute(C, R, b, ($, U) =>
                      E[$] === v[U] ? (v[U].length === 0 ? 0.1 : 1 + Math.log(1 + v[U].length)) : 0.99,
                    )
                  ...
                  for (let U = 0; U < $; U++) {
                    ...
                    if (E[ee] !== v[re]) {
                      const ue = this.refineDiff(
                        E,
                        v,
                        new p.SequenceDiff(new d.OffsetRange(ee, ee + 1), new d.OffsetRange(re, re + 1)),
                        b,
                        g,
                      );
      ...
      class r {
        ...
        toString() {
          return (
            ...
            this._charCodes
              .map(
                (v, l) =>
                  (v === 10 ? "\\n" : String.fromCharCode(v)) + `-(${this._lineNumbers[l]},${this._columns[l]})`,
              )
              .join(", ") +
            "]"
          );
        ...
        getEndColumn(v) {
          return v === -1
            ...
            : (this._assertIndex(v, this._columns), this._charCodes[v] === 10 ? 1 : this._columns[v] + 1);
        }
      }
      class s {
      ...
      class u {
        ...
        static createFromDiffResult(v, l, b, g, w, M, y) {
          ...
          if (
            ...
            M && l.originalLength > 0 && l.originalLength < 20 && l.modifiedLength > 0 && l.modifiedLength < 20 && w())
          ) {
      ...
      class S {
        constructor(v, l, b) {
          ((this.shouldComputeCharChanges = b.shouldComputeCharChanges),
            ...
            (this.continueCharDiff = P(b.maxComputationTime === 0 ? 0 : Math.min(b.maxComputationTime, 5e3))));
        }
        computeDiff() {
          ...
          const v = e(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
            l = v.changes,
            b = v.quitEarly;
        ...
        _mergeTrimWhitespaceCharChange(v, l, b, g, w, M, y) {
          ...
          return C.originalEndLineNumber === 0 || C.modifiedEndLineNumber === 0
            ...
            : C.originalEndLineNumber === l && C.modifiedEndLineNumber === w
              ? (this.shouldComputeCharChanges && C.charChanges && C.charChanges.push(new s(l, b, l, g, w, M, w, y)),
                !0)
        ...
        constructor(s) {
          ((this._textModelResolvedOptionsBrand = void 0),
            ...
            s.indentSize === "tabSize"
              ...
              : ((this.indentSize = Math.max(1, s.indentSize | 0)), (this._indentSizeIsTabSize = !1)),
      ...
      class A {
        ...
        setValue(c, a) {
          return (
            ...
            this.values[c] === a
              ? !1
              : ((this.values[c] = a), c - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = c - 1), !0)
          );
        }
        removeValues(c, a) {
        ...
        getIndexOf(c) {
          ...
          let a = 0,
            ...
            r = 0;
          for (; a <= m;)
            if (((e = (a + (m - a) / 2) | 0), (h = this.prefixSum[e]), (r = h - this.values[e]), c < r)) m = e - 1;
            else if (c >= h) a = e + 1;
            else break;
          return new f(e, c - r);
        }
      ...
      class d {
        ...
        onEvents(p) {
          ...
          for (const a of c)
            (this._acceptDeleteRange(a.range),
              this._acceptInsertText(new x.Position(a.range.startLineNumber, a.range.startColumn), a.text));
        ...
        _acceptInsertText(p, c) {
          ...
          ((a[a.length - 1] += this._lines[p.lineNumber - 1].substring(p.column - 1)),
            this._setLineText(p.lineNumber - 1, this._lines[p.lineNumber - 1].substring(0, p.column - 1) + a[0]));
          const m = new Uint32Array(a.length - 1);
          for (let e = 1; e < a.length; e++)
            (this._lines.splice(p.lineNumber + e - 1, 0, a[e]), (m[e - 1] = a[e].length + this._eol.length));
...
`) >= 0);
          ...
          return (
            P && this.searchString.toLowerCase() !== this.searchString.toUpperCase() && (P = this.matchCase),
            new f.SearchData(
              N,
...
`
          ...
          for (P.reset(0); (y = P.next(b));)
            if (((w[M++] = m(this._getMultilineMatchRange(L, l, b, g, y.index, y[0]), y, E)), M >= v)) return w;
          return w;
        }
        ...
        static _findMatchesInLine(L, N, P, E, v, l, b, g) {
          ...
          if (!b && L.simpleSearch) {
            ...
            for (; (D = N.indexOf(_, D + C)) !== -1;)
              if (
                (!w || o(w, N, R, D, C)) &&
                ((l[v++] = new f.FindMatch(new d.Range(P, D + 1 + E, P, D + 1 + C + E), null)), v >= g)
              )
                return v;
            return v;
          }
          ...
          do
            if (
              ((y = M.next(N)),
              y && ((l[v++] = m(new d.Range(P, y.index + 1 + E, P, y.index + 1 + y[0].length + E), y, b)), v >= g))
            )
              return v;
          while (y);
          return v;
...
`
      ...
      class u {
        ...
        next(L) {
          ...
          let P;
          do {
            if (this._prevMatchStartIndex + this._prevMatchLength === N || ((P = this._searchRegex.exec(L)), !P))
              return null;
            const E = P.index,
              v = P[0].length;
            ...
            case 3: {
              const u = h.codePointAt(0),
                ...
                L = A.AmbiguousCharacters.getLocales().filter(
                  (N) => !A.AmbiguousCharacters.getInstance(new Set([...r.allowedLocales, N])).isAmbiguous(u),
                );
      ...
      class a {
        constructor(h) {
          ((this.options = h),
            ...
            (this.ambiguousCharacters = A.AmbiguousCharacters.getInstance(new Set(h.allowedLocales))));
        }
        getCandidateCodePoints() {
          if (this.options.nonBasicASCII) return "allNonBasicAscii";
          const h = new Set();
          if (this.options.invisibleCharacters)
            for (const r of A.InvisibleCharacters.codePoints) m(String.fromCodePoint(r)) || h.add(r);
        ...
        shouldHighlightNonBasicASCII(h, r) {
          ...
          return !o && u
            ? 0
            : this.options.invisibleCharacters && !m(h) && A.InvisibleCharacters.isInvisibleCharacter(s)
              ? 2
...
` ||
          ...
          m.length === 0
            ...
            : (e = a.replace(/\{(\d+)\}/g, (h, r) => {
                ...
                return (
                  typeof o == "string"
                    ? (u = o)
                    : (typeof o == "number" || typeof o == "boolean" || o === void 0 || o === null) && (u = String(o)),
                  u
                );
              })),
    ...
    X(J[71], Z([0, 1, 23, 3, 9, 8, 11, 45]), function (W, n, i, x, A, d, f, p) {
      ...
      class s {
        ...
        cancel() {
          (this.cancelTimeout(),
            this.completionPromise && (this.doReject?.(new x.CancellationError()), (this.completionPromise = null)));
        }
        cancelTimeout() {
    ...
    X(J[37], Z([0, 1, 72]), function (W, n, i) {
              ...
              if (C === 2) {
                if (M.length < 2 || y !== 2 || M.charCodeAt(M.length - 1) !== p || M.charCodeAt(M.length - 2) !== p) {
                  if (M.length > 2) {
                    ...
                    (T === -1 ? ((M = ""), (y = 0)) : ((M = M.slice(0, T)), (y = M.length - 1 - M.lastIndexOf(g))),
                      (_ = D),
                      (C = 0));
                    continue;
                  } else if (M.length !== 0) {
          ...
          for (let M = l.length - 1; M >= -1; M--) {
            ...
            if (M >= 0) {
              ...
              b.length === 0
                ? (y = i.cwd())
                : ((y = i.env[`=${b}`] || i.cwd()),
                  (y === void 0 || (y.slice(0, 2).toLowerCase() !== b.toLowerCase() && y.charCodeAt(2) === a)) &&
                    (y = `${b}\\`));
            const _ = y.length;
            let C = 0,
              R = "",
      ...
      ((n.posix = {
        ...
        relative(l, b) {
          if ((s(l, "from"), s(b, "to"), l === b || ((l = n.posix.resolve(l)), (b = n.posix.resolve(b)), l === b)))
            return "";
          const g = 1,
            w = l.length,
            M = w - g,
    ...
    X(J[14], Z([0, 1, 37, 11]), function (W, n, i, x) {
      ...
      class r {
        ...
        with(g) {
          ...
          return (
            ...
            w === this.scheme && M === this.authority && y === this.path && _ === this.query && C === this.fragment
              ? this
              : new o(w, M, y, _, C)
          );
        }
      ...
      function S(b, g, w) {
        ...
        for (let _ = 0; _ < b.length; _++) {
          ...
          if (
            ...
            (y !== -1 && ((M += encodeURIComponent(b.substring(y, _))), (y = -1)), M !== void 0 && (M += b.charAt(_)));
          else {
      ...
      function P(b, g) {
        ...
        if ((y && ((M += y), (M += ":")), (_ || y === "file") && ((M += e), (M += e)), _)) {
          ...
          ((_ = _.toLowerCase()),
            (T = _.lastIndexOf(":")),
            T === -1 ? (M += w(_, !1, !0)) : ((M += w(_.substr(0, T), !1, !0)), (M += _.substr(T))));
        }
        if (C) {
    ...
    X(J[38], Z([0, 1, 3, 11, 6, 14, 37]), function (W, n, i, x, A, d, f) {
      ...
      class m {
        ...
        rewrite(s) {
          ...
          return (
            typeof L == "string" && (N += `&${n.connectionTokenQueryName}=${encodeURIComponent(L)}`),
            d.URI.from({
      ...
      class e {
        ...
        uriToBrowserUri(s) {
          return s.scheme === p.vscodeRemote
            ...
            : s.scheme === p.file &&
                (x.isNative || x.webWorkerOrigin === `${p.vscodeFileResource}://${e.FALLBACK_AUTHORITY}`)
              ? s.with({
      ...
      class L {
              ...
              typeof _ == "string" &&
                ...
                (E(_)
                  ...
                  : P(_)
                    ...
                    : _.charCodeAt(0) === 36 && (y[_] = async (...C) => (await w?.(), this.sendMessage(g, _, C)))),
              y[_]
            ),
          };
        ...
        _handleReplyMessage(g) {
          ...
          if ((delete this._pendingReplies[g.seq], g.err)) {
            let M = g.err;
            (g.err.$isError &&
              ((M = new Error()), (M.name = g.err.name), (M.message = g.err.message), (M.stack = g.err.stack)),
              w.reject(M));
            return;
          }
          w.resolve(g.res);
        ...
        _handleRequestMessage(g) {
          ...
          this._handler.handleMessage(g.channel, g.method, g.args).then(
            ...
            (y) => {
              (y.detail instanceof Error && (y.detail = (0, i.transformErrorForSerialization)(y.detail)),
                this._send(new s(this._workerId, w, void 0, (0, i.transformErrorForSerialization)(y))));
            },
          );
        }
        ...
        _send(g) {
          const w = [];
          if (g.type === 0)
            for (let M = 0; M < g.args.length; M++) g.args[M] instanceof ArrayBuffer && w.push(g.args[M]);
    ...
    X(J[73], Z([0, 1, 47, 14, 2, 70, 36]), function (W, n, i, x, A, d, f) {
      ...
      (function (y) {
        ...
        function C(T) {
          let O = _.get(T);
          return (
            O || (console.info("No codicon found for CompletionItemKind " + T), (O = i.Codicon.symbolProperty)),
            O
          );
        }
        y.toIcon = C;
      ...
      class a extends x.Disposable {
        constructor(r, s, o = !1) {
          if (
            ...
            (u.cancelAndSet(() => this._checkStopModelSync(), Math.round(n.STOP_SYNC_MODEL_DELTA_TIME_MS / 2)),
              this._register(u));
          }
        }
        dispose() {
      ...
      class e extends c.MirrorTextModel {
        ...
        getLineWords(r, s) {
          const o = this._lines[r - 1],
            ...
            S = [];
          for (const L of u)
            S.push({ word: o.substring(L.start, L.end), startColumn: L.start + 1, endColumn: L.end + 1 });
          return S;
        }
        _wordenize(r, s) {
          const o = [];
        ...
        _validateRange(r) {
          ...
          return s.lineNumber !== r.startLineNumber ||
            ...
            ? { startLineNumber: s.lineNumber, startColumn: s.column, endLineNumber: o.lineNumber, endColumn: o.column }
            : r;
        }
        _validatePosition(r) {
          ...
          let { lineNumber: s, column: o } = r,
            u = !1;
          if (s < 1) ((s = 1), (o = 1), (u = !0));
          else if (s > this._lines.length) ((s = this._lines.length), (o = this._lines[s - 1].length + 1), (u = !0));
          else {
            ...
            e: for (const y of E) {
              ...
              if (_) {
                for (const C of _.words(w))
                  if (!(C === v || !isNaN(Number(C))) && (M.add(C), M.size > L._suggestionsLimit)) break e;
              }
            }
          ...
          async $computeWordRanges(E, v, l, b) {
            ...
            for (let y = v.startLineNumber; y < v.endLineNumber; y++) {
              ...
              for (const C of _) {
                ...
                let R = M[C.word];
                (R || ((R = []), (M[C.word] = R)),
                  R.push({ startLineNumber: y, startColumn: C.startColumn, endLineNumber: y, endColumn: C.endColumn }));
              }
            }
            return M;
          }
