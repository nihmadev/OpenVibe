  ...
  var moduleExports = (() => {
    ...
    var nt = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
      ...
      G = (e, r, i, t) => {
        if ((r && typeof r == "object") || typeof r == "function")
          for (let n of Gn(r))
            !Cn.call(e, n) && n !== i && Z(e, n, { get: () => r[n], enumerable: !(t = Yn(r, n)) || t.enumerable });
        return e;
      },
    ...
    (function (e) {
      function r(t, n, o, s) {
        ...
        return (
          o !== void 0 && (o.overwrite !== void 0 || o.ignoreIfExists !== void 0) && (l.options = o),
      ...
      function r(i) {
        ...
        return (
          ...
          (t.documentChanges === void 0 ||
            t.documentChanges.every((n) => (a.string(n.kind) ? ge.is(n) || pe.is(n) || me.is(n) : de.is(n))))
        );
      }
      e.is = r;
    })(he || (he = {}));
    ...
    (function (e) {
      function r(i) {
        let t = i;
        return (
          t && (a.string(t.detail) || t.detail === void 0) && (a.string(t.description) || t.description === void 0)
        );
      }
      e.is = r;
    })(Ye || (Ye = {}));
    ...
    (function (e) {
      function r(t, n, o) {
        let s = { title: t },
          l = !0;
        return (
          typeof n == "string" ? ((l = !1), (s.kind = n)) : S.is(n) ? (s.command = n) : (s.edit = n),
          l && o !== void 0 && (s.kind = o),
          s
        );
      }
    ...
    function mt(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let n of e.changes[i])
          r.push({ resource: t, versionId: void 0, textEdit: { range: v(n.range), text: n.newText } });
      }
      return { edits: r };
    }
    var z = class {
