    ...
    var kr = (e, t) => {
      ...
      Ar = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of vr(t))
            !xr.call(e, i) && i !== r && ft(e, i, { get: () => t[i], enumerable: !(n = br(t, i)) || n.enumerable });
        return e;
      };
...
`,
    ...
    function pt(e, t, r) {
      ...
      for (; S !== 17;) {
        ...
        if (T === 2)
          (S !== 1 && f--, (r.keepLines && u > 0) || (!r.keepLines && S !== 1) ? (O = y()) : r.keepLines && (O = Q[1]));
        else if (T === 4)
          (S !== 3 && f--, (r.keepLines && u > 0) || (!r.keepLines && S !== 3) ? (O = y()) : r.keepLines && (O = Q[1]));
        else {
          switch (S) {
            case 3:
            case 1:
...
`.indexOf(e.charAt(t)) !== -1
    ...
    function ln(e, t, r = De.DEFAULT) {
      ...
      function s(v) {
        return v
          ? () => v(n.getTokenOffset(), n.getTokenLength(), n.getTokenStartLine(), n.getTokenStartCharacter())
          : () => !0;
      }
      function o(v) {
        return v
      ...
      function c(v) {
        return v
          ? (P) => v(P, n.getTokenOffset(), n.getTokenLength(), n.getTokenStartLine(), n.getTokenStartCharacter())
          : () => !0;
      }
      function l(v) {
        return v
          ? (P) =>
              v(P, n.getTokenOffset(), n.getTokenLength(), n.getTokenStartLine(), n.getTokenStartCharacter(), () =>
                i.slice(),
              )
          : () => !0;
      }
    ...
    (function (e) {
      function t(n, i, s, o) {
        ...
        return (
          s !== void 0 && (s.overwrite !== void 0 || s.ignoreIfExists !== void 0) && (c.options = s),
      ...
      function t(r) {
        ...
        return (
          ...
          (n.documentChanges === void 0 ||
            n.documentChanges.every((i) => (b.string(i.kind) ? Tt.is(i) || Nt.is(i) || Pt.is(i) : Ce.is(i))))
        );
      }
      e.is = t;
    })(qe || (qe = {}));
    ...
    (function (e) {
      function t(r) {
        let n = r;
        return (
          n && (b.string(n.detail) || n.detail === void 0) && (b.string(n.description) || n.description === void 0)
        );
      }
      e.is = t;
    })(Nn || (Nn = {}));
    ...
    (function (e) {
      function t(n, i, s) {
        let o = { title: n },
          c = !0;
        return (
          typeof i == "string" ? ((c = !1), (o.kind = i)) : be.is(i) ? (o.command = i) : (o.edit = i),
          c && s !== void 0 && (o.kind = s),
          o
        );
      }
          ...
          ((r.enumValues = t.enum),
            ...
            g ||
              r.problems.push({
                ...
                message:
                  t.errorMessage ||
                  A("Value is not accepted. Valid values: {0}.", t.enum.map((S) => JSON.stringify(S)).join(", ")),
              }));
        }
        if (Y(t.const)) {
          let w = ae(s);
        ...
        if (m) {
          ...
          for (let w = 0; w < f.items.length; w++) {
            ...
            (C(g, m, S, ve.instance, i),
              S.hasProblems() || (k++, i.schemaDraft >= ie.v2020_12 && r.processedProperties.add(String(w))));
          }
          (k === 0 &&
            !W(t.minContains) &&
            r.problems.push({
            ...
            W(t.minContains) &&
              ...
              r.problems.push({
                ...
                message:
                  t.errorMessage ||
                  A("Array has too few items that match the contains contraint. Expected {0} or more.", t.minContains),
              }),
            W(t.maxContains) &&
              k > t.maxContains &&
              r.problems.push({
                ...
                message:
                  t.errorMessage ||
                  A("Array has too many items that match the contains contraint. Expected {0} or less.", t.maxContains),
              }));
        }
        ...
        for (;;) {
          ...
          switch ((f(), O)) {
            ...
            case 13:
              Array.isArray(o) &&
                o.push(
                  _.create(e.positionAt(s.getTokenOffset()), e.positionAt(s.getTokenOffset() + s.getTokenLength())),
                );
              break;
            case 15:
            case 14:
...
` + p,
        ...
        getInsertTextForProperty(t, r, n, i) {
          ...
          if (r) {
            ...
            if (
              (r.enum &&
                (!c && r.enum.length === 1 && (c = this.getInsertTextForGuessedValue(r.enum[0], "")),
                (l += r.enum.length)),
...
$3`,
    ...
    var rt = class {
        ...
        configure(t) {
          t &&
            ((this.validationEnabled = t.validate !== !1), (this.commentSeverity = t.allowComments ? void 0 : z.Error));
        }
    ...
    var it = class {
      ...
      findDocumentSymbols(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        let s = n.resultLimit || Number.MAX_VALUE,
          o = t.uri;
        if (
          (o === "vscode://defaultsettings/keybindings.json" || fe(o.toLowerCase(), "/user/keybindings.json")) &&
          i.type === "array"
        ) {
          let d = [];
          ...
          470: (i) => {
                    ...
                    if (h !== m - 1 && p === 2) {
                      if (
                        ...
                        if (f.length > 2) {
                          var y = f.lastIndexOf("/");
                          if (y !== f.length - 1) {
                            (y === -1 ? ((f = ""), (d = 0)) : (d = (f = f.slice(0, y)).length - 1 - f.lastIndexOf("/")),
                              (h = m),
                              (p = 0));
                            continue;
                          }
            ...
            var c = {
              ...
              relative: function (l, a) {
                ...
                var g = "";
                for (k = u + y + 1; k <= f; ++k)
                  (k !== f && l.charCodeAt(k) !== 47) || (g.length === 0 ? (g += "..") : (g += "/.."));
                ...
                if (a !== void 0 && a.length > 0 && a.length <= l.length) {
                  ...
                  for (u = l.length - 1; u >= 0; --u) {
                    ...
                    if (y === 47) {
                      ...
                      (m === -1 && ((h = !1), (m = u + 1)),
                        p >= 0 && (y === a.charCodeAt(p) ? --p == -1 && (d = u) : ((p = -1), (d = m))));
                  }
        ...
        class d {
          ...
          with(v) {
            ...
            return (
              ...
              P === this.scheme && L === this.authority && $ === this.path && F === this.query && V === this.fragment
                ? this
                : new p(P, L, $, F, V)
            );
          }
          ...
          if (($ && ((L += $), (L += ":")), (F || $ === "file") && ((L += u), (L += u)), F)) {
            ...
            if (J !== -1) {
              ...
              ((F = F.substr(J + 1)),
                ...
                J === -1
                  ? (L += P($e, !1, !1))
                  : ((L += P($e.substr(0, J), !1, !1)), (L += ":"), (L += P($e.substr(J + 1), !1, !0))),
                (L += "@"));
            }
            ((F = F.toLowerCase()),
              (J = F.lastIndexOf(":")),
              J === -1 ? (L += P(F, !1, !0)) : ((L += P(F.substr(0, J), !1, !0)), (L += F.substr(J))));
          }
          if (V) {
          ...
          case "*":
            ...
            s
              ? d > 1 &&
                (f === "/" || f === void 0 || f === "{" || f === ",") &&
                (h === "/" || h === void 0 || h === "," || h === "}")
                ? (h === "/" ? a++ : f === "/" && n.endsWith("\\/") && (n = n.substr(0, n.length - 2)),
                  (n += "((?:[^/]*(?:/|$))*)"))
                : (n += "([^/]*)")
              : (n += ".*");
            break;
            ...
            this.requestService(t).then(
              (r) => {
                ...
                r.charCodeAt(0) === 65279 &&
                  (n.push(
                    A("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", Me(t)),
                  ),
                  (r = r.trimStart()));
                let i = {},
                  s = [];
                return (
                  (i = dn(r, s)),
                  s.length &&
                    n.push(A("Unable to parse content from '{0}': Parse error at offset {1}.", Me(t), s[0].offset)),
                  new xe(i, n)
                );
              },
              (r) => {
        ...
        resolveSchemaContent(t, r) {
          ...
          let o = new Set(),
            ...
            l = (m, y) => {
              ...
              return (
                y[0] === "/" && (y = y.substring(1)),
                y.split("/").some((w) => ((w = w.replace(/~1/g, "/").replace(/~0/g, "~")), (k = k[w]), !k)),
                k
              );
            },
...
`,
    ...
    function Xr(e) {
      ...
      for (; (c = r.scan()) !== 17;) {
        ...
        if (
          (w === !0 && c !== 14 && c !== 15 && c !== 12 && c !== 13 && ((p = r.getTokenStartLine()), (w = !1)),
