  ...
  var moduleExports = (() => {
    ...
    var Lt = ((e) =>
      typeof require < "u"
        ? require
        : typeof Proxy < "u"
          ? new Proxy(e, { get: (n, i) => (typeof require < "u" ? require : n)[i] })
          : e)(function (e) {
      if (typeof require < "u") return require.apply(this, arguments);
      throw Error('Dynamic require of "' + e + '" is not supported');
    });
    var Rt = (e, n) => () => (n || e((n = { exports: {} }).exports, n), n.exports),
      Pt = (e, n) => {
        for (var i in n) O(e, i, { get: n[i], enumerable: !0 });
      },
      N = (e, n, i, r) => {
        if ((n && typeof n == "object") || typeof n == "function")
          for (let t of Ct(n))
            !Et.call(e, t) && t !== i && O(e, t, { get: () => n[t], enumerable: !(r = bt(n, t)) || r.enumerable });
        return e;
      },
      he = (e, n, i) => (N(e, n, "default"), i && N(i, n, "default")),
      xe = (e, n, i) => (
        (i = e != null ? _t(wt(e)) : {}),
        N(n || !e || !e.__esModule ? O(i, "default", { value: e, enumerable: !0 }) : i, e)
      ),
      Wt = (e) => N(O({}, "__esModule", { value: !0 }), e);
    var ye = Rt((Jt, ve) => {
      var Dt = xe(Lt("vs/editor/editor.api"));
      ve.exports = Dt;
    });
    var Qt = {};
    Pt(Qt, {
      CompletionAdapter: () => U,
      DefinitionAdapter: () => ge,
      DiagnosticsAdapter: () => le,
      DocumentColorAdapter: () => pe,
      DocumentFormattingEditProvider: () => A,
      DocumentHighlightAdapter: () => W,
      DocumentLinkAdapter: () => M,
      DocumentRangeFormattingEditProvider: () => S,
      DocumentSymbolAdapter: () => F,
      FoldingRangeAdapter: () => H,
      HoverAdapter: () => P,
      ReferenceAdapter: () => fe,
      RenameAdapter: () => D,
      SelectionRangeAdapter: () => K,
      WorkerManager: () => T,
      fromPosition: () => I,
      fromRange: () => me,
      setupMode: () => qt,
    ...
    (function (e) {
      function n(r, t) {
        return (
          r === Number.MAX_VALUE && (r = V.MAX_VALUE),
          t === Number.MAX_VALUE && (t = V.MAX_VALUE),
          { line: r, character: t }
        );
      }
      e.create = n;
    ...
    (function (e) {
      function n(r, t, o, s) {
        if (a.uinteger(r) && a.uinteger(t) && a.uinteger(o) && a.uinteger(s))
          return { start: k.create(r, t), end: k.create(o, s) };
      ...
      function i(r) {
        let t = r;
        return a.objectLiteral(t) && k.is(t.start) && k.is(t.end);
      }
      e.is = i;
    })(m || (m = {}));
    var z;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          ...
          (m.is(t.originSelectionRange) || a.undefined(t.originSelectionRange))
        );
      }
      e.is = i;
    })(Te || (Te = {}));
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.objectLiteral(t) &&
          a.string(t.label) &&
          (a.undefined(t.textEdit) || w.is(t)) &&
          (a.undefined(t.additionalTextEdits) || a.typedArray(t.additionalTextEdits, w.is))
        );
      }
      e.is = i;
    })(be || (be = {}));
    ...
    var Ce;
    (function (e) {
      function n(r, t, o, s, u, g) {
        let f = { startLine: r, endLine: t };
        return (
          a.defined(o) && (f.startCharacter = o),
          a.defined(s) && (f.endCharacter = s),
          a.defined(u) && (f.kind = u),
          a.defined(g) && (f.collapsedText = g),
          f
        );
      }
      e.create = n;
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(o.codeDescription) ||
            a.string((t = o.codeDescription) === null || t === void 0 ? void 0 : t.href)) &&
          (a.string(o.source) || a.undefined(o.source)) &&
          (a.undefined(o.relatedInformation) || a.typedArray(o.relatedInformation, Z.is))
        );
      }
      e.is = i;
    })(X || (X = {}));
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.objectLiteral(t) &&
          a.string(t.label) &&
          (a.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
    ...
    (function (e) {
      ...
      function t(o) {
        let s = o;
        return w.is(s) && (ee.is(s.annotationId) || E.is(s.annotationId));
      }
      e.is = t;
    })(Le || (Le = {}));
    var te;
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && se.is(t.textDocument) && Array.isArray(t.edits);
      }
      e.is = i;
    })(te || (te = {}));
    var ne;
    (function (e) {
      function n(r, t, o) {
        ...
        return (
          t !== void 0 && (t.overwrite !== void 0 || t.ignoreIfExists !== void 0) && (s.options = t),
      ...
      function i(r) {
        ...
        return (
          ...
          a.string(t.uri) &&
          (t.options === void 0 ||
            ((t.options.overwrite === void 0 || a.boolean(t.options.overwrite)) &&
              (t.options.ignoreIfExists === void 0 || a.boolean(t.options.ignoreIfExists)))) &&
          (t.annotationId === void 0 || E.is(t.annotationId))
        );
      }
      e.is = i;
    })(ne || (ne = {}));
    ...
    (function (e) {
      function n(r, t, o) {
        ...
        return (
          t !== void 0 && (t.recursive !== void 0 || t.ignoreIfNotExists !== void 0) && (s.options = t),
          o !== void 0 && (s.annotationId = o),
          s
        );
      }
      ...
      function i(r) {
        ...
        return (
          ...
          a.string(t.uri) &&
          (t.options === void 0 ||
            ((t.options.recursive === void 0 || a.boolean(t.options.recursive)) &&
              (t.options.ignoreIfNotExists === void 0 || a.boolean(t.options.ignoreIfNotExists)))) &&
          (t.annotationId === void 0 || E.is(t.annotationId))
        );
      }
      e.is = i;
      ...
      function n(i) {
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every((t) => (a.string(t.kind) ? ne.is(t) || re.is(t) || ie.is(t) : te.is(t))))
        );
      }
      e.is = n;
    })(oe || (oe = {}));
    ...
    (function (e) {
      function n(i) {
        let r = i;
        return a.objectLiteral(i) && ae.is(r.kind) && a.string(r.value);
      }
      e.is = n;
    })(j || (j = {}));
    var h;
    ...
    (function (e) {
      function n(i) {
        let r = i;
        return (
          r && (a.string(r.detail) || r.detail === void 0) && (a.string(r.description) || r.description === void 0)
        );
      }
      e.is = n;
    })(Ae || (Ae = {}));
    ...
    (function (e) {
      function n(i) {
        ...
        return (
          !!r &&
          a.objectLiteral(r) &&
          (j.is(r.contents) || B.is(r.contents) || a.typedArray(r.contents, B.is)) &&
    ...
    (function (e) {
      function n(r, t, o, s, u, g) {
        let f = { name: r, detail: t, kind: o, range: s, selectionRange: u };
        return (g !== void 0 && (f.children = g), f);
      }
      e.create = n;
      function i(r) {
        let t = r;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.defined(t) &&
          a.typedArray(t.diagnostics, X.is) &&
          (t.only === void 0 || a.typedArray(t.only, a.string)) &&
          (t.triggerKind === void 0 || t.triggerKind === q.Invoked || t.triggerKind === q.Automatic)
        );
      }
      e.is = i;
    })(Be || (Be = {}));
    ...
    (function (e) {
      function n(r, t, o) {
        let s = { title: r },
          u = !0;
        return (
          typeof t == "string" ? ((u = !1), (s.kind = t)) : C.is(t) ? (s.command = t) : (s.edit = t),
          u && o !== void 0 && (s.kind = o),
          s
        );
      }
      ...
      function i(r) {
        ...
        return (
          t &&
          a.string(t.title) &&
          (t.diagnostics === void 0 || a.typedArray(t.diagnostics, X.is)) &&
          (t.kind === void 0 || a.string(t.kind)) &&
          (t.edit !== void 0 || t.command !== void 0) &&
          (t.command === void 0 || C.is(t.command)) &&
          (t.isPreferred === void 0 || a.boolean(t.isPreferred)) &&
          (t.edit === void 0 || oe.is(t.edit))
        );
      }
      e.is = i;
    })(qe || (qe = {}));
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && m.is(t.range) && (a.undefined(t.command) || C.is(t.command));
      }
      e.is = i;
    })(Qe || (Qe = {}));
    var Ge;
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && m.is(r.stoppedLocation);
      }
      e.is = i;
    })(ot || (ot = {}));
    var ue;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.objectLiteral(t) &&
          (t.tooltip === void 0 || a.string(t.tooltip) || j.is(t.tooltip)) &&
          (t.location === void 0 || z.is(t.location)) &&
          (t.command === void 0 || C.is(t.command))
        );
      }
      e.is = i;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          (a.objectLiteral(t) &&
            k.is(t.position) &&
            (a.string(t.label) || a.typedArray(t.label, de.is)) &&
            (t.kind === void 0 || ue.is(t.kind)) &&
            t.textEdits === void 0) ||
          (a.typedArray(t.textEdits, w.is) &&
            (t.tooltip === void 0 || a.string(t.tooltip) || j.is(t.tooltip)) &&
    ...
    (function (e) {
      function n(i) {
        let r = i;
        return a.objectLiteral(r) && J.is(r.uri) && a.string(r.name);
      }
      e.is = n;
    })(ft || (ft = {}));
    var pt;
    (function (e) {
      ...
      function r(o, s) {
        let u = o.getText(),
          g = t(s, (l, p) => {
            let y = l.range.start.line - p.range.start.line;
            return y === 0 ? l.range.start.character - p.range.start.character : y;
          }),
          f = u.length;
        for (let l = g.length - 1; l >= 0; l--) {
          let p = g[l],
            y = o.offsetAt(p.range.start),
            c = o.offsetAt(p.range.end);
          if (c <= f) u = u.substring(0, y) + p.newText + u.substring(c, u.length);
      ...
      function t(o, s) {
        ...
        let l = 0,
          p = 0,
          y = 0;
        for (; l < g.length && p < f.length;) s(g[l], f[p]) <= 0 ? (o[y++] = g[l++]) : (o[y++] = f[p++]);
        for (; l < g.length;) o[y++] = g[l++];
        for (; p < f.length;) o[y++] = f[p++];
        return o;
      }
    })(pt || (pt = {}));
    var ce = class {
...
` &&
    ...
    (function (e) {
      ...
      e.number = s;
      function u(c, G, Tt) {
        return n.call(c) === "[object Number]" && G <= c && c <= Tt;
      }
      e.numberRange = u;
      function g(c) {
      ...
      e.objectLiteral = p;
      function y(c, G) {
        return Array.isArray(c) && c.every(G);
      }
      e.typedArray = y;
    })(a || (a = {}));
    var le = class {
      constructor(n, i, r) {
        ...
        let t = (s) => {
            ...
            ((this._listener[s.uri.toString()] = s.onDidChangeContent(() => {
              (window.clearTimeout(g), (g = window.setTimeout(() => this._doValidate(s.uri, u), 500)));
            })),
          ...
          o = (s) => {
            ...
            let u = s.uri.toString(),
              g = this._listener[u];
            g && (g.dispose(), delete this._listener[u]);
          };
        (this._disposables.push(d.editor.onDidCreateModel(t)),
          ...
          this._disposables.push(
            r((s) => {
              d.editor.getModels().forEach((u) => {
                u.getLanguageId() === this._languageId && (o(u), t(u));
              });
            }),
          ),
          this._disposables.push({
      ...
      _doValidate(n, i) {
        this._worker(n)
          ...
          .then((r) => {
            let t = r.map((s) => St(n, s)),
              o = d.editor.getModel(n);
            o && o.getLanguageId() === i && d.editor.setModelMarkers(o, i, t);
          })
          .then(void 0, (r) => {
            console.error(r);
          });
    ...
    var U = class {
      ...
      provideCompletionItems(n, i, r, t) {
        ...
        return this._worker(o)
          .then((s) => s.doComplete(o.toString(), I(i)))
          .then((s) => {
            if (!s) return;
            let u = n.getWordUntilPosition(i),
              g = new d.Range(i.lineNumber, u.startColumn, i.lineNumber, u.endColumn),
              f = s.items.map((l) => {
                let p = {
                  label: l.label,
                ...
                return (
                  l.textEdit &&
                    (Ht(l.textEdit)
                      ? (p.range = { insert: v(l.textEdit.insert), replace: v(l.textEdit.replace) })
                      : (p.range = v(l.textEdit.range)),
                    (p.insertText = l.textEdit.newText)),
                  l.additionalTextEdits && (p.additionalTextEdits = l.additionalTextEdits.map(R)),
                  l.insertTextFormat === $.Snippet &&
                    (p.insertTextRules = d.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                  p
                );
              });
    ...
    function v(e) {
      if (e) return new d.Range(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
    }
    function Ht(e) {
      return typeof e.insert < "u" && typeof e.replace < "u";
    }
    function Kt(e) {
      let n = d.languages.CompletionItemKind;
      switch (e) {
        case h.Text:
          return n.Text;
        case h.Method:
    ...
    var P = class {
      ...
      provideHover(n, i, r) {
        ...
        return this._worker(t)
          .then((o) => o.doHover(t.toString(), I(i)))
          .then((o) => {
            if (o) return { range: v(o.range), contents: Nt(o.contents) };
          });
      }
    };
    function Ut(e) {
...
` +
    ...
    var W = class {
      ...
      provideDocumentHighlights(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.findDocumentHighlights(t.toString(), I(i)))
          .then((o) => {
            if (o) return o.map((s) => ({ range: v(s.range), kind: Ot(s.kind) }));
          });
      }
    };
    function Ot(e) {
    ...
    var ge = class {
      ...
      provideDefinition(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.findDefinition(t.toString(), I(i)))
          .then((o) => {
            if (o) return [ht(o)];
          });
      }
    ...
    function ht(e) {
      return { uri: d.Uri.parse(e.uri), range: v(e.range) };
    }
    var fe = class {
        constructor(n) {
          this._worker = n;
        ...
        provideReferences(n, i, r, t) {
          let o = n.uri;
          return this._worker(o)
            .then((s) => s.findReferences(o.toString(), I(i)))
            .then((s) => {
              if (s) return s.map(ht);
            });
        }
      },
      D = class {
        ...
        provideRenameEdits(n, i, r, t) {
          let o = n.uri;
          return this._worker(o)
            .then((s) => s.doRename(o.toString(), I(i), r))
            .then((s) => Vt(s));
        }
      };
    function Vt(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let t of e.changes[i])
          n.push({ resource: r, versionId: void 0, textEdit: { range: v(t.range), text: t.newText } });
      }
      return { edits: n };
    }
    var F = class {
    ...
    function xt(e) {
      return {
        ...
        tags: e.tags ?? [],
        children: (e.children ?? []).map((n) => xt(n)),
      };
    }
    function vt(e) {
    ...
    var M = class {
        ...
        provideLinks(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t) return { links: t.map((o) => ({ range: v(o.range), url: o.target })) };
            });
        }
      },
      A = class {
        ...
        provideDocumentFormattingEdits(n, i, r) {
          ...
          return this._worker(t).then((o) =>
            o.format(t.toString(), null, yt(i)).then((s) => {
              if (!(!s || s.length === 0)) return s.map(R);
            }),
          );
        }
      },
      S = class {
        ...
        provideDocumentRangeFormattingEdits(n, i, r, t) {
          ...
          return this._worker(o).then((s) =>
            s.format(o.toString(), me(i), yt(r)).then((u) => {
              if (!(!u || u.length === 0)) return u.map(R);
            }),
          );
        }
      };
    ...
    var pe = class {
        ...
        provideDocumentColors(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t) return t.map((o) => ({ color: o.color, range: v(o.range) }));
            });
        }
        provideColorPresentations(n, i, r) {
          let t = n.uri;
          return this._worker(t)
            .then((o) => o.getColorPresentations(t.toString(), i.color, me(i.range)))
            .then((o) => {
              if (o)
                return o.map((s) => {
                  let u = { label: s.label };
                  return (
                    s.textEdit && (u.textEdit = R(s.textEdit)),
                    s.additionalTextEdits && (u.additionalTextEdits = s.additionalTextEdits.map(R)),
                    u
                  );
                });
            });
      ...
      H = class {
        ...
        provideFoldingRanges(n, i, r) {
          let t = n.uri;
          return this._worker(t)
            .then((o) => o.getFoldingRanges(t.toString(), i))
            .then((o) => {
              if (o)
                return o.map((s) => {
                  let u = { start: s.startLine + 1, end: s.endLine + 1 };
                  return (typeof s.kind < "u" && (u.kind = Xt(s.kind)), u);
                });
            });
        }
      };
    ...
    var K = class {
      ...
      provideSelectionRanges(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.getSelectionRanges(t.toString(), i.map(I)))
          .then((o) => {
            if (o)
              return o.map((s) => {
                let u = [];
                for (; s;) (u.push({ range: v(s.range) }), (s = s.parent));
                return u;
              });
          });
      }
    ...
    function Bt(e) {
      let n = new T(e),
        ...
        r = e.languageId;
      (d.languages.registerCompletionItemProvider(r, new Q(i)),
        d.languages.registerHoverProvider(r, new P(i)),
        d.languages.registerDocumentHighlightProvider(r, new W(i)),
        d.languages.registerLinkProvider(r, new M(i)),
        d.languages.registerFoldingRangeProvider(r, new H(i)),
        d.languages.registerDocumentSymbolProvider(r, new F(i)),
        d.languages.registerSelectionRangeProvider(r, new K(i)),
        d.languages.registerRenameProvider(r, new D(i)),
        r === "html" &&
          (d.languages.registerDocumentFormattingEditProvider(r, new A(i)),
          d.languages.registerDocumentRangeFormattingEditProvider(r, new S(i))));
    }
    function qt(e) {
      let n = [],
        i = [],
        r = new T(e);
      n.push(r);
      let t = (...s) => r.getLanguageServiceWorker(...s);
      function o() {
        let { languageId: s, modeConfiguration: u } = e;
        (It(i),
          u.completionItems && i.push(d.languages.registerCompletionItemProvider(s, new Q(t))),
          u.hovers && i.push(d.languages.registerHoverProvider(s, new P(t))),
          u.documentHighlights && i.push(d.languages.registerDocumentHighlightProvider(s, new W(t))),
          u.links && i.push(d.languages.registerLinkProvider(s, new M(t))),
          u.documentSymbols && i.push(d.languages.registerDocumentSymbolProvider(s, new F(t))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new D(t))),
          u.foldingRanges && i.push(d.languages.registerFoldingRangeProvider(s, new H(t))),
          u.selectionRanges && i.push(d.languages.registerSelectionRangeProvider(s, new K(t))),
          u.documentFormattingEdits && i.push(d.languages.registerDocumentFormattingEditProvider(s, new A(t))),
          u.documentRangeFormattingEdits &&
            i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new S(t))));
      }
      return (o(), n.push(kt(i)), kt(n));
    }
    function kt(e) {
      return { dispose: () => It(e) };
    }
