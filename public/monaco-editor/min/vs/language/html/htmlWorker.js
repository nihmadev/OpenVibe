  ...
  var moduleExports = (() => {
    ...
    var In = (t, n) => {
      ...
      Wn = (t, n, o, a) => {
        if ((n && typeof n == "object") || typeof n == "function")
          for (let e of zn(n))
            !Hn.call(t, e) && e !== o && Fe(t, e, { get: () => n[e], enumerable: !(a = Rn(n, e)) || a.enumerable });
        return t;
      };
    ...
    function J(...t) {
      let n = t[0],
        ...
        a,
        e;
      if (typeof n == "string") ((o = n), (a = n), t.splice(0, 1), (e = !t || typeof t[0] != "object" ? t : t[0]));
      else if (n instanceof Array) {
        let u = t.slice(1);
        if (n.length !== u.length + 1) throw new Error("expected a string as the first argument to l10n.t");
        let c = n[0];
        ...
        ((a = n.message),
          (o = a),
          n.comment && n.comment.length > 0 && (o += `/${Array.isArray(n.comment) ? n.comment.join("") : n.comment}`),
          (e = n.args ?? {}));
      let r = On?.[o];
      return r ? (typeof r == "string" ? Te(r, e) : r.comment ? Te(r.message, e) : Te(a, e)) : Te(a, e);
    }
    var Bn = /{([^}]+)}/g;
    function Te(t, n) {
    ...
    (function (t) {
      function n(a, e, r) {
        ...
        return (
          e !== void 0 && (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) && (u.options = e),
    ...
    (function (t) {
      function n(a, e, r, u) {
        ...
        return (
          r !== void 0 && (r.overwrite !== void 0 || r.ignoreIfExists !== void 0) && (c.options = r),
    ...
    (function (t) {
      function n(a, e, r) {
        ...
        return (
          e !== void 0 && (e.recursive !== void 0 || e.ignoreIfNotExists !== void 0) && (u.options = e),
          r !== void 0 && (u.annotationId = r),
          u
        );
      }
        ...
        return (
          ...
          (e.options === void 0 ||
            ((e.options.recursive === void 0 || w.boolean(e.options.recursive)) &&
              (e.options.ignoreIfNotExists === void 0 || w.boolean(e.options.ignoreIfNotExists)))) &&
          (e.annotationId === void 0 || se.is(e.annotationId))
        );
      }
      t.is = o;
      ...
      function n(o) {
        ...
        return (
          ...
          (a.documentChanges === void 0 ||
            a.documentChanges.every((e) => (w.string(e.kind) ? Qe.is(e) || Ze.is(e) || Ke.is(e) : Ye.is(e))))
        );
      }
      t.is = n;
    })(Ae || (Ae = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return w.defined(e) && w.string(e.uri) && w.string(e.languageId) && w.integer(e.version) && w.string(e.text);
      }
      t.is = o;
    })(Mt || (Mt = {}));
    var Q;
    ...
    (function (t) {
      function n(o) {
        let a = o;
        return (
          a && (w.string(a.detail) || a.detail === void 0) && (w.string(a.description) || a.description === void 0)
        );
      }
      t.is = n;
    })(Rt || (Rt = {}));
    ...
    (function (t) {
      function n(o, a, ...e) {
        let r = { label: o };
        return (w.defined(a) && (r.documentation = a), w.defined(e) ? (r.parameters = e) : (r.parameters = []), r);
      }
      t.create = n;
    })(Ht || (Ht = {}));
    var ue;
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          ...
          (e.triggerKind === void 0 || e.triggerKind === xe.Invoked || e.triggerKind === xe.Automatic)
        );
      }
      t.is = o;
    })(Ot || (Ot = {}));
    ...
    (function (t) {
      function n(a, e, r) {
        let u = { title: a },
          c = !0;
        return (
          typeof e == "string" ? ((c = !1), (u.kind = e)) : ne.is(e) ? (u.command = e) : (u.edit = e),
          c && r !== void 0 && (u.kind = r),
          u
        );
      }
    ...
    (function (t) {
      ...
      function e(r, u) {
        ...
        let l = 0,
          h = 0,
          p = 0;
        for (; l < i.length && h < s.length;) u(i[l], s[h]) <= 0 ? (r[p++] = i[l++]) : (r[p++] = s[h++]);
...
` &&
    ...
    var De = class t {
        ...
        update(n, o) {
          for (let a of n)
            if (t.isIncremental(a)) {
              ...
              this._content = this._content.substring(0, r) + a.text + this._content.substring(u, this._content.length);
        ...
        getLineOffsets() {
          return (this._lineOffsets === void 0 && (this._lineOffsets = rn(this._content, !0)), this._lineOffsets);
        }
        positionAt(n) {
          n = Math.max(Math.min(n, this._content.length), 0);
          let o = this.getLineOffsets(),
    ...
    (function (t) {
      ...
      function a(e, r) {
        ...
        for (let l of c) {
          ...
          (h > i && s.push(u.substring(i, h)), l.newText.length && s.push(l.newText), (i = e.offsetAt(l.range.end)));
        }
    ...
    function pt(t, n) {
      ...
      let r = 0,
        u = 0,
        c = 0;
      for (; r < a.length && u < e.length;) n(a[r], e[u]) <= 0 ? (t[c++] = a[r++]) : (t[c++] = e[u++]);
    ...
    function an(t) {
      let n = t.start,
        o = t.end;
      return n.line > o.line || (n.line === o.line && n.character > o.character) ? { start: o, end: n } : t;
    }
    function Nn(t) {
      let n = an(t.range);
    ...
    var ft = class {
        ...
        advanceIfChars(n) {
          ...
          for (o = 0; o < n.length; o++) if (this.source.charCodeAt(this.position + o) !== n[o]) return !1;
        ...
        skipWhitespace() {
          return this.advanceWhileChar((o) => o === $n || o === Jn || o === jn || o === Vn || o === Gn) > 0;
        }
        advanceWhileChar(n) {
          let o = this.position;
          for (; this.position < this.len && n(this.source.charCodeAt(this.position));) this.position++;
    ...
    function V(t, n = 0, o = H.WithinContent, a = !1) {
      ...
      function D() {
        let y = e.pos(),
          L = r,
          I = T();
        return I !== S.EOS && y === e.pos() && !(a && (I === S.StartTagClose || I === S.EndTagClose))
          ? (console.warn("Scanner.scan has not advanced at offset " + y + ", state before: " + L + " after: " + r),
            e.advance(1),
            b(y, S.Unknown))
          : I;
      }
      function T() {
        ...
        switch (r) {
          ...
          case H.WithinContent:
            if (e.advanceIfChar(Ce)) {
              if (!e.eos() && e.peekChar() === sn) {
                if (e.advanceIfChars([sn, he, he])) return ((r = H.WithinComment), b(y, S.StartCommentTag));
                if (e.advanceIfRegExp(/^!doctype/i)) return ((r = H.WithinDoctype), b(y, S.StartDoctypeTag));
              }
                ...
                : e.advanceIfChars([mt, ee])
                  ...
                  : e.advanceIfChar(ee)
                    ? (l === "script"
                      ...
                      b(y, S.StartTagClose))
                    : a && e.peekChar() === Ce
                      ? ((r = H.WithinContent), b(y, S.StartTagClose, J("Closing bracket missing.")))
          ...
          case H.BeforeAttributeValue:
            ...
            if (
              N.length > 0 &&
              (e.peekChar() === ee && e.peekChar(-1) === mt && (e.goBack(1), (N = N.substring(0, N.length - 1))),
              h === "type" && (p = N),
              N.length > 0)
            )
          ...
          case H.WithinStyleContent:
            return (e.advanceUntilRegExp(/<\/style/i), (r = H.WithinContent), y < e.pos() ? b(y, S.Styles) : T());
        }
    ...
    var Le = class {
        ...
        constructor(n, o, a, e) {
          ((this.start = n), (this.end = o), (this.children = a), (this.parent = e), (this.closed = !1));
        }
        isSameTag(n) {
      ...
      Me = class {
        ...
        parse(n, o) {
                ...
                r.parent &&
                  ...
                  a.getTokenLength()
                    ? ((r.startTagEnd = a.getTokenEnd()),
                      r.tag && this.dataManager.isVoidElement(r.tag, o) && ((r.closed = !0), (r = r.parent)))
                    : (r = r.parent));
                break;
              case S.StartTagSelfClose:
                r.parent &&
                  ((r.closed = !0), (r.end = a.getTokenEnd()), (r.startTagEnd = a.getTokenEnd()), (r = r.parent));
                break;
              case S.EndTagOpen:
          ...
          return { roots: e.children, findNodeBefore: e.findNodeBefore.bind(e), findNodeAt: e.findNodeAt.bind(e) };
        }
      };
    var ie = {
      "Aacute;": "\xC1",
...
\r`.indexOf(M) >= 0
        ...
        function d(k, x) {
          ...
          (a && a.roots.forEach((z) => O(z)),
            Object.keys(B).forEach((z) =>
              r.items.push({ label: z, kind: $.Value, textEdit: G.replace(k, B[z]), insertTextFormat: X.Snippet }),
            ));
        }
        function g(k, x = h) {
          let M, B, O;
          ...
          if (u.length > 0) {
            ...
            for (let j of u)
              j.onHtmlAttributeValue &&
                j.onHtmlAttributeValue({ document: n, position: o, tag: z, attribute: U, value: O, range: P });
          }
          return (
            c.forEach((z) => {
        ...
        function R(k) {
          return h === m.getTokenEnd() && ((E = m.scan()), E === k && m.getTokenOffset() === h) ? m.getTokenEnd() : h;
        }
        function v() {
        ...
        for (; E !== S.EOS && m.getTokenOffset() <= h;) {
          switch (E) {
            case S.StartTagOpen:
              ...
              break;
            case S.StartTag:
              if (m.getTokenOffset() <= h && h <= m.getTokenEnd()) return T(m.getTokenOffset(), m.getTokenEnd());
              A = m.getTokenText();
              break;
            case S.AttributeName:
              if (m.getTokenOffset() <= h && h <= m.getTokenEnd()) return f(m.getTokenOffset(), m.getTokenEnd());
              b = m.getTokenText();
              break;
            case S.DelimiterAssign:
              ...
              break;
            case S.AttributeValue:
              if (m.getTokenOffset() <= h && h <= m.getTokenEnd()) return g(m.getTokenOffset(), m.getTokenEnd());
              break;
            case S.Whitespace:
              if (h <= m.getTokenEnd())
        ...
        if (s && s.attributes && s.start < r && (!s.endTagStart || s.endTagStart > r)) {
          ...
          for (; h !== S.EOS && l.getTokenEnd() <= r;) {
            if (h === S.AttributeName && l.getTokenEnd() === r - 1)
              return (
                (h = l.scan()),
                h !== S.DelimiterAssign || ((h = l.scan()), h === S.Unknown || h === S.AttributeValue) ? null : i
              );
            h = l.scan();
          }
        }
      ...
      doesSupportMarkdown() {
        if (!de(this.supportsMarkdown)) {
          if (!de(this.lsOptions.clientCapabilities)) return ((this.supportsMarkdown = !0), this.supportsMarkdown);
          let n = this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
    ...
    var Ie = class {
      ...
      doHover(n, o, a, e) {
            ...
            if (
              (R.provideTags().forEach((_) => {
                if (_.name.toLowerCase() === f.toLowerCase()) {
                  let C = te(_, e, u);
                  (C || (C = { kind: u ? "markdown" : "plaintext", value: "" }), (v = { contents: C, range: d }));
                }
              }),
              v)
            )
        ...
        function b(f, d) {
          let g = V(n.getText(), d),
            R = g.scan();
          for (; R !== S.EOS && (g.getTokenEnd() < c || (g.getTokenEnd() === c && R !== f));) R = g.scan();
          ...
          function (e) {
            ...
            ((r.prototype.clone_empty = function () {
              ...
              (r.prototype.has_match = function (i) {
                for (var s = this.__items.length - 1; s >= 0; s--) if (this.__items[s].match(i)) return !0;
                return !1;
              }),
              ...
              (r.prototype._allow_wrap = function () {
                if (this._should_wrap()) {
                  ...
                  return (
                    ...
                    (i.__character_count += this.__character_count - this.__wrap_point_character_count),
...
`);
              ...
              (r.prototype.toString = function () {
                ...
                return (
                  this.is_empty()
                    ? this.__parent.indent_empty_lines && (i = this.__parent.get_indent_string(this.__indent_count))
                    : ((i = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)),
                      (i += this.__items.join(""))),
                  i
                );
              }));
            function u(i, s) {
              ((this.__cache = [""]),
                ...
                i.indent_with_tabs || (this.__indent_string = new Array(i.indent_size + 1).join(i.indent_char)),
                (s = s || ""),
                i.indent_level > 0 && (s = new Array(i.indent_level + 1).join(this.__indent_string)),
...
You passed in: '` +
              ...
              (r.prototype._get_selection_list = function (i, s, l) {
                ...
                if (((l = l || [s[0]]), !this._is_valid_selection(l, s))) throw new Error("Invalid Default Value!");
...
You passed in: '` +
          ...
          function (e) {
            ...
            function u(c) {
              ((this.__input = c || ""), (this.__input_length = this.__input.length), (this.__position = 0));
            }
            ((u.prototype.restart = function () {
              ...
              (u.prototype.next = function () {
                var c = null;
                return (this.hasNext() && ((c = this.__input.charAt(this.__position)), (this.__position += 1)), c);
              }),
              ...
              (u.prototype.read = function (c, i, s) {
                var l = "",
                  h;
                return (c && ((h = this.match(c)), h && (l += h[0])), i && (h || !c) && (l += this.readUntil(i, s)), l);
              }),
              ...
              (u.prototype.get_regexp = function (c, i) {
                ...
                return (
                  i && r && (l = "y"),
                  typeof c == "string" && c !== "" ? (s = new RegExp(c, l)) : c && (s = new RegExp(c.source, l)),
                  s
                );
              }),
          ...
          function (e) {
            function r(u, c) {
              ((u = typeof u == "string" ? u : u.source),
                ...
                (this.__directives_block_pattern = new RegExp(u + / beautify( \w+[:]\w+)+ /.source + c, "g")),
                (this.__directive_pattern = / (\w+)[:](\w+)/g),
                (this.__directives_end_ignore_pattern = new RegExp(u + /\sbeautify\signore:end\s/.source + c, "g")));
            }
...
`,
                ...
                for (
                  ...
                  if (this._ch === "/" && this._input.peek() === "*") {
                      ...
                      (z.match(/[ :]$/) &&
                        ...
                        F === 0 && z.indexOf(":") !== -1
                          ...
                          : z in this.NESTED_AT_RULE
                            ? ((this._nestedLevel += 1), z in this.CONDITIONAL_GROUP_RULE && (g = !0))
                            : F === 0 && !d && (R = !0));
                    }
                  else if (this._ch === "#" && this._input.peek() === "{")
                    ...
                    (d && ((d = !1), this.outdent()),
                      ...
                      this._options.brace_style === "expand"
                        ? (this._output.add_new_line(),
                          ...
                          this.indent(),
                          this._output.set_indent(this._indentLevel))
                        : (x === "(" ? (this._output.space_before_token = !1) : x !== "," && this.indent(),
                          this.print_string(this._ch)),
                      this.eatWhitespace(!0),
                      this._output.add_new_line());
                  else if (this._ch === "}")
                    ...
                    F === 0
                      ? (this.print_string(":"),
                        d || ((d = !0), (this._output.space_before_token = !0), this.eatWhitespace(!0), this.indent()))
                    ...
                    if (this._input.lookBack("url"))
                      (this.print_string(this._ch),
                        ...
                        this._ch === ")" || this._ch === '"' || this._ch === "'"
                          ? this._input.back()
                          : this._ch &&
                            (this.print_string(this._ch + this.eatString(")")), F && (F--, this.outdent())));
                    else {
                      var j = !1;
                    ...
                    (this.print_string(this._ch),
                      ...
                      this._options.selector_separator_newline && (!d || v) && F === 0 && !R
                        ? this._output.add_new_line()
                        : (this._output.space_before_token = !0));
                  else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !d && F === 0)
...
You passed in: '` +
          ...
          function (e, r, u) {
            ...
            ((p.prototype.tokenize = function () {
              ...
              for (var m, A = new i(h.START, ""), b = null, D = [], T = new s(); A.type !== h.EOF;) {
                for (m = this._get_next_token(A, b); this._is_comment(m);) (T.add(m), (m = this._get_next_token(A, b)));
                (T.isEmpty() || ((m.comments_before = T), (T = new s())),
                  (m.parent = b),
                  this._is_opening(m)
                    ? (D.push(b), (b = m))
                    : b && this._is_closing(m, b) && ((m.opened = b), (b.closed = m), (b = D.pop()), (m.parent = b)),
                  (m.previous = A),
                  (A.next = m),
                  this.__tokens.add(m),
                  (A = m));
            ...
            ((i.prototype = new c()),
              ...
              (i.prototype.read = function () {
                ...
                if (s === " ") this.whitespace_before_token = " ";
                  ...
                  ((this.newline_count = l.length - 1), (this.whitespace_before_token = l[this.newline_count]));
                }
                return s;
              }),
            ...
            ((r.prototype.read = function () {
              ...
              return (
                (!this._starting_pattern || u) &&
                  (u += this._input.read(this._match_pattern, this._until_pattern, this._until_after)),
                u
              );
            }),
              ...
              (r.prototype.until_after = function (u) {
                var c = this._create();
                return ((c._until_after = !0), (c._until_pattern = this._input.get_regexp(u)), c._update(), c);
              }),
              (r.prototype.until = function (u) {
                var c = this._create();
                return ((c._until_after = !1), (c._until_pattern = this._input.get_regexp(u)), c._update(), c);
              }),
          ...
          function (e, r, u) {
            ...
            ((s.prototype = new c()),
              ...
              (s.prototype.read = function () {
                ...
                return (this._until_after && (l += this._input.readUntilAfter(this._until_pattern)), l);
              }),
              (s.prototype.__set_templated_pattern = function () {
                var l = [];
                (this._disabled.php || l.push(this.__patterns.php._starting_pattern.source),
                  this._disabled.handlebars || l.push(this.__patterns.handlebars._starting_pattern.source),
              ...
              (s.prototype._read_template = function () {
                ...
                if (h === "<") {
                  ...
                  (!this._disabled.php && !this._excluded.php && p === "?" && (l = l || this.__patterns.php.read()),
                    !this._disabled.erb && !this._excluded.erb && p === "%" && (l = l || this.__patterns.erb.read()));
                } else
                  h === "{" &&
                    ...
                    this._disabled.django ||
                      ...
                      this._excluded.django ||
                        ((l = l || this.__patterns.django_comment.read()), (l = l || this.__patterns.django.read()))),
              ...
              (m.prototype.print_preserved_newlines = function (f) {
                ...
                (f.type !== l.TEXT && f.previous.type !== l.TEXT && (d = f.newlines ? 1 : 0),
                  this.preserve_newlines &&
                    (d = f.newlines < this.max_preserve_newlines + 1 ? f.newlines : this.max_preserve_newlines + 1));
                ...
                return (
                  ...
                  g.is_unformatted
                    ...
                    : (g.tag_start_char === "<" &&
                        ...
                        this._is_wrap_attributes_force_expand_multiline && g.has_wrapped_attrs && f.print_newline(!1)),
                      f.print_token(d)),
                  g.indent_content &&
                    !(g.is_unformatted || g.is_content_unformatted) &&
                    (f.indent(), (g.indent_content = !1)),
                  !g.is_inline_element && !(g.is_unformatted || g.is_content_unformatted) && f.set_wrap_point(),
                  R
                );
              }),
                  ...
                  g.is_unformatted
                    ...
                    : g.tag_start_char === "{" && d.type === l.TEXT
                      ...
                      : (d.type === l.ATTRIBUTE
                          ...
                          : (d.type === l.EQUALS || (d.type === l.VALUE && d.previous.type === l.EQUALS)) &&
                        ...
                        d.type === l.ATTRIBUTE &&
                          ...
                          this._is_wrap_attributes_force &&
                            ...
                            (R.type !== l.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) &&
              ...
              (L.prototype._print_custom_beatifier_text = function (f, d, g) {
                ...
                if (d.text !== "") {
                  var v = d.text,
                    ...
                    E = "",
                    k = "";
                  (g.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function"
                    ? (_ = this._js_beautify)
                  ...
                  if (
                    ((v = v.replace(/\n[ \t]*$/, "")),
                    g.custom_beautifier_name !== "html" && v[0] === "<" && v.match(/^(<!--|<!\[CDATA\[)/))
                  ) {
                    var M = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(v);
                    if (!M) {
                      f.add_raw_token(d);
...
` +
              ...
              (L.prototype._handle_tag_open = function (f, d, g, R, v) {
                ...
                if (
                  ...
                  d.type === l.TAG_OPEN &&
                  !_.is_start_tag
                    ? (f.add_raw_token(d), (_.start_tag_token = this._tag_stack.try_pop(_.tag_name)))
            ...
            var I = function (f, d) {
              if (
                ...
                var R = 2;
                (this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (R = 3),
                  (this.is_end_tag =
                    this.is_end_tag ||
                    (this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(R))))));
              }
            };
            ((L.prototype._get_tag_open_token = function (f) {
              ...
              return (
                ...
                (d.is_content_unformatted = !d.is_empty_element && D(d.tag_check, this._options.content_unformatted)),
                (d.is_inline_element =
                ...
                if (
                  (g.is_empty_element ||
                    (g.is_end_tag
                      ...
                      : (this._do_optional_end_element(g) && (g.is_inline_element || f.print_newline(!1)),
                  ...
                  if (g.tag_start_char === "{" && g.tag_check === "else") {
                    (this._tag_stack.indent_to_tag(["if", "unless", "each"]), (g.indent_content = !0));
...
`) === -1) ||
                    ...
                    g.tag_start_char === "<" &&
                      (g.tag_name === "html"
                        ...
                        : g.tag_name === "head"
                          ...
                          : g.tag_name === "body" && (g.indent_content = this._options.indent_body_inner_html)),
            ...
            ((L.prototype._do_optional_end_element = function (f) {
              ...
              if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
                if (f.tag_name === "body") d = d || this._tag_stack.try_pop("head");
                else if (f.tag_name === "li") d = d || this._tag_stack.try_pop("li", ["ol", "ul", "menu"]);
                  ...
                  f.tag_name === "rp" || f.tag_name === "rt"
                    ...
                    : f.tag_name === "optgroup"
                      ...
                      : f.tag_name === "option"
                        ? (d = d || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]))
                        : f.tag_name === "colgroup"
                          ...
                          : f.tag_name === "thead"
                            ...
                            : f.tag_name === "tbody" || f.tag_name === "tfoot"
                              ...
                              : f.tag_name === "tr"
                                ? ((d = d || this._tag_stack.try_pop("caption", ["table"])),
                                  (d = d || this._tag_stack.try_pop("colgroup", ["table"])),
                                  (d = d || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])))
                                : (f.tag_name === "th" || f.tag_name === "td") &&
                                  ((d = d || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])),
                                  (d = d || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"])));
            ...
            ((A.prototype = new c()),
              ...
              (A.prototype._read_comment_or_cdata = function (b) {
                ...
                if (b === "<") {
                  ...
                  (L === "!" &&
                    ...
                    T
                      ? ((y = m.get_directives(T)), y && y.ignore === "start" && (T += m.readIgnored(this._input)))
                ...
                return (
                  (!D || D.type === p.CONTROL_FLOW_OPEN) &&
                    ...
                    (this._input.peek(2) === "!"
                      ...
                      : ((T = this.__patterns.handlebars_open.read()), (y = this._create_token(p.TAG_OPEN, T)))),
                  y
                );
              }),
                  ...
                  D &&
                    ...
                    (D.text[0] === "<" && (b === ">" || (b === "/" && this._input.peek(1) === ">"))
                      ...
                      : D.text[0] === "{" &&
                        b === "}" &&
                        this._input.peek(1) === "}" &&
                        (this._input.next(), this._input.next(), (y = this._create_token(p.TAG_CLOSE, "}}")))),
                  y
                );
              }),
              ...
              (A.prototype._is_content_unformatted = function (b) {
                return (
                  ...
                  (this._options.content_unformatted.indexOf(b) !== -1 || this._options.unformatted.indexOf(b) !== -1)
                );
              }),
    ...
    function _n(t, n, o) {
      ...
      if (n) {
        ...
        if (new RegExp(/.*[<][^>]*$/).test(m)) return ((a = a.substring(s, h)), [{ range: n, newText: a }]);
...
` + s,
    ...
    function wt(t, n, o) {
      let a = Y(t, n, null);
      return typeof a == "string" ? (a.length > 0 ? a.split(",").map((e) => e.trim().toLowerCase()) : []) : o;
    }
    function fi(t, n) {
...
`.indexOf(t.charAt(n)) !== -1
    ...
    (() => {
          ...
          470: (e) => {
              ...
              for (var l, h = "", p = 0, m = -1, A = 0, b = 0; b <= i.length; ++b) {
                ...
                if (l === 47) {
                  if (!(m === b - 1 || A === 1))
                    if (m !== b - 1 && A === 2) {
                      if (
                        ...
                        if (h.length > 2) {
                          var D = h.lastIndexOf("/");
                          if (D !== h.length - 1) {
                            (D === -1 ? ((h = ""), (p = 0)) : (p = (h = h.slice(0, D)).length - 1 - h.lastIndexOf("/")),
                              (m = b),
                              (A = 0));
                            continue;
                          }
                    ...
                    } else (h.length > 0 ? (h += "/" + i.slice(m + 1, b)) : (h = i.slice(m + 1, b)), (p = b - m - 1));
                  ((m = b), (A = 0));
                } else l === 46 && A !== -1 ? ++A : (A = -1);
              }
              return h;
            ...
            var c = {
              resolve: function () {
                ...
                return ((s = u(s, !l)), l ? (s.length > 0 ? "/" + s : "/") : s.length > 0 ? s : ".");
              },
              ...
              relative: function (i, s) {
                ...
                for (var h = i.length, p = h - l, m = 1; m < s.length && s.charCodeAt(m) === 47; ++m);
                ...
                var L = "";
                for (T = l + D + 1; T <= h; ++T)
                  (T !== h && i.charCodeAt(T) !== 47) || (L.length === 0 ? (L += "..") : (L += "/.."));
                return L.length > 0 ? L + s.slice(m + D) : ((m += D), s.charCodeAt(m) === 47 && ++m, s.slice(m));
              },
              ...
              dirname: function (i) {
                if ((r(i), i.length === 0)) return ".";
                for (var s = i.charCodeAt(0), l = s === 47, h = -1, p = !0, m = i.length - 1; m >= 1; --m)
                ...
                if (s !== void 0 && s.length > 0 && s.length <= i.length) {
                  ...
                  for (l = i.length - 1; l >= 0; --l) {
                    ...
                    if (D === 47) {
                      ...
                      (b === -1 && ((m = !1), (b = l + 1)),
                        A >= 0 && (D === s.charCodeAt(A) ? --A == -1 && (p = l) : ((A = -1), (p = b))));
                  }
              ...
              extname: function (i) {
                ...
                return s === -1 || h === -1 || m === 0 || (m === 1 && s === h - 1 && s === l + 1) ? "" : i.slice(s, h);
              },
              format: function (i) {
      ...
      ((o.d = (e, r) => {
        for (var u in r) o.o(r, u) && !o.o(e, u) && Object.defineProperty(e, u, { enumerable: !0, get: r[u] });
      }),
      ...
      ((() => {
        ...
        function i(v, _) {
          ...
          if (v.scheme && !r.test(v.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
          if (v.path) {
            if (v.authority) {
              if (!u.test(v.path))
                throw new Error(
        ...
        class p {
          ...
          with(_) {
            ...
            return (
              ...
              C === this.scheme && E === this.authority && k === this.path && x === this.query && M === this.fragment
                ? this
                : new A(C, E, k, x, M)
            );
          }
          ...
          static file(_) {
            ...
            if ((e && (_ = _.replace(/\\/g, l)), _[0] === l && _[1] === l)) {
              let E = _.indexOf(l, 2);
              E === -1 ? ((C = _.substring(2)), (_ = l)) : ((C = _.substring(2, E)), (_ = _.substring(E) || l));
            }
          ...
          static revive(_) {
            if (_) {
              ...
              {
                let C = new A(_);
                return ((C._formatted = _.external), (C._fsPath = _._sep === m ? _.fsPath : null), C);
              }
            }
            return _;
          }
        ...
        class A extends p {
          ...
          toString(_ = !1) {
            return _ ? L(this, !0) : (this._formatted || (this._formatted = L(this, !1)), this._formatted);
          }
          toJSON() {
            let _ = { $mid: 1 };
            return (
        ...
        function T(v) {
          ...
          for (let C = 0; C < v.length; C++) {
            ...
            E === 35 || E === 63 ? (_ === void 0 && (_ = v.substr(0, C)), (_ += b[E])) : _ !== void 0 && (_ += v[C]);
          }
          return _ !== void 0 ? _ : v;
        }
        function y(v, _) {
        ...
        function L(v, _) {
          ...
          if ((k && ((E += k), (E += ":")), (x || k === "file") && ((E += l), (E += l)), x)) {
            ...
            if (z !== -1) {
              ...
              ((x = x.substr(z + 1)),
                ...
                z === -1
                  ? (E += C(U, !1, !1))
                  : ((E += C(U.substr(0, z), !1, !1)), (E += ":"), (E += C(U.substr(z + 1), !1, !0))),
                (E += "@"));
            }
            ((x = x.toLowerCase()),
              (z = x.lastIndexOf(":")),
              z === -1 ? (E += C(x, !1, !0)) : ((E += C(x.substr(0, z), !1, !0)), (E += x.substr(z))));
          }
          if (M) {
          ...
          return (B && ((E += "?"), (E += C(B, !1, !1))), O && ((E += "#"), (E += _ ? O : D(O, !1, !1))), E);
        }
        function I(v) {
          try {
    ...
    function yi(t, n) {
      try {
        ...
        return (
          ...
          o.scheme === "file" && o.fragment && !(t.startsWith(n.uri) && t.charCodeAt(n.uri.length) === vi)
    ...
    function Sn(t, n, o) {
      ...
      return e !== S.EOS ? { start: n.positionAt(a.getTokenOffset()), end: n.positionAt(a.getTokenEnd()) } : null;
    }
    function xn(t, n) {
      let o = [],
        a = vt(t, n);
      ...
      function e(r, u) {
        ...
        if ((c.containerName ?? (c.containerName = ""), o.push(c), r.children)) for (let i of r.children) e(i, r);
      }
    }
    function vt(t, n) {
      let o = [];
    ...
    function En(t, n, o, a) {
      ...
      if ((u.push({ range: c, newText: o }), r.endTagStart)) {
        let s = { start: t.positionAt(r.endTagStart + 2), end: t.positionAt(r.endTagStart + 2 + r.tag.length) };
    ...
    function yt(t, n, o) {
      ...
      return e.endTagStart &&
        ((e.start + 1 <= a && a <= e.start + 1 + r) || (e.endTagStart + 2 <= a && a <= e.endTagStart + 2 + r))
        ? [
              ...
              if (A)
                if (A[1]) c.push({ startLine: p, tagName: "" });
                  ...
                  if (b >= 0) {
                    ...
                    c.length = b;
                    let T = p;
                    ((p = D.startLine), T > p && s !== p && l({ startLine: p, endLine: T, kind: oe.Region }));
                  }
                }
              else {
        ...
        return !r.startTagEnd || !r.endTagStart
          ...
          : (u.unshift([r.start, r.end]),
            r.start < e && e < r.startTagEnd
              ? (u.unshift([r.start + 1, r.startTagEnd - 1]), (u = this.getAttributeLevelRanges(n, r, e).concat(u)), u)
          ...
          switch (i) {
            ...
            case S.AttributeValue: {
              ...
              u >= c.getTokenOffset() &&
                ...
                ((m[0] === '"' && m[m.length - 1] === '"') || (m[0] === "'" && m[m.length - 1] === "'")) &&
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
    ...
    var Be = class {
        ...
        setDataProviders(n, o) {
          ((this.dataProviders = []), n && this.dataProviders.push(new pe("html5", Tt)), this.dataProviders.push(...o));
        }
        getDataProviders() {
    ...
    var Ne = class {
      constructor(n, o) {
        ((this._ctx = n), (this._languageSettings = o.languageSettings), (this._languageId = o.languageId));
      ...
      async doComplete(n, o) {
        ...
        return Promise.resolve(
          this._languageService.doComplete(a, o, e, this._languageSettings && this._languageSettings.suggest),
        );
      }
      async format(n, o, a) {
      ...
      _getTextDocument(n) {
        ...
        for (let a of o) if (a.uri.toString() === n) return ve.create(n, this._languageId, a.version, a.getValue());
        return null;
      }
    };
    function Di(t, n) {
