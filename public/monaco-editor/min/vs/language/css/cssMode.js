...
define("vs/language/css/cssMode", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var Rt = (e, n) => () => (n || e((n = { exports: {} }).exports, n), n.exports),
      Pt = (e, n) => {
        for (var i in n) X(e, i, { get: n[i], enumerable: !0 });
      },
      z = (e, n, i, r) => {
        if ((n && typeof n == "object") || typeof n == "function")
          for (let t of Ct(n))
            !wt.call(e, t) && t !== i && X(e, t, { get: () => n[t], enumerable: !(r = _t(n, t)) || r.enumerable });
        return e;
      },
      he = (e, n, i) => (z(e, n, "default"), i && z(i, n, "default")),
      me = (e, n, i) => (
        (i = e != null ? Tt(bt(e)) : {}),
        z(n || !e || !e.__esModule ? X(i, "default", { value: e, enumerable: !0 }) : i, e)
      ),
      Lt = (e) => z(X({}, "__esModule", { value: !0 }), e);
    var ye = Rt((Qt, xe) => {
      var Wt = me(Et("vs/editor/editor.api"));
      xe.exports = Wt;
    });
    var Bt = {};
    Pt(Bt, {
      CompletionAdapter: () => D,
      DefinitionAdapter: () => A,
      DiagnosticsAdapter: () => W,
      DocumentColorAdapter: () => N,
      DocumentFormattingEditProvider: () => U,
      DocumentHighlightAdapter: () => F,
      DocumentLinkAdapter: () => fe,
      DocumentRangeFormattingEditProvider: () => H,
      DocumentSymbolAdapter: () => j,
      FoldingRangeAdapter: () => O,
      HoverAdapter: () => S,
      ReferenceAdapter: () => M,
      RenameAdapter: () => K,
      SelectionRangeAdapter: () => V,
      WorkerManager: () => _,
      fromPosition: () => k,
      fromRange: () => pe,
      setupMode: () => $t,
    ...
    var Dt = 2 * 60 * 1e3,
      _ = class {
        ...
        _checkIfIdle() {
          ...
          Date.now() - this._lastUsedTime > Dt && this._stopWorker();
        }
        _getClient() {
          return (
    ...
    (function (e) {
      function n(r, t) {
        return (
          r === Number.MAX_VALUE && (r = $.MAX_VALUE),
    ...
    (function (e) {
      function n(r, t, o, s) {
        if (a.uinteger(r) && a.uinteger(t) && a.uinteger(o) && a.uinteger(s))
          return { start: I.create(r, t), end: I.create(o, s) };
        if (I.is(r) && I.is(t)) return { start: r, end: t };
        throw new Error(`Range#create called with invalid arguments[${r}, ${t}, ${o}, ${s}]`);
      }
      e.create = n;
      function i(r) {
        let t = r;
        return a.objectLiteral(t) && I.is(t.start) && I.is(t.end);
      }
      e.is = i;
    })(h || (h = {}));
    var B;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          ...
          (h.is(t.originSelectionRange) || a.undefined(t.originSelectionRange))
        );
      }
      e.is = i;
    })(ke || (ke = {}));
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.objectLiteral(t) && h.is(t.range) && ee.is(t.color);
      }
      e.is = i;
    })(Te || (Te = {}));
    var _e;
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && B.is(t.location) && a.string(t.message);
      }
      e.is = i;
    })(te || (te = {}));
    var T;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(o.relatedInformation) || a.typedArray(o.relatedInformation, te.is))
        );
      }
      e.is = i;
    })(q || (q = {}));
    ...
    (function (e) {
      ...
      function t(o) {
        let s = o;
        return w.is(s) && (ne.is(s.annotationId) || E.is(s.annotationId));
      }
      e.is = t;
    })(Ee || (Ee = {}));
    var re;
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && ue.is(t.textDocument) && Array.isArray(t.edits);
      }
      e.is = i;
    })(re || (re = {}));
    var ie;
      ...
      function n(i) {
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every((t) => (a.string(t.kind) ? ie.is(t) || oe.is(t) || se.is(t) : re.is(t))))
        );
      }
      e.is = n;
    })(ae || (ae = {}));
    ...
    (function (e) {
      function n(i) {
        let r = i;
        return a.objectLiteral(i) && de.is(r.kind) && a.string(r.value);
      }
      e.is = n;
    })(L || (L = {}));
    var m;
    ...
    (function (e) {
      function n(i) {
        ...
        return (
          !!r &&
          a.objectLiteral(r) &&
          (L.is(r.contents) || G.is(r.contents) || a.typedArray(r.contents, G.is)) &&
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.defined(t) &&
          a.typedArray(t.diagnostics, q.is) &&
          (t.only === void 0 || a.typedArray(t.only, a.string)) &&
          (t.triggerKind === void 0 || t.triggerKind === J.Invoked || t.triggerKind === J.Automatic)
        );
      }
      e.is = i;
    })($e || ($e = {}));
    ...
    (function (e) {
      function n(r, t, o) {
        let s = { title: r },
          u = !0;
        return (
          typeof t == "string" ? ((u = !1), (s.kind = t)) : b.is(t) ? (s.command = t) : (s.edit = t),
          u && o !== void 0 && (s.kind = o),
          s
        );
      }
      ...
      function i(r) {
        ...
        return (
          t &&
          a.string(t.title) &&
          (t.diagnostics === void 0 || a.typedArray(t.diagnostics, q.is)) &&
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return a.defined(t) && h.is(t.range) && (a.undefined(t.command) || b.is(t.command));
      }
      e.is = i;
    })(qe || (qe = {}));
    var Qe;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.objectLiteral(t) &&
          (t.tooltip === void 0 || a.string(t.tooltip) || L.is(t.tooltip)) &&
          (t.location === void 0 || B.is(t.location)) &&
          (t.command === void 0 || b.is(t.command))
        );
      }
      e.is = i;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          (a.objectLiteral(t) &&
            I.is(t.position) &&
            (a.string(t.label) || a.typedArray(t.label, le.is)) &&
            (t.kind === void 0 || ce.is(t.kind)) &&
            t.textEdits === void 0) ||
    ...
    (function (e) {
      function n(i) {
        let r = i;
        return a.objectLiteral(r) && Z.is(r.uri) && a.string(r.name);
      }
      e.is = n;
    })(gt || (gt = {}));
    var ft;
    (function (e) {
      ...
      function r(o, s) {
        let u = o.getText(),
          g = t(s, (l, p) => {
            let v = l.range.start.line - p.range.start.line;
            return v === 0 ? l.range.start.character - p.range.start.character : v;
          }),
          f = u.length;
        for (let l = g.length - 1; l >= 0; l--) {
          let p = g[l],
            v = o.offsetAt(p.range.start),
            c = o.offsetAt(p.range.end);
          if (c <= f) u = u.substring(0, v) + p.newText + u.substring(c, u.length);
      ...
      function t(o, s) {
        ...
        let l = 0,
          p = 0,
          v = 0;
        for (; l < g.length && p < f.length;) s(g[l], f[p]) <= 0 ? (o[v++] = g[l++]) : (o[v++] = f[p++]);
        for (; l < g.length;) o[v++] = g[l++];
        for (; p < f.length;) o[v++] = f[p++];
        return o;
      }
    })(ft || (ft = {}));
    var ge = class {
...
` &&
        ...
        positionAt(n) {
          ...
          let i = this.getLineOffsets(),
            r = 0,
            t = i.length;
          if (t === 0) return I.create(0, n);
          for (; r < t;) {
            let s = Math.floor((r + t) / 2);
            i[s] > n ? (t = s) : (r = s + 1);
          }
          let o = r - 1;
          return I.create(o, n - i[o]);
        }
        offsetAt(n) {
          let i = this.getLineOffsets();
    ...
    (function (e) {
      ...
      e.number = s;
      function u(c, Y, kt) {
        return n.call(c) === "[object Number]" && Y <= c && c <= kt;
      }
      e.numberRange = u;
      function g(c) {
      ...
      e.objectLiteral = p;
      function v(c, Y) {
        return Array.isArray(c) && c.every(Y);
      }
      e.typedArray = v;
    })(a || (a = {}));
    var W = class {
    ...
    var D = class {
      ...
      provideCompletionItems(n, i, r, t) {
        ...
        return this._worker(o)
          .then((s) => s.doComplete(o.toString(), k(i)))
          .then((s) => {
            if (!s) return;
            let u = n.getWordUntilPosition(i),
              ...
              f = s.items.map((l) => {
                ...
                return (
                  l.textEdit &&
                    (Mt(l.textEdit)
                      ? (p.range = { insert: y(l.textEdit.insert), replace: y(l.textEdit.replace) })
                      : (p.range = y(l.textEdit.range)),
                    (p.insertText = l.textEdit.newText)),
                  l.additionalTextEdits && (p.additionalTextEdits = l.additionalTextEdits.map(P)),
                  l.insertTextFormat === Q.Snippet &&
    ...
    function P(e) {
      if (e) return { range: y(e.range), text: e.newText };
    }
    function jt(e) {
    ...
    var S = class {
      ...
      provideHover(n, i, r) {
        ...
        return this._worker(t)
          .then((o) => o.doHover(t.toString(), k(i)))
          .then((o) => {
            if (o) return { range: y(o.range), contents: Ht(o.contents) };
          });
      }
    };
    function Ut(e) {
...
` +
    ...
    function Ht(e) {
      if (e) return Array.isArray(e) ? e.map(pt) : [pt(e)];
    }
    var F = class {
      constructor(n) {
        this._worker = n;
      ...
      provideDocumentHighlights(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.findDocumentHighlights(t.toString(), k(i)))
          .then((o) => {
            if (o) return o.map((s) => ({ range: y(s.range), kind: Nt(s.kind) }));
          });
      }
    };
    function Nt(e) {
    ...
    var A = class {
      ...
      provideDefinition(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.findDefinition(t.toString(), k(i)))
          .then((o) => {
            if (o) return [ht(o)];
          });
      }
    ...
    function ht(e) {
      return { uri: d.Uri.parse(e.uri), range: y(e.range) };
    }
    var M = class {
        constructor(n) {
          this._worker = n;
        ...
        provideReferences(n, i, r, t) {
          let o = n.uri;
          return this._worker(o)
            .then((s) => s.findReferences(o.toString(), k(i)))
            .then((s) => {
      ...
      K = class {
        ...
        provideRenameEdits(n, i, r, t) {
          let o = n.uri;
          return this._worker(o)
            .then((s) => s.doRename(o.toString(), k(i), r))
            .then((s) => Ot(s));
        }
      };
    function Ot(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let t of e.changes[i])
          n.push({ resource: r, versionId: void 0, textEdit: { range: y(t.range), text: t.newText } });
      }
      return { edits: n };
    }
    var j = class {
    ...
    function mt(e) {
      return {
        ...
        kind: xt(e.kind),
        range: y(e.range),
        selectionRange: y(e.selectionRange),
        tags: e.tags ?? [],
        children: (e.children ?? []).map((n) => mt(n)),
      };
    }
    function xt(e) {
    ...
    var fe = class {
        ...
        provideLinks(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t) return { links: t.map((o) => ({ range: y(o.range), url: o.target })) };
            });
        }
      },
      U = class {
        ...
        provideDocumentFormattingEdits(n, i, r) {
          ...
          return this._worker(t).then((o) =>
            o.format(t.toString(), null, yt(i)).then((s) => {
              if (!(!s || s.length === 0)) return s.map(P);
            }),
          );
        }
      },
      H = class {
        ...
        provideDocumentRangeFormattingEdits(n, i, r, t) {
          ...
          return this._worker(o).then((s) =>
            s.format(o.toString(), pe(i), yt(r)).then((u) => {
              if (!(!u || u.length === 0)) return u.map(P);
            }),
          );
        }
      };
    ...
    var N = class {
        ...
        provideDocumentColors(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t) return t.map((o) => ({ color: o.color, range: y(o.range) }));
            });
        }
        provideColorPresentations(n, i, r) {
          let t = n.uri;
          return this._worker(t)
            .then((o) => o.getColorPresentations(t.toString(), i.color, pe(i.range)))
            .then((o) => {
              if (o)
                return o.map((s) => {
                  let u = { label: s.label };
                  return (
                    s.textEdit && (u.textEdit = P(s.textEdit)),
                    s.additionalTextEdits && (u.additionalTextEdits = s.additionalTextEdits.map(P)),
                    u
                  );
                });
            });
            ...
            .then((o) => {
              if (o)
                return o.map((s) => {
                  ...
                  return (typeof s.kind < "u" && (u.kind = zt(s.kind)), u);
                });
            });
        }
      };
    ...
    var V = class {
      ...
      provideSelectionRanges(n, i, r) {
        let t = n.uri;
        return this._worker(t)
          .then((o) => o.getSelectionRanges(t.toString(), i.map(k)))
          .then((o) => {
            if (o)
              return o.map((s) => {
                let u = [];
    ...
    function $t(e) {
      ...
      function o() {
        ...
        (It(i),
          u.completionItems && i.push(d.languages.registerCompletionItemProvider(s, new D(t, ["/", "-", ":"]))),
          u.hovers && i.push(d.languages.registerHoverProvider(s, new S(t))),
          u.documentHighlights && i.push(d.languages.registerDocumentHighlightProvider(s, new F(t))),
          u.definitions && i.push(d.languages.registerDefinitionProvider(s, new A(t))),
          u.references && i.push(d.languages.registerReferenceProvider(s, new M(t))),
          u.documentSymbols && i.push(d.languages.registerDocumentSymbolProvider(s, new j(t))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new K(t))),
          u.colors && i.push(d.languages.registerColorProvider(s, new N(t))),
          u.foldingRanges && i.push(d.languages.registerFoldingRangeProvider(s, new O(t))),
          u.diagnostics && i.push(new W(s, t, e.onDidChange)),
          u.selectionRanges && i.push(d.languages.registerSelectionRangeProvider(s, new V(t))),
          u.documentFormattingEdits && i.push(d.languages.registerDocumentFormattingEditProvider(s, new U(t))),
          u.documentRangeFormattingEdits &&
            i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new H(t))));
      }
      return (o(), n.push(vt(i)), vt(n));
    }
    function vt(e) {
      return { dispose: () => It(e) };
    }
