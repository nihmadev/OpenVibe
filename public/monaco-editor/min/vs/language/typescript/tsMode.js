...
define("vs/language/typescript/tsMode", ["require", "require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var ne = (n, e) => () => (e || n((e = { exports: {} }).exports, e), e.exports),
      ...
      H = (n, e, t, i) => {
        if ((e && typeof e == "object") || typeof e == "function")
          for (let l of ie(e))
            !se.call(n, l) && l !== t && K(n, l, { get: () => e[l], enumerable: !(i = te(e, l)) || i.enumerable });
        return n;
      },
      $ = (n, e, t) => (H(n, e, "default"), t && H(t, e, "default")),
      z = (n, e, t) => (
        (t = n != null ? ee(re(n)) : {}),
        H(e || !n || !n.__esModule ? K(t, "default", { value: n, enumerable: !0 }) : t, n)
      ),
      ae = (n) => H(K({}, "__esModule", { value: !0 }), n);
    var G = ne((he, J) => {
    ...
    function U(n, e, t = 0) {
      ...
      if (((i += n.messageText), t++, n.next)) for (let l of n.next) i += U(l, e, t);
      return i;
    }
    function S(n) {
      return n ? n.map((e) => e.text).join("") : "";
    }
    var k = class {
        constructor(e) {
          this._worker = e;
        ...
        _textSpanToRange(e, t) {
          let i = e.getPositionAt(t.start),
            ...
            { lineNumber: u, column: c } = i,
            { lineNumber: g, column: o } = l;
          return { startLineNumber: u, startColumn: c, endLineNumber: g, endColumn: o };
        }
      },
      _ = class {
        constructor(e) {
        ...
        getOrCreateModel(e) {
          let t = s.Uri.parse(e),
            i = s.editor.getModel(t);
          if (i) return i;
          if (this.isLibFile(t) && this._hasFetchedLibFiles)
            return s.editor.createModel(this._libFiles[t.path.slice(1)], "typescript", t);
          let l = q.typescriptDefaults.getExtraLibs()[e];
          return l ? s.editor.createModel(l.content, "typescript", t) : null;
        }
        _containsLibFile(e) {
    ...
    var T = class extends k {
          ...
          let c = (a) => {
              ...
              let d = () => {
                ...
                b = a.onDidChangeAttached(() => {
                  let { onlyVisible: y } = this._defaults.getDiagnosticsOptions();
                  y && (a.isAttachedToEditor() ? d() : s.editor.setModelMarkers(a, this._selector, []));
                });
            ...
            g = (a) => {
              s.editor.setModelMarkers(a, this._selector, []);
              let d = a.uri.toString();
              this._listener[d] && (this._listener[d].dispose(), delete this._listener[d]);
            };
          (this._disposables.push(s.editor.onDidCreateModel((a) => c(a))),
            this._disposables.push(s.editor.onWillDisposeModel(g)),
            this._disposables.push(
              s.editor.onDidChangeModelLanguage((a) => {
                (g(a.model), c(a.model));
              }),
            ),
            this._disposables.push({
              dispose() {
                for (let a of s.editor.getModels()) g(a);
              },
            }));
          let o = () => {
            for (let a of s.editor.getModels()) (g(a), c(a));
          };
          (this._disposables.push(this._defaults.onDidChange(o)),
            this._disposables.push(this._defaults.onDidExtraLibsChange(o)),
            s.editor.getModels().forEach((a) => c(a)));
        }
        dispose() {
        ...
        async _doValidate(t) {
          ...
          let a = o
            ...
            d = a
              ...
              .reduce((p, f) => f.concat(p), [])
              .map((p) => (p.file ? s.Uri.parse(p.file.fileName) : null));
        ...
        _convertDiagnostics(t, i) {
          let l = i.start || 0,
            u = i.length || 1,
            { lineNumber: c, column: g } = t.getPositionAt(l),
            { lineNumber: o, column: a } = t.getPositionAt(l + u),
            d = [];
          return (
            i.reportsUnnecessary && d.push(s.MarkerTag.Unnecessary),
            i.reportsDeprecated && d.push(s.MarkerTag.Deprecated),
            {
...
`,
        ...
        _convertRelatedInformation(t, i) {
          ...
          return (
            i.forEach((u) => {
              let c = t;
              if ((u.file && (c = this._libFiles.getOrCreateModel(u.file.fileName)), !c)) return;
              let g = u.start || 0,
                o = u.length || 1,
                { lineNumber: a, column: d } = c.getPositionAt(g),
                { lineNumber: p, column: f } = c.getPositionAt(g + o);
              l.push({
                resource: c.uri,
                startLineNumber: a,
                startColumn: d,
      ...
      C = class n extends k {
        ...
        async provideCompletionItems(e, t, i, l) {
          let u = e.getWordUntilPosition(t),
            c = new s.Range(t.lineNumber, u.startColumn, t.lineNumber, u.endColumn),
            g = e.uri,
            o = e.getOffsetAt(t),
            ...
            : {
                suggestions: d.entries.map((f) => {
                  ...
                  if (f.replacementSpan) {
                    ...
                    b = new s.Range(W.lineNumber, W.column, w.lineNumber, w.column);
                  }
                  let y = [];
                  return (
                    f.kindModifiers !== void 0 &&
                      f.kindModifiers.indexOf("deprecated") !== -1 &&
                      y.push(s.languages.CompletionItemTag.Deprecated),
                    {
                      uri: g,
                      position: t,
                      offset: o,
        ...
        async resolveCompletionItem(e, t) {
          let i = e,
            ...
            u = i.position,
            c = i.offset,
            o = await (await this._worker(l)).getCompletionEntryDetails(l.toString(), c, i.label);
          return o
            ? {
                uri: l,
                position: u,
                label: o.name,
                kind: n.convertKind(o.kind),
                detail: S(o.displayParts),
                documentation: { value: n.createDocumentationString(o) },
              }
            : i;
        }
...
${Q(i)}`;
    ...
    function Q(n) {
      let e = `*@${n.name}*`;
      if (n.name === "param" && n.text) {
        let [t, ...i] = n.text;
        ((e += `\`${t.text}\``), i.length > 0 && (e += ` \u2014 ${i.map((l) => l.text).join(" ")}`));
      } else
        Array.isArray(n.text)
          ? (e += ` \u2014 ${n.text.map((t) => t.text).join(" ")}`)
          : n.text && (e += ` \u2014 ${n.text}`);
      return e;
    }
    var I = class n extends k {
        constructor() {
          super(...arguments);
        ...
        static _toSignatureHelpTriggerReason(t) {
          switch (t.triggerKind) {
            ...
            case s.languages.SignatureHelpTriggerKind.Invoke:
            default:
              return { kind: "invoked" };
          }
        }
        async provideSignatureHelp(t, i, l, u) {
          let c = t.uri,
            g = t.getOffsetAt(i),
            o = await this._worker(c);
          if (t.isDisposed()) return;
          let a = await o.getSignatureHelpItems(c.toString(), g, { triggerReason: n._toSignatureHelpTriggerReason(u) });
      ...
      P = class extends k {
        async provideHover(e, t, i) {
          let l = e.uri,
            u = e.getOffsetAt(t),
            c = await this._worker(l);
          if (e.isDisposed()) return;
          let g = await c.getQuickInfoAtPosition(l.toString(), u);
          if (!g || e.isDisposed()) return;
          let o = S(g.documentation),
            a = g.tags
              ? g.tags.map((p) => Q(p)).join(`  
...
` + a
      ...
      D = class extends k {
        async provideDocumentHighlights(e, t, i) {
          let l = e.uri,
            ...
            c = await this._worker(l);
          if (e.isDisposed()) return;
          let g = await c.getDocumentHighlights(l.toString(), u, [l.toString()]);
          if (!(!g || e.isDisposed()))
            return g.flatMap((o) =>
      ...
      F = class extends k {
        ...
        async provideDefinition(t, i, l) {
          ...
          if (t.isDisposed()) return;
          let o = await g.getDefinitionAtPosition(u.toString(), c);
          if (
            !o ||
            t.isDisposed() ||
            (await this._libFiles.fetchLibFilesIfNecessary(o.map((d) => s.Uri.parse(d.fileName))), t.isDisposed())
          )
            return;
          let a = [];
          for (let d of o) {
      ...
      L = class extends k {
        ...
        async provideReferences(t, i, l, u) {
          let c = t.uri,
            ...
            o = await this._worker(c);
          if (t.isDisposed()) return;
          let a = await o.getReferencesAtPosition(c.toString(), g);
          if (
            !a ||
            t.isDisposed() ||
            (await this._libFiles.fetchLibFilesIfNecessary(a.map((p) => s.Uri.parse(p.fileName))), t.isDisposed())
          )
            return;
          let d = [];
          for (let p of a) {
      ...
      M = class extends k {
        async provideDocumentSymbols(e, t) {
          ...
          if (e.isDisposed()) return;
          let u = await l.getNavigationTree(i.toString());
          if (!u || e.isDisposed()) return;
          let c = (o, a) => ({
            name: o.text,
            detail: "",
            kind: h[o.kind] || s.languages.SymbolKind.Variable,
            range: this._textSpanToRange(e, o.spans[0]),
            selectionRange: this._textSpanToRange(e, o.spans[0]),
            tags: [],
            children: o.childItems?.map((p) => c(p, o.text)),
            containerName: a,
          });
          return u.childItems ? u.childItems.map((o) => c(o)) : [];
        }
      },
      m = class {
        static {
    ...
    h[m.module] = s.languages.SymbolKind.Module;
    h[m.class] = s.languages.SymbolKind.Class;
    h[m.enum] = s.languages.SymbolKind.Enum;
    h[m.interface] = s.languages.SymbolKind.Interface;
    h[m.memberFunction] = s.languages.SymbolKind.Method;
    h[m.memberVariable] = s.languages.SymbolKind.Property;
    h[m.memberGetAccessor] = s.languages.SymbolKind.Property;
    h[m.memberSetAccessor] = s.languages.SymbolKind.Property;
    h[m.variable] = s.languages.SymbolKind.Variable;
    h[m.const] = s.languages.SymbolKind.Variable;
    h[m.localVariable] = s.languages.SymbolKind.Variable;
    h[m.variable] = s.languages.SymbolKind.Variable;
    h[m.function] = s.languages.SymbolKind.Function;
    h[m.localFunction] = s.languages.SymbolKind.Function;
...
`,
      ...
      A = class extends x {
        ...
        async provideDocumentRangeFormattingEdits(t, i, l, u) {
          let c = t.uri,
            ...
            a = await this._worker(c);
          if (t.isDisposed()) return;
          let d = await a.getFormattingEditsForRange(c.toString(), g, o, x._convertOptions(l));
...
`,
        ...
        async provideOnTypeFormattingEdits(e, t, i, l, u) {
          let c = e.uri,
            ...
            o = await this._worker(c);
          if (e.isDisposed()) return;
          let a = await o.getFormattingEditsAfterKeystroke(c.toString(), g, i, x._convertOptions(l));
      ...
      O = class extends x {
        async provideCodeActions(e, t, i, l) {
          let u = e.uri,
            c = e.getOffsetAt({ lineNumber: t.startLineNumber, column: t.startColumn }),
            ...
            a = i.markers
              ...
              .map((b) => b.code)
              .map(Number),
            d = await this._worker(u);
          if (e.isDisposed()) return;
          let p = await d.getCodeFixesAtPosition(u.toString(), c, g, a, o);
      ...
      N = class extends k {
        async provideInlayHints(e, t, i) {
          ...
          return e.isDisposed()
            ? null
            : {
                hints: (await o.provideInlayHints(u, c, g)).map((p) => ({
                  ...p,
                  label: p.text,
        ...
        _convertHintKind(e) {
          switch (e) {
            case "Parameter":
              return s.languages.InlayHintKind.Parameter;
            case "Type":
              return s.languages.InlayHintKind.Type;
            default:
              return s.languages.InlayHintKind.Type;
          }
        }
    ...
    function X(n, e) {
      let t = [],
        ...
        l = new v(e, n);
      t.push(l);
      let u = (...o) => l.getLanguageServiceWorker(...o),
        c = new _(u);
      function g() {
        let { modeConfiguration: o } = n;
        (Y(i),
          o.completionItems && i.push(s.languages.registerCompletionItemProvider(e, new C(u))),
          o.signatureHelp && i.push(s.languages.registerSignatureHelpProvider(e, new I(u))),
          o.hovers && i.push(s.languages.registerHoverProvider(e, new P(u))),
          o.documentHighlights && i.push(s.languages.registerDocumentHighlightProvider(e, new D(u))),
          o.definitions && i.push(s.languages.registerDefinitionProvider(e, new F(c, u))),
          o.references && i.push(s.languages.registerReferenceProvider(e, new L(c, u))),
          o.documentSymbols && i.push(s.languages.registerDocumentSymbolProvider(e, new M(u))),
          o.rename && i.push(s.languages.registerRenameProvider(e, new E(c, u))),
          o.documentRangeFormattingEdits &&
            i.push(s.languages.registerDocumentRangeFormattingEditProvider(e, new A(u))),
          o.onTypeFormattingEdits && i.push(s.languages.registerOnTypeFormattingEditProvider(e, new R(u))),
          o.codeActions && i.push(s.languages.registerCodeActionProvider(e, new O(u))),
          o.inlayHints && i.push(s.languages.registerInlayHintsProvider(e, new N(u))),
          o.diagnostics && i.push(new T(c, n, e, u)));
      }
      return (g(), t.push(fe(i)), u);
    }
    function fe(n) {
      return { dispose: () => Y(n) };
    }
