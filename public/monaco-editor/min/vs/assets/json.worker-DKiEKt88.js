...
` +
  ...
  (function (t) {
    ...
    function* b(L, S, P = L.length) {
      for (
        S < -L.length && (S = 0), S < 0 && (S += L.length), P < 0 ? (P += L.length) : P > L.length && (P = L.length);
        S < P;
        S++
      )
        yield L[S];
      ...
      if (e.prev !== Y.Undefined && e.next !== Y.Undefined) {
        ...
        e.prev === Y.Undefined && e.next === Y.Undefined
          ...
          : e.next === Y.Undefined
            ...
            : e.prev === Y.Undefined && ((this._first = this._first.next), (this._first.prev = Y.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let e = this._first;
  ...
  class hn {
    ...
    constructor(e) {
      ((this._now = e === !1 ? Date.now : Xo), (this._startTime = this._now()), (this._stopTime = -1));
    }
    stop() {
...
`),
  ...
  ((Oe.ambiguousCharacterData = new tr(() =>
    ...
    (Oe._locales = new tr(() => Object.keys(Oe.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")))));
  let Bt = Oe;
  const Ft = class Ft {
    static getRawData() {
      return JSON.parse(
  ...
  class Rl {
    ...
    async sendMessage(e, n, r) {
      ...
      return new Promise((s, a) => {
        ((this._pendingReplies[i] = { resolve: s, reject: a }), this._send(new _l(this._workerId, i, e, n, r)));
      });
    }
    listen(e, n, r) {
      let i = null;
          ...
          typeof s == "string" &&
            ...
            (di(s)
              ...
              : mi(s)
                ...
                : s.charCodeAt(0) === 36 && (i[s] = async (...a) => (await n?.(), this.sendMessage(e, s, a)))),
          i[s]
        ),
      };
  ...
  class El {
    ...
    _handleMessage(e, n, r) {
      ...
      const s = i[n];
      if (typeof s != "function") return Promise.reject(new Error(`Missing method ${n} on worker thread channel ${e}`));
      try {
  ...
  class yi {
    ...
    MarkNextChange() {
      ((this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
        this.m_changes.push(
          new ze(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
        ),
        (this.m_originalCount = 0),
        (this.m_modifiedCount = 0),
        (this.m_originalStart = 1073741824),
  ...
  class Ge {
    ...
    ComputeRecursionPoint(e, n, r, i, s, a, o) {
      let u = 0,
        ...
        m = 0,
        g = 0;
      (e--, r--, (s[0] = 0), (a[0] = 0), (this.m_forwardHistory = []), (this.m_reverseHistory = []));
      const d = n - e + (i - r),
        p = d + 1,
        y = new Int32Array(p),
        x = new Int32Array(p),
      ...
      for (let S = 1; S <= d / 2 + 1; S++) {
        let P = 0,
          D = 0;
        ((h = this.ClipDiagonalBound(v - S, S, v, p)), (f = this.ClipDiagonalBound(v + S, S, v, p)));
        for (let w = h; w <= f; w += 2) {
          (w === h || (w < f && y[w - 1] < y[w + 1]) ? (u = y[w + 1]) : (u = y[w - 1] + 1), (l = u - (w - v) - _));
          const k = u;
          for (; u < n && l < i && this.ElementsAreEqual(u + 1, l + 1);) (u++, l++);
          if (((y[w] = u), u + l > P + D && ((P = u), (D = l)), !L && Math.abs(w - b) <= S - 1 && u >= x[w]))
            return (
              (s[0] = u),
              (a[0] = l),
              k <= x[w] && S <= 1448 ? this.WALKTRACE(v, h, f, _, b, m, g, N, y, x, u, n, s, l, i, a, L, o) : null
            );
        }
        const T = (P - e + (D - r) - S) / 2;
        ...
        ((m = this.ClipDiagonalBound(b - S, S, b, p)), (g = this.ClipDiagonalBound(b + S, S, b, p)));
        for (let w = m; w <= g; w += 2) {
          (w === m || (w < g && x[w - 1] >= x[w + 1]) ? (u = x[w + 1] - 1) : (u = x[w - 1]), (l = u - (w - b) - N));
          const k = u;
          ...
          if (((x[w] = u), L && Math.abs(w - v) <= S && u <= y[w]))
            return (
              (s[0] = u),
              (a[0] = l),
              k >= y[w] && S <= 1448 ? this.WALKTRACE(v, h, f, _, b, m, g, N, y, x, u, n, s, l, i, a, L, o) : null
            );
        }
        if (S <= 1447) {
    ...
    PrettifyChanges(e) {
      for (let n = 0; n < e.length; n++) {
        ...
        for (
          ...
          (!a || this.OriginalElementsAreEqual(r.originalStart, r.originalStart + r.originalLength)) &&
          (!o || this.ModifiedElementsAreEqual(r.modifiedStart, r.modifiedStart + r.modifiedLength));
        ) {
      ...
      for (let n = e.length - 1; n >= 0; n--) {
        ...
        for (let f = 1; ; f++) {
          ...
          if (
            ...
            break;
          const p = (m === i && g === s ? 5 : 0) + this._boundaryScore(m, r.originalLength, g, r.modifiedLength);
          p > l && ((l = p), (u = f));
        }
      ...
      if (this._hasStrings)
        for (let n = 1, r = e.length; n < r; n++) {
          ...
          if (a < 5 && l < 20 && m < 20) {
            ...
            if (g) {
              const [d, p] = g;
              (d !== i.originalStart + i.originalLength || p !== i.modifiedStart + i.modifiedLength) &&
    ...
    ChangesOverlap(e, n, r) {
      if (
        (mt.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"),
        mt.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"),
        e.originalStart + e.originalLength >= n.originalStart || e.modifiedStart + e.modifiedLength >= n.modifiedStart)
      ) {
  ...
  let Q = class ct {
    ...
    B = class re {
      constructor(e, n, r, i) {
        e > r || (e === r && n > i)
          ? ((this.startLineNumber = r), (this.startColumn = i), (this.endLineNumber = e), (this.endColumn = n))
          : ((this.startLineNumber = e), (this.startColumn = n), (this.endLineNumber = r), (this.endColumn = i));
      }
      isEmpty() {
      ...
      delta(e) {
        return new re(this.startLineNumber + e, this.startColumn, this.endLineNumber + e, this.endColumn);
      }
      isSingleLine() {
  ...
  function Dl(t) {
    return !t || typeof t.getLineCount != "function" || typeof t.getLineContent != "function" ? [] : dn.computeLinks(t);
  }
  const On = class On {
    constructor() {
  ...
  class pn {
    ...
    get onCancellationRequested() {
      return this._isCancelled ? xi : (this._emitter || (this._emitter = new Pe()), this._emitter.event);
    }
    dispose() {
  ...
  function wn(t, e, n, r) {
    ...
    for (let l = 0; l <= t.length; ++l) {
      ...
      if (r(u)) {
        if (!(a === l - 1 || o === 1))
          if (o === 2) {
            if (i.length < 2 || s !== 2 || i.charCodeAt(i.length - 1) !== rt || i.charCodeAt(i.length - 2) !== rt) {
              if (i.length > 2) {
                const h = i.lastIndexOf(n);
                (h === -1 ? ((i = ""), (s = 0)) : ((i = i.slice(0, h)), (s = i.length - 1 - i.lastIndexOf(n))),
                  (a = l),
                  (o = 0));
                continue;
              } else if (i.length !== 0) {
          ...
          } else (i.length > 0 ? (i += `${n}${t.slice(a + 1, l)}`) : (i = t.slice(a + 1, l)), (s = l - a - 1));
        ((a = l), (o = 0));
      } else u === rt && o !== -1 ? ++o : (o = -1);
    }
    return i;
  ...
  const fe = {
        ...
        for (let i = t.length - 1; i >= -1; i--) {
          ...
          if (i >= 0) {
            ...
            e.length === 0
              ? (s = yn())
              : ((s = jl[`=${e}`] || yn()),
                (s === void 0 || (s.slice(0, 2).toLowerCase() !== e.toLowerCase() && s.charCodeAt(2) === de)) &&
                  (s = `${e}\\`));
          const a = s.length;
          let o = 0,
            u = "",
      ...
      relative(t, e) {
        ...
        if (m !== h) {
          ...
          (a > h && (t.charCodeAt(i + m) === de ? (f = m) : m === 2 && (f = 3)), f === -1 && (f = 0));
        }
        let g = "";
        for (m = i + f + 1; m <= s; ++m) (m === s || t.charCodeAt(m) === de) && (g += g.length === 0 ? ".." : "\\..");
        return ((o += f), g.length > 0 ? `${g}${r.slice(o, u)}` : (r.charCodeAt(o) === de && ++o, r.slice(o, u)));
      },
      toNamespacedPath(t) {
        ...
        } else if (Ue(e.charCodeAt(0)) && e.charCodeAt(1) === Be && e.charCodeAt(2) === de) return `\\\\?\\${e}`;
        return e;
      },
      dirname(t) {
        te(t, "path");
        ...
        } else Ue(i) && t.charCodeAt(1) === Be && ((n = e > 2 && U(t.charCodeAt(2)) ? 3 : 2), (r = n));
        let s = -1,
          a = !0;
        for (let o = e - 1; o >= r; --o)
          if (U(t.charCodeAt(o))) {
      ...
      extname(t) {
        ...
        return n === -1 || i === -1 || a === 0 || (a === 1 && n === i - 1 && n === r + 1) ? "" : t.slice(n, i);
      },
      format: Ni.bind(null, "\\"),
      parse(t) {
        te(t, "path");
    ...
    ge = {
      resolve(...t) {
        ...
        for (let r = t.length - 1; r >= 0 && !n; r--) {
          const i = t[r];
          (te(i, `paths[${r}]`), i.length !== 0 && ((e = `${i}/${e}`), (n = i.charCodeAt(0) === ae)));
        }
        if (!n) {
          const r = Yl();
      ...
      relative(t, e) {
        if ((te(t, "from"), te(e, "to"), t === e || ((t = ge.resolve(t)), (e = ge.resolve(e)), t === e))) return "";
        const n = 1,
          r = t.length,
          i = r - n,
          s = 1,
        ...
        let h = "";
        for (l = n + u + 1; l <= r; ++l) (l === r || t.charCodeAt(l) === ae) && (h += h.length === 0 ? ".." : "/..");
  ...
  function nu(t, e) {
    ...
    if (t.scheme && !Kl.test(t.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (t.path) {
      if (t.authority) {
        if (!eu.test(t.path))
          throw new Error(
  ...
  let hr = class jn {
    ...
    with(e) {
      ...
      return (
        ...
        n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment
          ? this
          : new bt(n, r, i, s, a)
      );
    }
    ...
    static file(e) {
      ...
      if (($t && (e = e.replace(/\\/g, ke)), e[0] === ke && e[1] === ke)) {
        ...
        r === -1 ? ((n = e.substring(2)), (e = ke)) : ((n = e.substring(2, r)), (e = e.substring(r) || ke));
      }
    ...
    static joinPath(e, ...n) {
      ...
      let r;
      return (
        $t && e.scheme === "file" ? (r = jn.file(fe.join(mr(e, !0), ...n)).path) : (r = ge.join(e.path, ...n)),
        e.with({ path: r })
      );
    }
    toString(e = !1) {
    ...
    static revive(e) {
      if (e) {
        ...
        {
          const n = new bt(e);
          return ((n._formatted = e.external ?? null), (n._fsPath = e._sep === _i ? (e.fsPath ?? null) : null), n);
        }
      } else return e;
    }
  };
  ...
  function au(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const r = t.charCodeAt(n);
      r === 35 || r === 63 ? (e === void 0 && (e = t.substr(0, n)), (e += Si[r])) : e !== void 0 && (e += t[n]);
    }
    return e !== void 0 ? e : t;
  }
  function mr(t, e) {
  ...
  function dr(t, e) {
    ...
    return (o && ((r += "?"), (r += n(o, !1, !1))), u && ((r += "#"), (r += e ? u : Ai(u, !1, !1))), r);
  }
  function ki(t) {
    try {
  ...
  class be extends B {
    ...
    static liftSelection(e) {
      return new be(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn);
    }
  ...
  (function (t) {
    ((t[(t.acceptSuggestionOnCommitCharacter = 0)] = "acceptSuggestionOnCommitCharacter"),
      ...
      (t[(t.inlineCompletionsAccessibilityVerbose = 169)] = "inlineCompletionsAccessibilityVerbose"),
    ...
    touch(e, n) {
      ...
      if (!(n !== 1 && n !== 2)) {
        if (n === 1) {
          ...
          const r = e.next,
            i = e.previous;
          (e === this._tail ? ((i.next = void 0), (this._tail = i)) : ((r.previous = i), (i.next = r)),
            (e.previous = void 0),
            (e.next = this._head),
          ...
          const r = e.next,
            i = e.previous;
          (e === this._head ? ((r.previous = void 0), (this._head = r)) : ((r.previous = i), (i.next = r)),
            (e.next = void 0),
  ...
  function xr(t, e, n, r, i) {
    ...
    if (u) {
      const l = { word: u[0], startColumn: r + 1 + u.index, endColumn: r + 1 + u.index + u[0].length };
      ...
      switch (r.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const s = e.codePointAt(0),
            ...
            o = Bt.getLocales().filter((u) => !Bt.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(s));
  ...
  class Us {
    ...
    getCandidateCodePoints() {
      ...
      const e = new Set();
      if (this.options.invisibleCharacters) for (const n of Ut.codePoints) qs(String.fromCodePoint(n)) || e.add(n);
      ...
      if (n)
        for (const a of n) {
          const o = a.codePointAt(0),
            u = Ll(a);
          ((i = i || u), !u && !this.ambiguousCharacters.isAmbiguous(o) && !Ut.isInvisibleCharacter(o) && (s = !0));
        }
      return !i && s
        ? 0
...
` ||
  ...
  function Mu(t, e) {
    for (let n = 0; n <= t.length; n++) e(n === 0 ? void 0 : t[n - 1], n === t.length ? void 0 : t[n]);
  }
  function Tu(t, e) {
    for (let n = 0; n < t.length; n++) e(n === 0 ? void 0 : t[n - 1], t[n], n + 1 === t.length ? void 0 : t[n + 1]);
  }
  function Pu(t, e) {
  ...
  class j {
    ...
    constructor(e, n) {
      if (((this.start = e), (this.endExclusive = n), e > n)) throw new le(`Invalid range: ${this.toString()}`);
    }
    get isEmpty() {
    ...
    joinRightTouching(e) {
      if (this.endExclusive !== e.start) throw new le(`Invalid join: ${this.toString()} and ${e.toString()}`);
  ...
  class Ie {
      ...
      for (; r < this._normalizedRanges.length || i < e._normalizedRanges.length;) {
        ...
        s === null
          ...
          : s.endLineNumberExclusive >= a.startLineNumber
            ? (s = new H(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)))
            : (n.push(s), (s = a));
      }
    ...
    subtractFrom(e) {
      ...
      for (let a = n; a < r; a++) {
        ...
        (o.startLineNumber > s && i.push(new H(s, o.startLineNumber)), (s = o.endLineNumberExclusive));
      }
...
`,
  ...
  class Le {
    ...
    toRangeMapping2(e, n) {
      if (Ws(this.original.endLineNumberExclusive, e) && Ws(this.modified.endLineNumberExclusive, n))
        return new Ne(
          new B(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new B(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
        );
  ...
  function Hs(t, e, n, r = !1) {
    ...
    for (const s of Eu(
      t.map((a) => $u(a, e, n)),
      (a, o) => a.original.intersectsOrTouches(o.original) || a.modified.intersectsOrTouches(o.modified),
    )) {
      const a = s[0],
        o = s[s.length - 1];
      i.push(
      ...
      for (const u of s.changes) {
        ...
        let f = new qe(
          ...
          u.charChanges?.map(
            (m) =>
              new Ne(
                new B(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn),
                new B(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn),
              ),
          ),
        );
        (o &&
  ...
  class qu {
    ...
    getEndColumn(e) {
      return e === -1
        ...
        : (this._assertIndex(e, this._columns), this._charCodes[e] === 10 ? 1 : this._columns[e] + 1);
    }
  }
  class Lt {
  ...
  class Wu {
    constructor(e, n, r) {
      ((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.continueCharDiff = Js(r.maxComputationTime === 0 ? 0 : Math.min(r.maxComputationTime, 5e3))));
    }
    computeDiff() {
    ...
    _pushTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
      ...
      let u;
      (this.shouldComputeCharChanges && (u = [new Lt(n, r, n, i, s, a, s, o)]), e.push(new zt(n, n, s, s, u)));
    }
    _mergeTrimWhitespaceCharChange(e, n, r, i, s, a, o) {
      ...
      return l.originalEndLineNumber === 0 || l.modifiedEndLineNumber === 0
        ...
        : l.originalEndLineNumber === n && l.modifiedEndLineNumber === s
          ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Lt(n, r, n, i, s, a, s, o)), !0)
          : l.originalEndLineNumber + 1 === n && l.modifiedEndLineNumber + 1 === s
            ? ((l.originalEndLineNumber = n),
              (l.modifiedEndLineNumber = s),
              this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Lt(n, r, n, i, s, a, s, o)),
              !0)
            : !1;
    }
  }
        ...
        Mu(e, (i, s) => {
          r.push(
            K.fromOffsetPairs(
              ...
              s ? s.getStarts() : new We(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n),
            ),
          );
        }),
        r
    ...
    compute(e, n, r = Gt.instance, i) {
      ...
      for (let d = 0; d < e.length; d++)
        for (let p = 0; p < n.length; p++) {
          ...
          } else b === y ? (o.set(d, p, 0), a.set(d, p, 1)) : b === x && (o.set(d, p, 0), a.set(d, p, 2));
          s.set(d, p, b);
        }
      const u = [];
      let l = e.length,
        h = n.length;
      function f(d, p) {
        ((d + 1 !== l || p + 1 !== h) && u.push(new K(new j(d + 1, l), new j(p + 1, h))), (l = d), (h = p));
      }
      let m = e.length - 1,
        g = n.length - 1;
      for (; m >= 0 && g >= 0;) a.get(m, g) === 3 ? (f(m, g), m--, g--) : a.get(m, g) === 1 ? m-- : g--;
    ...
    compute(e, n, r = Gt.instance) {
      ...
      e: for (;;) {
        ...
        for (h = p; h <= y; h += 2) {
          ...
          if ((l.set(h, N !== b ? new Qs(E, b, _, N - b) : E), u.get(h) === i.length && u.get(h) - h === s.length))
            break e;
        }
      }
      let f = l.get(h);
...
`).length >= 15 && Zu(f, (g) => g.length >= 2) >= 2
  ...
  function Yu(t, e, n, r) {
    const i = [],
      s = t.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new _n(u.original, e, u)),
      a = new Set(t.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new _n(u.modified, n, u))),
      o = new Set();
    for (const u of s) {
      let l = -1,
        h;
      ...
      if (
        (l > 0.9 && h && (a.delete(h), i.push(new Le(u.range, h.range)), o.add(u.source), o.add(h.source)),
        !r.isValid())
      )
  ...
  function Ku(t, e, n, r, i, s) {
        ...
        (o.forEach(p, ({ range: v }) => {
          for (const _ of g)
            if (
              ...
              ((_.originalLineRange = new H(_.originalLineRange.startLineNumber, v.endLineNumberExclusive)),
                (_.modifiedLineRange = new H(_.modifiedLineRange.startLineNumber, y.endLineNumberExclusive)),
                x.push(_));
              return;
            }
    ...
    for (let m = 0; m < a.length; m++) {
      const g = a[m],
        ...
        x = f.findLastMonotonous((E) => E.original.startLineNumber < g.original.endLineNumberExclusive),
      ...
      for (_ = 0; _ < y; _++) {
        ...
        if (E > r.length || L > i.length || l.contains(L) || h.contains(E) || !ea(r[E - 1], i[L - 1], s)) break;
      }
      _ > 0 &&
      ...
      (N > 0 &&
        (h.addRange(new H(g.original.endLineNumberExclusive, g.original.endLineNumberExclusive + N)),
        l.addRange(new H(g.modified.endLineNumberExclusive, g.modified.endLineNumberExclusive + N))),
        (_ > 0 || N > 0) &&
          (a[m] = new Le(
  ...
  function ea(t, e, n) {
    ...
    const i = new Xs().compute(new Sn([t], new B(1, 1, 1, t.length), !1), new Sn([e], new B(1, 1, 1, e.length), !1), n);
    let s = 0;
  ...
  function tc(t, e) {
    ...
    return (
      (e = e.filter((r) => {
        const i =
            n.findLastMonotonous((o) => o.original.startLineNumber < r.original.endLineNumberExclusive) ||
      ...
      for (let o = 1; o < r.length; o++) {
        let h = function (m, g) {
          ...
          return (
            ...
            (m.seq1Range.length + m.seq2Range.length > 5 || g.seq1Range.length + g.seq2Range.length > 5)
          );
        };
        const u = r[o],
          l = a[a.length - 1];
...
`);
  ...
  class oc {
    ...
    computeMoves(e, n, r, i, s, a, o, u) {
      return Qu(e, n, r, i, s, a).map((f) => {
        const m = this.refineDiff(n, r, new K(f.original.toOffsetRange(), f.modified.toOffsetRange()), a, o, u),
    ...
    refineDiff(e, n, r, i, s, a) {
      ...
      return (
        ...
        (m = ac(l, h, m)),
        {
          mappings: m.map((d) => new Ne(l.translateRange(d.seq1Range), h.translateRange(d.seq2Range))),
    ...
    static toRGBA(e) {
      ...
      if (r === 0) a = o = u = i;
        ...
        const l = i < 0.5 ? i * (1 + r) : i + r - i * r,
          h = 2 * i - l;
        ((a = _e._hue2rgb(h, l, n + 1 / 3)), (o = _e._hue2rgb(h, l, n)), (u = _e._hue2rgb(h, l, n - 1 / 3)));
      }
  ...
  let An =
    ((J = class {
      ...
      equals(e) {
        return !!e && A.equals(this.rgba, e.rgba) && _e.equals(this.hsla, e.hsla) && _t.equals(this.hsva, e.hsva);
      }
      ...
      makeOpaque(e) {
        ...
        const { r: n, g: r, b: i, a: s } = this.rgba;
        return new J(
          new A(e.rgba.r - s * (e.rgba.r - n), e.rgba.g - s * (e.rgba.g - r), e.rgba.b - s * (e.rgba.b - i), 1),
        );
      }
      toString() {
      ...
      toNumber32Bit() {
        return (
          this._toNumber32Bit ||
            (this._toNumber32Bit =
              ((this.rgba.r << 24) | (this.rgba.g << 16) | (this.rgba.b << 8) | ((this.rgba.a * 255) << 0)) >>> 0),
          this._toNumber32Bit
        );
      }
  ...
  (function (t) {
    (function (e) {
      (function (n) {
        function r(p) {
          return p.rgba.a === 1 ? `rgb(${p.rgba.r}, ${p.rgba.g}, ${p.rgba.b})` : t.Format.CSS.formatRGBA(p);
        }
        n.formatRGB = r;
        function i(p) {
...
`) + 1,
  ...
  class wc {
    ...
    _ensureNoFinalValue() {
      if (this._finalValue) throw new le("ProducerConsumer: cannot produce after final value has been set");
    }
      ...
      ((this._onReturn = n),
        ...
        queueMicrotask(async () => {
          const r = e({
            ...
            emitMany: (i) => {
              for (const s of i) this._producerConsumer.produce({ ok: !0, value: { done: !1, value: s } });
            },
  ...
  class xc {
    ...
    setValue(e, n) {
      return (
        ...
        this.values[e] === n
          ? !1
          : ((this.values[e] = n), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
      );
    }
    removeValues(e, n) {
      ((e = gt(e)), (n = gt(n)));
    ...
    getIndexOf(e) {
      ...
      let n = 0,
        ...
        a = 0;
      for (; n <= r;)
        if (((i = (n + (r - n) / 2) | 0), (s = this.prefixSum[i]), (a = s - this.values[i]), e < a)) r = i - 1;
        else if (e >= s) n = i + 1;
        else break;
      return new vc(i, e - a);
    }
  ...
  class Lc {
    ...
    _acceptInsertText(e, n) {
      ...
      ((r[r.length - 1] += this._lines[e.lineNumber - 1].substring(e.column - 1)),
        this._setLineText(e.lineNumber - 1, this._lines[e.lineNumber - 1].substring(0, e.column - 1) + r[0]));
  ...
  class _c extends Lc {
    ...
    getLineWords(e, n) {
      const r = this._lines[e - 1],
        ...
        s = [];
      for (const a of i) s.push({ word: r.substring(a.start, a.end), startColumn: a.start + 1, endColumn: a.end + 1 });
      return s;
    }
    _wordenize(e, n) {
      const r = [];
    ...
    _validatePosition(e) {
      ...
      let { lineNumber: n, column: r } = e,
        i = !1;
      if (n < 1) ((n = 1), (r = 1), (i = !0));
      else if (n > this._lines.length) ((n = this._lines.length), (r = this._lines[n - 1].length + 1), (i = !0));
      else {
  ...
  const ut = class ut {
    constructor(e = null) {
      ((this._foreignModule = e), (this._requestHandlerBrand = void 0), (this._workerTextModelSyncServer = new Nc()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeMoreMinimalEdits(e, n, r) {
      ...
      for (let u = 1; u < n.length; u++)
        B.getEndPosition(n[o].range).equals(B.getStartPosition(n[u].range))
          ? ((n[o].range = B.fromPositions(B.getStartPosition(n[o].range), B.getEndPosition(n[u].range))),
            (n[o].text += n[u].text))
          : (o++, (n[o] = n[u]));
      n.length = o + 1;
      ...
      return (
        typeof a == "number" &&
          s.push({ eol: a, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }),
        s
      );
    }
      ...
      e: for (const u of e) {
        ...
        if (l) {
          for (const h of l.words(a))
            if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > ut._suggestionsLimit)) break e;
        }
      }
    ...
    async $computeWordRanges(e, n, r, i) {
      ...
      for (let u = n.startLineNumber; u < n.endLineNumber; u++) {
        ...
        for (const h of l) {
          ...
          let f = o[h.word];
          (f || ((f = []), (o[h.word] = f)),
            f.push({ startLineNumber: u, startColumn: h.startColumn, endLineNumber: u, endColumn: h.endColumn }));
        }
      }
      return o;
    }
  ...
  function Mr(t, e = !1) {
    ...
    function d() {
      ...
      if (r < t.length && t.charCodeAt(r) === 46)
        if ((r++, r < t.length && St(t.charCodeAt(r)))) for (r++; r < t.length && St(t.charCodeAt(r));) r++;
...
`,
  ...
  function Rc(t, e, n) {
    ...
    function x() {
      let N = d.scan();
      for (h = 0; N === 15 || N === 14;) (N === 14 && n.keepLines ? (h += 1) : N === 14 && (h = 1), (N = d.scan()));
      return ((p = N === 16 || d.getTokenError() !== 0), N);
    }
    const v = [];
    function b(N, E, L) {
      !p && (!e || (E < o && L > a)) && t.substring(E, L) !== N && v.push({ offset: E, length: L - E, content: N });
    }
    let _ = x();
    ...
    for (; _ !== 17;) {
      ...
      if (E === 2)
        (_ !== 1 && f--, (n.keepLines && h > 0) || (!n.keepLines && _ !== 1) ? (L = y()) : n.keepLines && (L = Se[1]));
      else if (E === 4)
        (_ !== 3 && f--, (n.keepLines && h > 0) || (!n.keepLines && _ !== 3) ? (L = y()) : n.keepLines && (L = Se[1]));
      else {
        switch (_) {
          case 3:
          case 1:
...
`.indexOf(t.charAt(e)) !== -1
  ...
  function Cc(t, e, n = kn.DEFAULT) {
    ...
    function s(w) {
      return w
        ? () => w(r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter())
        : () => !0;
    }
    function a(w) {
      return w
    ...
    function o(w) {
      return w
        ? (k) => w(k, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter())
        : () => !0;
    }
    function u(w) {
      return w
        ? (k) =>
            w(k, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () =>
              i.slice(),
            )
        : () => !0;
    }
    ...
    function S() {
      return r.getToken() !== 10
        ? (N(3, [], [2, 5]), !1)
        : (E(!1), r.getToken() === 6 ? (p(":"), _(), T() || N(4, [], [2, 5])) : N(5, [], [2, 5]), i.pop(), !0);
    }
    function P() {
      (l(), _());
      let w = !1;
    ...
    function e(n) {
      ...
      return (
        ...
        (r.documentChanges === void 0 ||
          r.documentChanges.every((i) => (R.string(i.kind) ? Or.is(i) || $r.is(i) || Br.is(i) : Dr.is(i))))
      );
    }
    t.is = e;
  })(Ur || (Ur = {}));
  ...
  (function (t) {
    ...
    function i(s, a) {
      ...
      let h = 0,
        f = 0,
        m = 0;
      for (; h < u.length && f < l.length;) a(u[h], l[f]) <= 0 ? (s[m++] = u[h++]) : (s[m++] = l[f++]);
...
` &&
  ...
  class en {
    ...
    getLineOffsets() {
      return (this._lineOffsets === void 0 && (this._lineOffsets = wo(this._content, !0)), this._lineOffsets);
    }
    positionAt(e) {
      e = Math.max(Math.min(e, this._content.length), 0);
      let n = this.getLineOffsets(),
  ...
  function M(...t) {
    const e = t[0];
    let n, r, i;
    if (typeof e == "string") ((n = e), (r = e), t.splice(0, 1), (i = !t || typeof t[0] != "object" ? t : t[0]));
      ...
      ((r = e.message),
        (n = r),
        e.comment && e.comment.length > 0 && (n += `/${Array.isArray(e.comment) ? e.comment.join("") : e.comment}`),
        (i = e.args ?? {}));
    return jc(r, i);
  }
  var qc = /{([^}]+)}/g;
    ...
    validate(e, n, r = ye.Warning, i) {
      if (this.root && n) {
        ...
        return (
          ...
          s.problems.map((a) => {
            const o = W.create(e.positionAt(a.location.offset), e.positionAt(a.location.offset + a.location.length));
  ...
  function oe(t, e, n, r, i) {
        ...
        (Array.isArray(e.type)
          ? e.type.some(f) ||
            n.problems.push({
              ...
              message: e.errorMessage || M("Incorrect type. Expected one of {0}.", e.type.join(", ")),
            })
          : e.type &&
            (f(e.type) ||
              n.problems.push({
      ...
      const d = (v) => {
        ...
        p = (v, b, _) => {
          const N = xe(v),
            E = new ce(),
            L = r.newSub();
          (oe(s, N, E, L, i), r.merge(L), n.mergeProcessedProperties(E), E.hasProblems() ? _ && d(_) : b && d(b));
        },
        y = xe(e.if);
        ...
        ((n.enumValues = e.enum),
          ...
          b ||
            n.problems.push({
              ...
              message:
                e.errorMessage ||
                M("Value is not accepted. Valid values: {0}.", e.enum.map((_) => JSON.stringify(_)).join(", ")),
            }));
      }
      if (Re(e.const)) {
        const v = ot(s);
    ...
    function o(f) {
      ...
      function g(_) {
        ...
        return N && { value: Number(N[1] + (N[2] || "")), multiplier: (N[2]?.length || 0) - (parseInt(N[3]) || 0) };
      }
      if (ue(e.multipleOf)) {
        let _ = -1;
        if (Number.isInteger(e.multipleOf)) _ = m % e.multipleOf;
          ...
          if (N && E) {
            ...
            (E.multiplier < N.multiplier ? (E.value *= L) : (N.value *= L), (_ = E.value % N.value));
          }
        }
        _ !== 0 &&
          n.problems.push({
        ...
        La(e.pattern) &&
          (Rn(e.pattern)?.test(f.value) ||
            n.problems.push({
              location: { offset: f.offset, length: f.length },
              message:
                e.patternErrorMessage || e.errorMessage || M('String does not match the pattern of "{0}".', e.pattern),
            })),
        e.format)
      )
        switch (e.format) {
          ...
          case "uri-reference":
            {
              ...
              g &&
                n.problems.push({
                  location: { offset: f.offset, length: f.length },
                  message: e.patternErrorMessage || e.errorMessage || M("String is not a URI: {0}", g),
                });
            }
            break;
          case "color-hex":
    ...
    function l(f) {
      ...
      i.schemaDraft >= Me.v2020_12
        ...
        : ((m = Array.isArray(e.items) ? e.items : void 0), (g = Array.isArray(e.items) ? e.additionalItems : e.items));
      let d = 0;
      if (m !== void 0) {
      ...
      if (g !== void 0 && d < f.items.length)
        if (typeof g == "boolean")
          ...
          for (; d < f.items.length; d++) {
            const x = new ce();
            (oe(f.items[d], g, x, r, i), n.mergePropertyMatch(x), n.processedProperties.add(String(d)));
          }
      ...
      if (p) {
        ...
        for (let v = 0; v < f.items.length; v++) {
          ...
          (oe(b, p, _, tn.instance, i),
            _.hasProblems() || (x++, i.schemaDraft >= Me.v2020_12 && n.processedProperties.add(String(v))));
        }
        (x === 0 &&
          !ue(e.minContains) &&
          n.problems.push({
          ...
          ue(e.minContains) &&
            ...
            n.problems.push({
              ...
              message:
                e.errorMessage ||
                M("Array has too few items that match the contains contraint. Expected {0} or more.", e.minContains),
            }),
          ue(e.maxContains) &&
            x > e.maxContains &&
            n.problems.push({
              ...
              message:
                e.errorMessage ||
                M("Array has too many items that match the contains contraint. Expected {0} or less.", e.maxContains),
            }));
      }
    ...
    function h(f) {
      ...
      if (
        ...
        ue(e.minProperties) &&
          ...
          n.problems.push({
            location: { offset: f.offset, length: f.length },
            message: M("Object has fewer properties than the required number of {0}", e.minProperties),
          }),
        e.dependentRequired)
      )
  ...
  function Yc(t, e) {
    ...
    function o() {
      for (;;) {
        ...
        switch ((h(), E)) {
          ...
          case 13:
            Array.isArray(a) &&
              a.push(W.create(t.positionAt(s.getTokenOffset()), t.positionAt(s.getTokenOffset() + s.getTokenLength())));
            break;
          case 15:
          case 14:
            break;
    ...
    function h() {
      switch (s.getTokenError()) {
        ...
        case 6:
          return (l(M("Invalid characters in string. Control characters must be escaped."), G.InvalidCharacter), !0);
      }
      return !1;
    }
    function f(E, L) {
    ...
    function m(E) {
      ...
      for (; s.getToken() !== 4 && s.getToken() !== 17;) {
        ...
        const P = b(L);
        (P ? L.items.push(P) : l(M("Value expected"), G.ValueExpected, void 0, [], [4, 5]), (S = !0));
      }
      return s.getToken() !== 4 ? l(M("Expected comma or closing bracket"), G.CommaOrCloseBacketExpected, L) : f(L, !0);
    }
    ...
    function d(E, L) {
      ...
      if (s.getToken() === 6) ((S.colonOffset = s.getTokenOffset()), o());
        ...
        s.getToken() === 10 && t.positionAt(P.offset + P.length).line < t.positionAt(s.getTokenOffset()).line)
      )
    ...
    function p(E) {
      ...
      for (; s.getToken() !== 2 && s.getToken() !== 17;) {
        ...
        const D = d(L, S);
        (D ? L.properties.push(D) : l(M("Property expected"), G.PropertyExpected, void 0, [], [2, 5]), (P = !0));
      }
      return s.getToken() !== 2 ? l(M("Expected comma or closing brace"), G.CommaOrCloseBraceExpected, L) : f(L, !0);
    }
    function y(E) {
  ...
  class Kc {
        ...
        f = {
          add: (m) => {
            ...
            if (d)
              ...
              ((m.textEdit = Ve.replace(l, m.insertText)), (m.label = g), h.set(g, m), i.items.push(m));
            }
          },
          setAsIncomplete: () => {
            i.isIncomplete = !0;
      ...
      return this.schemaService.getSchemaForResource(e.uri, r).then((m) => {
        ...
        if (o && o.type === "string") {
          ...
          v &&
            v.type === "property" &&
            v.keyNode === o &&
            ((d = !v.valueNode), (y = v), (p = s.substr(o.offset + 1, o.length - 2)), v && (o = v.parent));
        }
        if (o && o.type === "object") {
          ...
          (d && (b = this.evaluateSeparatorAfter(e, e.offsetAt(l.end))),
            m ? this.getPropertyCompletions(m, r, o, d, b, f) : this.getSchemaLessPropertyCompletions(r, o, p, f));
          const _ = Qr(o);
        ...
        const x = {};
        return (
          m ? this.getValueCompletions(m, r, o, a, e, f, x) : this.getSchemaLessValueCompletions(r, o, a, e, f),
            ...
            if (h.enum)
              for (let m = 0; m < h.enum.length; m++) {
                ...
                (h.markdownEnumDescriptions && m < h.markdownEnumDescriptions.length
                  ...
                  : h.enumDescriptions && m < h.enumDescriptions.length && (g = h.enumDescriptions[m]),
                  f(h.enum[m], g));
              }
            h.const && f(h.const);
          }
    ...
    getSchemaLessValueCompletions(e, n, r, i, s) {
      ...
      if (n.type === "property" && r > (n.colonOffset || 0)) {
        ...
        (e.visit((f) => (f.type === "property" && f.keyNode.value === h && f.valueNode && u(f.valueNode), !0)),
    ...
    getValueCompletions(e, n, r, i, s, a, o) {
      ...
      if (r && (l !== void 0 || r.type === "array")) {
          ...
          if (g.node === r && !g.inverted && g.schema) {
            if (r.type === "array" && g.schema.items) {
              ...
              if (Array.isArray(g.schema.items)) {
                ...
                p < g.schema.items.length && this.addSchemaValueCompletions(g.schema.items[p], f, d, o);
        ...
        (l === "$schema" && !r.parent && this.addDollarSchemaCompletions(f, a),
          o.boolean && (this.addBooleanValueCompletion(!0, f, a), this.addBooleanValueCompletion(!1, f, a)),
    ...
    getContributedValueCompletions(e, n, r, i, s, a) {
      if (!n)
        ...
        ((n.type === "string" || n.type === "number" || n.type === "boolean" || n.type === "null") && (n = n.parent),
    ...
    addSchemaValueCompletions(e, n, r, i) {
      typeof e == "object" &&
        ...
        Array.isArray(e.allOf) && e.allOf.forEach((s) => this.addSchemaValueCompletions(s, n, r, i)),
        Array.isArray(e.anyOf) && e.anyOf.forEach((s) => this.addSchemaValueCompletions(s, n, r, i)),
        Array.isArray(e.oneOf) && e.oneOf.forEach((s) => this.addSchemaValueCompletions(s, n, r, i)));
    }
...
` + d,
    ...
    addEnumValueCompletions(e, n, r) {
      if (
        ...
        for (let i = 0, s = e.enum.length; i < s; i++) {
          ...
          (e.markdownEnumDescriptions && i < e.markdownEnumDescriptions.length && this.doesSupportMarkdown()
    ...
    getInsertTextForSnippetValue(e, n) {
      return Zr(e, "", (i) => (typeof i == "string" && i[0] === "^" ? i.substr(1) : JSON.stringify(i))) + n;
    }
    ...
    getInsertTextForProperty(e, n, r, i) {
      ...
      if (n) {
        ...
        if (
          (n.enum &&
            (!o && n.enum.length === 1 && (o = this.getInsertTextForGuessedValue(n.enum[0], "")), (u += n.enum.length)),
          ...
          Array.isArray(n.examples) &&
            n.examples.length &&
            (o || (o = this.getInsertTextForGuessedValue(n.examples[0], "")), (u += n.examples.length)),
          u === 0)
        ) {
...
\r\v":{[,]}`.indexOf(i.charAt(r)) === -1;
  ...
  class e1 {
    ...
    doHover(e, n, r) {
      ...
      if (s.type === "string") {
        const h = s.parent;
        if (h && h.type === "property" && h.keyNode === s && ((s = h.valueNode), !s)) return this.promise.resolve(null);
      }
...
$3`,
  ...
  const Eo = 48,
    ...
    a1 = 102;
  function ne(t) {
    return t < Eo ? 0 : t <= i1 ? t - Eo : (t < In && (t += In - s1), t >= In && t <= a1 ? t - In + 10 : 0);
  }
  function o1(t) {
    if (t[0] === "#")
      switch (t.length) {
  ...
  class l1 {
    ...
    findDocumentSymbols(e, n, r = { resultLimit: Number.MAX_VALUE }) {
      ...
      const a = e.uri;
      if (
        (a === "vscode://defaultsettings/keybindings.json" || Zt(a.toLowerCase(), "/user/keybindings.json")) &&
        i.type === "array"
      ) {
        const m = [];
          ...
          if (g.type === "object") {
            for (const d of g.properties)
              if (d.keyNode.value === "key" && d.valueNode) {
                ...
                if ((m.push({ name: Mo(d.valueNode), kind: De.Function, location: p }), s--, s <= 0))
          ...
          if (g.type === "object") {
            for (const d of g.properties)
              if (d.keyNode.value === "key" && d.valueNode) {
                const p = Ye(e, g),
                  y = Ye(e, d.keyNode);
                if ((m.push({ name: Mo(d.valueNode), kind: De.Function, range: p, selectionRange: y }), s--, s <= 0))
                  return (r && r.onResultLimitExceeded && r.onResultLimitExceeded(a), m);
              }
          }
        return m;
    ...
    getColorPresentations(e, n, r, i) {
      ...
      let h;
      return (
        r.alpha === 1 ? (h = `#${l(a)}${l(o)}${l(u)}`) : (h = `#${l(a)}${l(o)}${l(u)}${l(Math.round(r.alpha * 255))}`),
  ...
  (() => {
        ...
        470: (i) => {
            ...
            for (var h, f = "", m = 0, g = -1, d = 0, p = 0; p <= u.length; ++p) {
              ...
              if (h === 47) {
                if (!(g === p - 1 || d === 1))
                  if (g !== p - 1 && d === 2) {
                    if (
                      ...
                      if (f.length > 2) {
                        var y = f.lastIndexOf("/");
                        if (y !== f.length - 1) {
                          (y === -1 ? ((f = ""), (m = 0)) : (m = (f = f.slice(0, y)).length - 1 - f.lastIndexOf("/")),
                            (g = p),
                            (d = 0));
                          continue;
                        }
                  ...
                  } else (f.length > 0 ? (f += "/" + u.slice(g + 1, p)) : (f = u.slice(g + 1, p)), (m = p - g - 1));
                ((g = p), (d = 0));
              } else h === 46 && d !== -1 ? ++d : (d = -1);
            }
            return f;
          ...
          var o = {
            ...
            relative: function (u, l) {
              ...
              return b.length > 0 ? b + l.slice(g + y) : ((g += y), l.charCodeAt(g) === 47 && ++g, l.slice(g));
            },
            ...
            dirname: function (u) {
              if ((s(u), u.length === 0)) return ".";
              for (var l = u.charCodeAt(0), h = l === 47, f = -1, m = !0, g = u.length - 1; g >= 1; --g)
              ...
              if (l !== void 0 && l.length > 0 && l.length <= u.length) {
                ...
                for (h = u.length - 1; h >= 0; --h) {
                  ...
                  if (y === 47) {
                    ...
                    (p === -1 && ((g = !1), (p = h + 1)),
                      d >= 0 && (y === l.charCodeAt(d) ? --d == -1 && (m = h) : ((d = -1), (m = p))));
                }
            ...
            extname: function (u) {
              ...
              return l === -1 || f === -1 || g === 0 || (g === 1 && l === f - 1 && l === h + 1) ? "" : u.slice(l, f);
            },
            format: function (u) {
    ...
    ((() => {
      ...
      class m {
        ...
        with(w) {
          ...
          return (
            ...
            k === this.scheme && C === this.authority && I === this.path && F === this.query && V === this.fragment
              ? this
              : new d(k, C, I, F, V)
          );
        }
        static parse(w, k = !1) {
          const C = f.exec(w);
          return C ? new d(C[2] || l, E(C[4] || l), E(C[5] || l), E(C[7] || l), E(C[9] || l), k) : new d(l, l, l, l, l);
        }
        static file(w) {
          let k = l;
          if ((i && (w = w.replace(/\\/g, h)), w[0] === h && w[1] === h)) {
            const C = w.indexOf(h, 2);
            C === -1 ? ((k = w.substring(2)), (w = h)) : ((k = w.substring(2, C)), (w = w.substring(C) || h));
          }
      ...
      class d extends m {
        ...
        toString(w = !1) {
          return w ? b(this, !0) : (this._formatted || (this._formatted = b(this, !1)), this._formatted);
        }
        toJSON() {
          const w = { $mid: 1 };
          return (
      ...
      function y(T, w, k) {
        ...
        for (let F = 0; F < T.length; F++) {
          ...
          if (
            ...
            (I !== -1 && ((C += encodeURIComponent(T.substring(I, F))), (I = -1)), C !== void 0 && (C += T.charAt(F)));
          else {
      ...
      function x(T) {
        ...
        for (let k = 0; k < T.length; k++) {
          ...
          C === 35 || C === 63 ? (w === void 0 && (w = T.substr(0, k)), (w += p[C])) : w !== void 0 && (w += T[k]);
        }
        return w !== void 0 ? w : T;
      }
      function v(T, w) {
      ...
      function b(T, w) {
        ...
        if ((I && ((C += I), (C += ":")), (F || I === "file") && ((C += h), (C += h)), F)) {
          ...
          if (z !== -1) {
            ...
            ((F = F.substr(z + 1)),
              ...
              z === -1
                ? (C += k(Ae, !1, !1))
                : ((C += k(Ae.substr(0, z), !1, !1)), (C += ":"), (C += k(Ae.substr(z + 1), !1, !0))),
              (C += "@"));
          }
          ((F = F.toLowerCase()),
            (z = F.lastIndexOf(":")),
        ...
        return (q && ((C += "?"), (C += k(q, !1, !1))), X && ((C += "#"), (C += w ? X : y(X, !1, !1))), C);
      }
      function _(T) {
        try {
          return decodeURIComponent(T);
        ...
        case "*":
          ...
          s
            ? m > 1 &&
              (f === "/" || f === void 0 || f === "{" || f === ",") &&
              (g === "/" || g === void 0 || g === "," || g === "}")
              ? (g === "/" ? l++ : f === "/" && r.endsWith("\\/") && (r = r.substr(0, r.length - 2)),
                (r += "((?:[^/]*(?:/|$))*)"))
              : (r += "([^/]*)")
            : (r += ".*");
          break;
        ...
        for (let i of e) {
          ...
          (s || (i = i.substring(1)),
            i.length > 0 &&
              ...
              this.globWrappers.push({ regexp: c1("**/" + i, { extended: !0, globstar: !0 }), include: s })));
        }
  ...
  class d1 {
    ...
    getResolvedSchema() {
      return (
        this.resolvedSchema ||
          (this.resolvedSchema = this.getUnresolvedSchema().then((e) => this.service.resolveSchemaContent(e, this))),
        this.resolvedSchema
      );
    }
    clearSchema() {
  ...
  class Po {
    ...
    getSectionRecursive(e, n) {
      ...
      const r = e.shift();
      if (n.properties && typeof n.properties[r]) return this.getSectionRecursive(e, n.properties[r]);
      if (n.patternProperties) {
        ...
        if (typeof n.additionalProperties == "object") return this.getSectionRecursive(e, n.additionalProperties);
        if (r.match("[0-9]+")) {
  ...
  class g1 {
    ...
    registerExternalSchema(e) {
      ...
      return (
        ...
        (this.cachedSchemaForResource = void 0),
        e.fileMatch && e.fileMatch.length && this.addFilePatternAssociation(e.fileMatch, e.folderUri, [n]),
        ...
        this.requestService(e).then(
          (n) => {
            ...
            n.charCodeAt(0) === 65279 &&
              (r.push(M("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", rn(e))),
              (n = n.trimStart()));
            let i = {};
            const s = [];
            return (
              (i = Ic(n, s)),
              s.length &&
                r.push(M("Unable to parse content from '{0}': Parse error at offset {1}.", rn(e), s[0].offset)),
              new nn(i, r)
            );
          },
          (n) => {
    ...
    resolveSchemaContent(e, n) {
      ...
      const o = this.contextService,
        u = (p, y) => {
          ...
          return (
            y[0] === "/" && (y = y.substring(1)),
            y.split("/").some((v) => ((v = v.replace(/~1/g, "/").replace(/~0/g, "~")), (x = x[v]), !x)),
            x
          );
        },
        ...
        f = (p, y, x, v) => {
          let b;
          (v === void 0 || v.length === 0 ? (b = y) : v.charAt(0) === "/" ? (b = u(y, v)) : (b = l(y, x, v)),
            b ? h(p, b) : r.push(M("$ref '{0}' in '{1}' can not be resolved.", v || "", x.uri)));
        },
        m = (p, y, x, v) => {
          (o && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(y) && (y = o.resolveRelativePath(y, v.uri)), (y = Ke(y)));
    ...
    traverseNodes(e, n) {
      ...
      for (; l;)
        (r.has(l) ||
          ...
          s(l.definitions, l.$defs, l.properties, l.patternProperties, l.dependencies, l.dependentSchemas),
      ...
      if (n.root?.type === "object") {
        for (const r of n.root.properties)
          if (r.keyNode.value === "$schema" && r.valueNode?.type === "string") {
            ...
            return (
              this.contextService && !/^\w[\w\d+.-]*:/.test(i) && (i = this.contextService.resolveRelativePath(i, e)),
              i
            );
          }
      }
    ...
    getSchemaForResource(e, n) {
      ...
      const r = this.getAssociatedSchemas(e),
        i = r.length > 0 ? this.createCombinedSchema(e, r).getResolvedSchema() : this.promise.resolve(void 0);
      ...
      switch (o) {
        ...
        case 4: {
          ...
          if (i.length > 0 && i[i.length - 1].kind === d) {
            ...
            p && y > p.startLine + 1 && s !== p.startLine && ((p.endLine = y - 1), u(p), (s = p.startLine));
          }
          break;
        }
        case 13: {
        ...
        case 12: {
          ...
          if (p) {
            ...
            if (p[1]) {
              ...
              if (x >= 0) {
                const v = i[x];
                ((i.length = x), y > v.startLine && s !== v.startLine && ((v.endLine = y), u(v), (s = v.startLine)));
              }
            }
          }
          break;
      ...
      for (; l;) {
        switch (l.type) {
          ...
          case "array":
            ...
            (m < g && u >= m && u <= g && h.push(i(m, g)), h.push(i(l.offset, l.offset + l.length)));
            break;
          case "number":
          case "boolean":
          case "null":
...
`,
  ...
  class Fn {
    ...
    addChildProperty(e) {
      if (((e.parent = this), this.childrenProperties.length > 0)) {
        let n = 0;
        (e.noKeyName ? (n = this.childrenProperties.length) : (n = x1(this.childrenProperties, e, w1)),
          n < 0 && (n = n * -1 - 1),
  ...
  function L1(t) {
    ...
    for (; (o = n.scan()) !== 17;) {
      if (x === !0 && o !== 14 && o !== 15 && o !== 12 && o !== 13 && s.endLineNumber === void 0) {
        ...
        (f === 2 || f === 4 ? (a.endLineNumber = b - 1) : (s.endLineNumber = b - 1), (d = b), (x = !1));
      }
      if (
        (v === !0 && o !== 14 && o !== 15 && o !== 12 && o !== 13 && ((d = n.getTokenStartLine()), (v = !1)),
      ...
      switch (o) {
        ...
        case 5: {
          ((p = n.getTokenStartLine()),
            s.endLineNumber === void 0 &&
              (y[y.length - 1] === se.Object || (y[y.length - 1] === se.Array && (h === 2 || h === 4))) &&
        ...
        case 13: {
          (h === 5 &&
            ...
            ((y[y.length - 1] === se.Array && (f === 2 || f === 4)) || y[y.length - 1] === se.Object) &&
            ((y[y.length - 1] === se.Array && (f === 2 || f === 4)) || y[y.length - 1] === se.Object) &&
      ...
      o !== 14 &&
        ...
        o !== 12 &&
        o !== 15 &&
        ((f = h), (h = o), (m = n.getTokenStartLine()), (g = n.getTokenOffset() + n.getTokenLength() - l));
    }
    return r;
  }
  function N1(t, e) {
  ...
  function Io(t, e, n) {
    if (e.childrenProperties.length !== 0)
      if (e.type === se.Object) {
        let r = 1 / 0;
        for (const s of e.childrenProperties) s.beginningLineNumber < r && (r = s.beginningLineNumber);
      ...
      e.visit((r) => {
        if (r.type === "property" && r.keyNode.value === "$ref" && r.valueNode?.type === "string") {
          ...
          if (s) {
            ...
            n.push({ target: `${t.uri}#${a.line + 1},${a.character + 1}`, range: S1(t, r.valueNode) });
          }
        }
        return !0;
      }),
  ...
  function E1(t) {
    ...
    return {
      configure: (o) => {
        (n.clearExternalSchemas(), o.schemas?.forEach(n.registerExternalSchema.bind(n)), a.configure(o));
      },
  ...
  class M1 {
    ...
    _getTextDocument(e) {
      ...
      for (let r of n) if (r.uri.toString() === e) return Ee.create(e, this._languageId, r.version, r.getValue());
      return null;
    }
  }
  const T1 = 47,
