...
` +
  ...
  (function (t) {
    ...
    function* A(b, g, v = b.length) {
      for (
        g < -b.length && (g = 0), g < 0 && (g += b.length), v < 0 ? (v += b.length) : v > b.length && (v = b.length);
        g < v;
        g++
      )
        yield b[g];
      ...
      if (e.prev !== te.Undefined && e.next !== te.Undefined) {
        ...
        e.prev === te.Undefined && e.next === te.Undefined
          ...
          : e.next === te.Undefined
            ...
            : e.prev === te.Undefined && ((this._first = this._first.next), (this._first.prev = te.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let e = this._first;
  ...
  class $t {
    ...
    constructor(e) {
      ((this._now = e === !1 ? Date.now : mo), (this._startTime = this._now()), (this._stopTime = -1));
    }
    stop() {
...
`),
      ...
      e.length === 0
        ...
        : (n = t.replace(/\{(\d+)\}/g, (i, r) => {
            ...
            return (
              typeof a == "string"
                ? (l = a)
                : (typeof a == "number" || typeof a == "boolean" || a === void 0 || a === null) && (l = String(a)),
              l
            );
          })),
  ...
  ((Ne.ambiguousCharacterData = new Hn(() =>
    ...
    (Ne._locales = new Hn(() => Object.keys(Ne.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")))));
  let St = Ne;
  const vt = class vt {
    static getRawData() {
      return JSON.parse(
  ...
  class $o {
    ...
    async sendMessage(e, n, i) {
      ...
      return new Promise((s, a) => {
        ((this._pendingReplies[r] = { resolve: s, reject: a }), this._send(new qo(this._workerId, r, e, n, i)));
      });
    }
    listen(e, n, i) {
      let r = null;
          ...
          typeof s == "string" &&
            ...
            (Oi(s)
              ...
              : qi(s)
                ...
                : s.charCodeAt(0) === 36 && (r[s] = async (...a) => (await n?.(), this.sendMessage(e, s, a)))),
          r[s]
        ),
      };
  ...
  class Gi {
    ...
    MarkNextChange() {
      ((this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
        this.m_changes.push(
          new qe(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
        ),
        (this.m_originalCount = 0),
        (this.m_modifiedCount = 0),
        (this.m_originalStart = 1073741824),
  ...
  class Oe {
    ...
    ComputeRecursionPoint(e, n, i, r, s, a, l) {
      ...
      for (let g = 1; g <= w / 2 + 1; g++) {
        ...
        for (let _ = c; _ <= d; _ += 2) {
          (_ === c || (_ < d && x[_ - 1] < x[_ + 1]) ? (o = x[_ + 1]) : (o = x[_ - 1] + 1), (u = o - (_ - y) - I));
          const L = o;
          for (; o < n && u < r && this.ElementsAreEqual(o + 1, u + 1);) (o++, u++);
          if (((x[_] = o), o + u > v + N && ((v = o), (N = u)), !b && Math.abs(_ - A) <= g - 1 && o >= T[_]))
            return (
              (s[0] = o),
              (a[0] = u),
              L <= T[_] && g <= 1448 ? this.WALKTRACE(y, c, d, I, A, m, f, H, x, T, o, n, s, u, r, a, b, l) : null
            );
        }
        const S = (v - e + (N - i) - g) / 2;
        ...
        ((m = this.ClipDiagonalBound(A - g, g, A, p)), (f = this.ClipDiagonalBound(A + g, g, A, p)));
        for (let _ = m; _ <= f; _ += 2) {
          (_ === m || (_ < f && T[_ - 1] >= T[_ + 1]) ? (o = T[_ + 1] - 1) : (o = T[_ - 1]), (u = o - (_ - A) - H));
          const L = o;
          ...
          if (((T[_] = o), b && Math.abs(_ - y) <= g && o <= x[_]))
            return (
              (s[0] = o),
              (a[0] = u),
              L >= x[_] && g <= 1448 ? this.WALKTRACE(y, c, d, I, A, m, f, H, x, T, o, n, s, u, r, a, b, l) : null
            );
        }
        if (g <= 1447) {
    ...
    ChangesOverlap(e, n, i) {
      if (
        (rt.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"),
        rt.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"),
  ...
  let K = class tt {
    ...
    j = class re {
      constructor(e, n, i, r) {
        e > i || (e === i && n > r)
          ? ((this.startLineNumber = i), (this.startColumn = r), (this.endLineNumber = e), (this.endColumn = n))
          : ((this.startLineNumber = e), (this.startColumn = n), (this.endLineNumber = i), (this.endColumn = r));
      }
      isEmpty() {
  ...
  function tl(t) {
    return !t || typeof t.getLineCount != "function" || typeof t.getLineContent != "function" ? [] : Xt.computeLinks(t);
  }
  const yn = class yn {
    constructor() {
  ...
  class Qt {
    ...
    get onCancellationRequested() {
      return this._isCancelled ? Ji : (this._emitter || (this._emitter = new Ee()), this._emitter.event);
    }
    dispose() {
  ...
  function Kt(t, e, n, i) {
    ...
    for (let u = 0; u <= t.length; ++u) {
      ...
      if (i(o)) {
        if (!(a === u - 1 || l === 1))
          if (l === 2) {
            if (r.length < 2 || s !== 2 || r.charCodeAt(r.length - 1) !== Ye || r.charCodeAt(r.length - 2) !== Ye) {
              if (r.length > 2) {
                const c = r.lastIndexOf(n);
                (c === -1 ? ((r = ""), (s = 0)) : ((r = r.slice(0, c)), (s = r.length - 1 - r.lastIndexOf(n))),
                  (a = u),
                  (l = 0));
                continue;
              } else if (r.length !== 0) {
          ...
          } else (r.length > 0 ? (r += `${n}${t.slice(a + 1, u)}`) : (r = t.slice(a + 1, u)), (s = u - a - 1));
        ((a = u), (l = 0));
      } else o === Ye && l !== -1 ? ++l : (l = -1);
    }
    return r;
  ...
  const ue = {
      ...
      relative(t, e) {
        ...
        if (m !== c) {
          ...
          (a > c && (t.charCodeAt(r + m) === de ? (d = m) : m === 2 && (d = 3)), d === -1 && (d = 0));
        }
        let f = "";
        for (m = r + d + 1; m <= s; ++m) (m === s || t.charCodeAt(m) === de) && (f += f.length === 0 ? ".." : "\\..");
      ...
      toNamespacedPath(t) {
        ...
        } else if (He(e.charCodeAt(0)) && e.charCodeAt(1) === ze && e.charCodeAt(2) === de) return `\\\\?\\${e}`;
        return e;
      },
      dirname(t) {
        ie(t, "path");
        ...
        } else He(r) && t.charCodeAt(1) === ze && ((n = e > 2 && $(t.charCodeAt(2)) ? 3 : 2), (i = n));
        let s = -1,
          a = !0;
        for (let l = e - 1; l >= i; --l)
          if ($(t.charCodeAt(l))) {
      ...
      extname(t) {
        ...
        return n === -1 || r === -1 || a === 0 || (a === 1 && n === r - 1 && n === i + 1) ? "" : t.slice(n, r);
      },
      format: Zi.bind(null, "\\"),
      parse(t) {
        ie(t, "path");
    ...
    me = {
      resolve(...t) {
        ...
        for (let i = t.length - 1; i >= 0 && !n; i--) {
          const r = t[i];
          (ie(r, `paths[${i}]`), r.length !== 0 && ((e = `${r}/${e}`), (n = r.charCodeAt(0) === ae)));
        }
        if (!n) {
          const i = gl();
      ...
      relative(t, e) {
        if ((ie(t, "from"), ie(e, "to"), t === e || ((t = me.resolve(t)), (e = me.resolve(e)), t === e))) return "";
        const n = 1,
          i = t.length,
          r = i - n,
          s = 1,
        ...
        let c = "";
        for (u = n + o + 1; u <= i; ++u) (u === i || t.charCodeAt(u) === ae) && (c += c.length === 0 ? ".." : "/..");
      ...
      extname(t) {
        ...
        return e === -1 || i === -1 || s === 0 || (s === 1 && e === i - 1 && e === n + 1) ? "" : t.slice(e, i);
      },
      format: Zi.bind(null, "/"),
      parse(t) {
        ie(t, "path");
  ...
  function vl(t, e) {
    ...
    if (t.scheme && !bl.test(t.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (t.path) {
      if (t.authority) {
        if (!wl.test(t.path))
          throw new Error(
  ...
  let Gn = class kn {
    ...
    with(e) {
      ...
      return (
        ...
        n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment
          ? this
          : new lt(n, i, r, s, a)
      );
    }
    ...
    static file(e) {
      ...
      if ((kt && (e = e.replace(/\\/g, ke)), e[0] === ke && e[1] === ke)) {
        ...
        i === -1 ? ((n = e.substring(2)), (e = ke)) : ((n = e.substring(2, i)), (e = e.substring(i) || ke));
      }
    ...
    static joinPath(e, ...n) {
      ...
      let i;
      return (
        kt && e.scheme === "file" ? (i = kn.file(ue.join(Xn(e, !0), ...n)).path) : (i = me.join(e.path, ...n)),
        e.with({ path: i })
      );
    }
    toString(e = !1) {
    ...
    static revive(e) {
      if (e) {
        ...
        {
          const n = new lt(e);
          return ((n._formatted = e.external ?? null), (n._fsPath = e._sep === Ki ? (e.fsPath ?? null) : null), n);
        }
      } else return e;
    }
  };
  ...
  class lt extends Gn {
    ...
    toString(e = !1) {
      return e ? Jn(this, !0) : (this._formatted || (this._formatted = Jn(this, !1)), this._formatted);
    }
    toJSON() {
      const e = { $mid: 1 };
      return (
  ...
  function kl(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const i = t.charCodeAt(n);
      i === 35 || i === 63 ? (e === void 0 && (e = t.substr(0, n)), (e += er[i])) : e !== void 0 && (e += t[n]);
    }
    return e !== void 0 ? e : t;
  }
  function Xn(t, e) {
  ...
  function Jn(t, e) {
    ...
    return (l && ((i += "?"), (i += n(l, !1, !1))), o && ((i += "#"), (i += e ? o : tr(o, !1, !1))), i);
  }
  function nr(t) {
    try {
  ...
  class ge extends j {
    ...
    static liftSelection(e) {
      return new ge(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn);
    }
    ...
    touch(e, n) {
      ...
      if (!(n !== 1 && n !== 2)) {
        if (n === 1) {
          ...
          const i = e.next,
            r = e.previous;
          (e === this._tail ? ((r.next = void 0), (this._tail = r)) : ((i.previous = r), (r.next = i)),
            (e.previous = void 0),
            (e.next = this._head),
          ...
          const i = e.next,
            r = e.previous;
          (e === this._head ? ((i.previous = void 0), (this._head = i)) : ((i.previous = r), (r.next = i)),
            (e.next = void 0),
      ...
      switch (i.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const s = e.codePointAt(0),
            ...
            l = St.getLocales().filter((o) => !St.getInstance(new Set([...n.allowedLocales, o])).isAmbiguous(s));
  ...
  class gs {
    ...
    getCandidateCodePoints() {
      ...
      const e = new Set();
      if (this.options.invisibleCharacters) for (const n of At.codePoints) bs(String.fromCodePoint(n)) || e.add(n);
      ...
      if (n)
        for (const a of n) {
          const l = a.codePointAt(0),
            o = Fo(a);
          ((r = r || o), !o && !this.ambiguousCharacters.isAmbiguous(l) && !At.isInvisibleCharacter(l) && (s = !0));
        }
      return !r && s
        ? 0
...
`,
  ...
  class ve {
    ...
    toRangeMapping2(e, n) {
      if (_s(this.original.endLineNumberExclusive, e) && _s(this.modified.endLineNumberExclusive, n))
        return new ye(
          new j(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new j(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
        );
      ...
      for (const o of s.changes) {
        ...
        let d = new Ue(
          ...
          o.charChanges?.map(
            (m) =>
              new ye(
                new j(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn),
                new j(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn),
              ),
          ),
        );
        (l &&
  ...
  class lu {
    constructor(e, n, i) {
      ((this.shouldComputeCharChanges = i.shouldComputeCharChanges),
        ...
        (this.continueCharDiff = xs(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3))));
    }
    computeDiff() {
    ...
    _pushTrimWhitespaceCharChange(e, n, i, r, s, a, l) {
      ...
      let o;
      (this.shouldComputeCharChanges && (o = [new mt(n, i, n, r, s, a, s, l)]), e.push(new Dt(n, n, s, s, o)));
    }
    _mergeTrimWhitespaceCharChange(e, n, i, r, s, a, l) {
      ...
      return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0
        ...
        : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s
          ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new mt(n, i, n, r, s, a, s, l)), !0)
          : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s
            ? ((u.originalEndLineNumber = n),
              (u.modifiedEndLineNumber = s),
              this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new mt(n, i, n, r, s, a, s, l)),
              !0)
            : !1;
    }
  }
        ...
        Xl(e, (r, s) => {
          i.push(
            ne.fromOffsetPairs(
              ...
              s ? s.getStarts() : new We(n, (r ? r.seq2Range.endExclusive - r.seq1Range.endExclusive : 0) + n),
            ),
          );
        }),
        i
    ...
    compute(e, n, i = Mt.instance, r) {
      ...
      for (let w = 0; w < e.length; w++)
        for (let p = 0; p < n.length; p++) {
          ...
          } else A === x ? (l.set(w, p, 0), a.set(w, p, 1)) : A === T && (l.set(w, p, 0), a.set(w, p, 2));
          s.set(w, p, A);
        }
      const o = [];
      let u = e.length,
    ...
    compute(e, n, i = Mt.instance) {
      ...
      e: for (;;) {
        ...
        for (c = p; c <= x; c += 2) {
          ...
          if ((u.set(c, H !== A ? new Ss(P, A, I, H - A) : P), o.get(c) === r.length && o.get(c) - c === s.length))
            break e;
        }
      }
      let d = u.get(c);
...
`).length >= 15 && pu(d, (f) => f.length >= 2) >= 2
  ...
  function gu(t, e, n, i) {
    const r = [],
      s = t.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new sn(o.original, e, o)),
      a = new Set(t.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new sn(o.modified, n, o))),
      l = new Set();
    for (const o of s) {
      let u = -1,
        c;
      ...
      if (
        (u > 0.9 && c && (a.delete(c), r.push(new ve(o.range, c.range)), l.add(o.source), l.add(c.source)),
        !i.isValid())
      )
  ...
  function bu(t, e, n, i, r, s) {
    ...
    for (let m = 0; m < a.length; m++) {
      ...
      for (I = 0; I < x; I++) {
        ...
        if (P > i.length || b > r.length || u.contains(b) || c.contains(P) || !Es(i[P - 1], r[b - 1], s)) break;
      }
      I > 0 &&
  ...
  function Es(t, e, n) {
    ...
    const r = new ks().compute(new an([t], new j(1, 1, 1, t.length), !1), new an([e], new j(1, 1, 1, e.length), !1), n);
    let s = 0;
  ...
  function _u(t, e) {
    ...
    return (
      (e = e.filter((i) => {
        const r =
            n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) ||
  ...
  function ku(t, e, n) {
    ...
    return (
      Jl(i, (l, o, u) => {
        ...
        const p = ne.fromOffsetPairs(l ? l.getEndExclusives() : We.zero, u ? u.getStarts() : We.max),
          x = c.intersect(p);
...
`);
  ...
  class Su {
    ...
    refineDiff(e, n, i, r, s, a) {
      ...
      return (
        ...
        (m = ku(u, c, m)),
        {
          mappings: m.map((w) => new ye(u.translateRange(w.seq1Range), c.translateRange(w.seq2Range))),
  ...
  let on =
    ((Q = class {
      ...
      equals(e) {
        return !!e && C.equals(this.rgba, e.rgba) && Te.equals(this.hsla, e.hsla) && pt.equals(this.hsva, e.hsva);
      }
      ...
      makeOpaque(e) {
        ...
        const { r: n, g: i, b: r, a: s } = this.rgba;
        return new Q(
          new C(e.rgba.r - s * (e.rgba.r - n), e.rgba.g - s * (e.rgba.g - i), e.rgba.b - s * (e.rgba.b - r), 1),
        );
      }
      toString() {
...
`) + 1,
  ...
  class Pu {
    ...
    getIndexOf(e) {
      ...
      let n = 0,
        ...
        a = 0;
      for (; n <= i;)
        if (((r = (n + (i - n) / 2) | 0), (s = this.prefixSum[r]), (a = s - this.values[r]), e < a)) i = r - 1;
        else if (e >= s) n = r + 1;
        else break;
      return new Wu(r, e - a);
    }
  ...
  const et = class et {
    constructor(e = null) {
      ((this._foreignModule = e), (this._requestHandlerBrand = void 0), (this._workerTextModelSyncServer = new Bu()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeMoreMinimalEdits(e, n, i) {
      ...
      for (let o = 1; o < n.length; o++)
        j.getEndPosition(n[l].range).equals(j.getStartPosition(n[o].range))
          ? ((n[l].range = j.fromPositions(j.getStartPosition(n[l].range), j.getEndPosition(n[o].range))),
            (n[l].text += n[o].text))
          : (l++, (n[l] = n[o]));
      n.length = l + 1;
      ...
      e: for (const o of e) {
        ...
        if (u) {
          for (const c of u.words(a))
            if (!(c === n || !isNaN(Number(c))) && (l.add(c), l.size > et._suggestionsLimit)) break e;
        }
      }
    ...
    async $computeWordRanges(e, n, i, r) {
      ...
      for (let o = n.startLineNumber; o < n.endLineNumber; o++) {
        ...
        for (const c of u) {
          ...
          let d = l[c.word];
          (d || ((d = []), (l[c.word] = d)),
            d.push({ startLineNumber: o, startColumn: c.startColumn, endLineNumber: o, endColumn: c.endColumn }));
        }
      }
      return l;
    }
  ...
  function Se(...t) {
    const e = t[0];
    let n, i, r;
    if (typeof e == "string") ((n = e), (i = e), t.splice(0, 1), (r = !t || typeof t[0] != "object" ? t : t[0]));
  ...
  (function (t) {
    function e(i, r, s) {
      ...
      return (
        r !== void 0 && (r.recursive !== void 0 || r.ignoreIfNotExists !== void 0) && (a.options = r),
        s !== void 0 && (a.annotationId = s),
        a
      );
    }
    ...
    function e(n) {
      ...
      return (
        ...
        (i.documentChanges === void 0 ||
          i.documentChanges.every((r) => (E.string(r.kind) ? gi.is(r) || bi.is(r) || wi.is(r) : pi.is(r))))
      );
    }
    t.is = e;
  })(_i || (_i = {}));
  ...
  (function (t) {
    ...
    function n(i) {
      let r = i;
      return E.defined(r) && E.string(r.uri) && E.string(r.languageId) && E.integer(r.version) && E.string(r.text);
    }
    t.is = n;
  })(ta || (ta = {}));
  var Fe;
  ...
  (function (t) {
    function e(n) {
      const i = n;
      return i && (E.string(i.detail) || i.detail === void 0) && (E.string(i.description) || i.description === void 0);
    }
    t.is = e;
  })(sa || (sa = {}));
  var aa;
  ...
  (function (t) {
    function e(n, i, ...r) {
      let s = { label: n };
      return (E.defined(i) && (s.documentation = i), E.defined(r) ? (s.parameters = r) : (s.parameters = []), s);
    }
    t.create = e;
  })(ca || (ca = {}));
  var mn;
...
` &&
  ...
  function Li(t, e) {
    ...
    let s = 0,
      a = 0,
      l = 0;
    for (; s < i.length && a < r.length;) e(i[s], r[a]) <= 0 ? (t[l++] = i[s++]) : (t[l++] = r[a++]);
  ...
  function Ha(t, e, n = 0) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      (s === 13 || s === 10) && (s === 13 && r + 1 < t.length && t.charCodeAt(r + 1) === 10 && r++, i.push(n + r + 1));
    }
    return i;
  }
  function Ua(t) {
  ...
  class Ju {
    ...
    advanceIfChars(e) {
      ...
      for (n = 0; n < e.length; n++) if (this.source.charCodeAt(this.position + n) !== e[n]) return !1;
    ...
    skipWhitespace() {
      return this.advanceWhileChar((n) => n === nc || n === ic || n === Ku || n === tc || n === ec) > 0;
    }
    advanceWhileChar(e) {
  ...
  function be(t, e = 0, n = V.WithinContent, i = !1) {
    ...
    function x() {
      ...
      return I !== z.EOS && y === r.pos() && !(i && (I === z.StartTagClose || I === z.EndTagClose))
        ? (console.warn("Scanner.scan has not advanced at offset " + y + ", state before: " + A + " after: " + s),
          r.advance(1),
          p(y, z.Unknown))
        : I;
    }
    function T() {
      ...
      switch (s) {
        ...
        case V.WithinContent:
          if (r.advanceIfChar(gn)) {
            if (!r.eos() && r.peekChar() === Wa) {
              if (r.advanceIfChars([Wa, wt, wt])) return ((s = V.WithinComment), p(y, z.StartCommentTag));
        ...
        case V.BeforeAttributeValue:
          ...
          if (
            H.length > 0 &&
            (r.peekChar() === Me && r.peekChar(-1) === Ei && (r.goBack(1), (H = H.substring(0, H.length - 1))),
            d === "type" && (m = H),
            H.length > 0)
          )
  ...
  class Ba {
    ...
    constructor(e, n, i, r) {
      ((this.start = e), (this.end = n), (this.children = i), (this.parent = r), (this.closed = !1));
    }
    isSameTag(e) {
            ...
            s.parent &&
              ...
              i.getTokenLength()
                ? ((s.startTagEnd = i.getTokenEnd()),
                  s.tag && this.dataManager.isVoidElement(s.tag, n) && ((s.closed = !0), (s = s.parent)))
                : (s = s.parent));
            break;
...
\r`.indexOf(M) >= 0
      ...
      function g(k, R) {
        ...
        (i && i.roots.forEach((U) => F(U)),
          Object.keys(W).forEach((U) =>
            s.items.push({ label: U, kind: fe.Value, textEdit: oe.replace(k, W[U]), insertTextFormat: Ae.Snippet }),
          ));
      }
      function v(k, R = d) {
        let M, W, F;
        ...
        if (a.length > 0) {
          ...
          for (const Z of a)
            Z.onHtmlAttributeValue &&
              Z.onHtmlAttributeValue({ document: e, position: n, tag: U, attribute: O, value: F, range: Y });
        }
        return (
          l.forEach((U) => {
      ...
      for (; D !== z.EOS && f.getTokenOffset() <= d;) {
        switch (D) {
          ...
          case z.DelimiterAssign:
            ...
            break;
          case z.AttributeValue:
            if (f.getTokenOffset() <= d && d <= f.getTokenEnd()) return v(f.getTokenOffset(), f.getTokenEnd());
            break;
          case z.Whitespace:
            if (d <= f.getTokenEnd())
      ...
      if (u && u.attributes && u.start < s && (!u.endTagStart || u.endTagStart > s)) {
        ...
        for (; d !== z.EOS && c.getTokenEnd() <= s;) {
          if (d === z.AttributeName && c.getTokenEnd() === s - 1)
            return (
              (d = c.scan()),
              d !== z.DelimiterAssign || ((d = c.scan()), d === z.Unknown || d === z.AttributeValue) ? null : o
            );
          d = c.scan();
        }
      }
      ...
      if (s === ">") {
        ...
        if (a && a.tag) {
          ...
          for (; o !== z.EOS && l.getTokenEnd() <= r;) {
            if (o === z.EndTagOpen && l.getTokenEnd() === r) return e.getText().charAt(r) !== ">" ? `${a.tag}>` : a.tag;
            o = l.scan();
          }
        }
      }
    ...
    doesSupportMarkdown() {
      if (!bn(this.supportsMarkdown)) {
        if (!bn(this.lsOptions.clientCapabilities)) return ((this.supportsMarkdown = !0), this.supportsMarkdown);
  ...
  class Ac {
    ...
    doHover(e, n, i, r) {
          ...
          if (
            (N.provideTags().forEach((_) => {
              if (_.name.toLowerCase() === b.toLowerCase()) {
                let L = Ze(_, r, a);
                (L || (L = { kind: a ? "markdown" : "plaintext", value: "" }), (S = { contents: L, range: g }));
              }
            }),
            S)
          )
      ...
      function p(b, g) {
        ...
        let N = v.scan();
        for (; N !== z.EOS && (v.getTokenEnd() < l || (v.getTokenEnd() === l && N !== b));) N = v.scan();
      ...
      function H(b, g) {
        ...
        let N = v.scan(),
          S;
        for (; N !== z.EOS && v.getTokenEnd() <= g;) ((N = v.scan()), N === z.AttributeName && (S = v.getTokenText()));
        return S;
      }
            ...
            (s.prototype.toString = function () {
              ...
              return (
                this.is_empty()
                  ...
                  : ((o = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)),
                    (o += this.__items.join(""))),
                o
              );
            }));
        ...
        function (r) {
          ...
          ((a.prototype.restart = function () {
            ...
            (a.prototype.get_regexp = function (l, o) {
              ...
              return (
                o && s && (c = "y"),
                typeof l == "string" && l !== "" ? (u = new RegExp(l, c)) : l && (u = new RegExp(l.source, c)),
                u
              );
            }),
              ...
              for (
                ...
                if (this._ch === "/" && this._input.peek() === "*") {
                  ...
                  (g && ((g = !1), this.outdent()),
                    ...
                    this._options.brace_style === "expand"
                      ? (this._output.add_new_line(),
                        ...
                        this.indent(),
                        this._output.set_indent(this._indentLevel))
                      : (R === "(" ? (this._output.space_before_token = !1) : R !== "," && this.indent(),
                        this.print_string(this._ch)),
                    this.eatWhitespace(!0),
                    this._output.add_new_line());
                else if (this._ch === "}")
                  (this.outdent(),
                    ...
                    this._input.peek() === ")" &&
                      (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0)));
                else if (this._ch === ":") {
                  ...
                  P === 0
                    ? (this.print_string(":"),
                      g || ((g = !0), (this._output.space_before_token = !0), this.eatWhitespace(!0), this.indent()))
                  ...
                  (this.eatWhitespace(), this.print_string("="), w.test(this._ch) && (this._ch = ""));
          ...
          ((s.prototype.read = function () {
            ...
            return (
              (!this._starting_pattern || a) &&
                (a += this._input.read(this._match_pattern, this._until_pattern, this._until_after)),
              a
            );
          }),
              ...
              if (d === "<") {
                ...
                d === "{" &&
                  ...
                  this._disabled.django ||
                    ...
                    this._excluded.django ||
                      ((c = c || this.__patterns.django_comment.read()), (c = c || this.__patterns.django.read()))),
        ...
        function (r, s, a) {
          ...
          ((f.prototype.current_line_has_match = function (b) {
            ...
            (f.prototype.print_preserved_newlines = function (b) {
              ...
              (b.type !== c.TEXT && b.previous.type !== c.TEXT && (g = b.newlines ? 1 : 0),
                this.preserve_newlines &&
                  (g = b.newlines < this.max_preserve_newlines + 1 ? b.newlines : this.max_preserve_newlines + 1));
            ...
            (f.prototype.print_token = function (b) {
              b.text &&
                (this._output.set_indent(this.indent_level, this.alignment_size), this._output.add_token(b.text));
            }),
            ...
            (f.prototype.deindent = function () {
              this.indent_level > 0 &&
                (this.indent_level--, this._output.set_indent(this.indent_level, this.alignment_size));
            }),
              ...
              return (
                ...
                v.is_unformatted
                  ...
                  : (v.tag_start_char === "<" &&
                      ...
                      this._is_wrap_attributes_force_expand_multiline && v.has_wrapped_attrs && b.print_newline(!1)),
                    b.print_token(g)),
                v.indent_content &&
                  !(v.is_unformatted || v.is_content_unformatted) &&
                  (b.indent(), (v.indent_content = !1)),
                !v.is_inline_element && !(v.is_unformatted || v.is_content_unformatted) && b.set_wrap_point(),
                N
              );
            }),
                ...
                v.is_unformatted
                  ...
                  : v.tag_start_char === "{" && g.type === c.TEXT
                    ...
                    : (g.type === c.ATTRIBUTE
                        ...
                        : (g.type === c.EQUALS || (g.type === c.VALUE && g.previous.type === c.EQUALS)) &&
            ...
            (A.prototype._print_custom_beatifier_text = function (b, g, v) {
              ...
              if (g.text !== "") {
                var S = g.text,
                  ...
                  D = "",
                  k = "";
                (v.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function"
                  ? (_ = this._js_beautify)
                ...
                if (
                  ((S = S.replace(/\n[ \t]*$/, "")),
                  v.custom_beautifier_name !== "html" && S[0] === "<" && S.match(/^(<!--|<!\[CDATA\[)/))
                ) {
                  var M = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(S);
                  if (!M) {
                    b.add_raw_token(g);
          ...
          var I = function (b, g) {
            if (
              ...
              (this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (N = 3),
                (this.is_end_tag =
                  this.is_end_tag ||
                  (this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(N))))));
            }
          };
              ...
              if (
                (v.is_empty_element ||
                  (v.is_end_tag
                    ...
                    : (this._do_optional_end_element(v) && (v.is_inline_element || b.print_newline(!1)),
...
`) === -1) ||
                  ...
                  v.tag_start_char === "<" &&
                    (v.tag_name === "html"
                      ...
                      : v.tag_name === "head"
                        ...
                        : v.tag_name === "body" && (v.indent_content = this._options.indent_body_inner_html)),
          ...
          ((w.prototype = new l()),
            ...
            (w.prototype._read_processing = function (p) {
              ...
              if (p === "<") {
                var A = this._input.peek(1);
                ((A === "!" || A === "?") &&
                  ((T = this.__patterns.conditional_comment.read()), (T = T || this.__patterns.processing.read())),
                  T && ((x = this._create_token(m.COMMENT, T)), (x.directives = y)));
              }
              return x;
            }),
  ...
  function Dc(t, e, n) {
    ...
    if (e) {
      ...
      if (new RegExp(/.*[<][^>]*$/).test(f)) return ((i = i.substring(u, d)), [{ range: e, newText: i }]);
...
`.indexOf(t.charAt(e)) !== -1
        ...
        470: (r) => {
                  ...
                  if (f !== p - 1 && w === 2) {
                    if (
                      ...
                      if (d.length > 2) {
                        var x = d.lastIndexOf("/");
                        if (x !== d.length - 1) {
                          (x === -1 ? ((d = ""), (m = 0)) : (m = (d = d.slice(0, x)).length - 1 - d.lastIndexOf("/")),
                            (f = p),
                            (w = 0));
                          continue;
                        }
          ...
          var l = {
            ...
            relative: function (o, u) {
              ...
              return A.length > 0 ? A + u.slice(f + x) : ((f += x), u.charCodeAt(f) === 47 && ++f, u.slice(f));
            },
              ...
              if (u !== void 0 && u.length > 0 && u.length <= o.length) {
                ...
                for (c = o.length - 1; c >= 0; --c) {
                  ...
                  if (x === 47) {
                    ...
                    (p === -1 && ((f = !1), (p = c + 1)),
                      w >= 0 && (x === u.charCodeAt(w) ? --w == -1 && (m = c) : ((w = -1), (m = p))));
                }
    ...
    ((() => {
      ...
      class m {
        ...
        with(_) {
          ...
          return (
            ...
            L === this.scheme && D === this.authority && k === this.path && R === this.query && M === this.fragment
              ? this
              : new w(L, D, k, R, M)
          );
        }
        static parse(_, L = !1) {
          const D = d.exec(_);
          return D ? new w(D[2] || u, P(D[4] || u), P(D[5] || u), P(D[7] || u), P(D[9] || u), L) : new w(u, u, u, u, u);
        }
        static file(_) {
          let L = u;
          if ((r && (_ = _.replace(/\\/g, c)), _[0] === c && _[1] === c)) {
            const D = _.indexOf(c, 2);
            D === -1 ? ((L = _.substring(2)), (_ = c)) : ((L = _.substring(2, D)), (_ = _.substring(D) || c));
          }
      ...
      function x(S, _, L) {
        ...
        for (let R = 0; R < S.length; R++) {
          ...
          if (
            ...
            (k !== -1 && ((D += encodeURIComponent(S.substring(k, R))), (k = -1)), D !== void 0 && (D += S.charAt(R)));
          else {
      ...
      function T(S) {
        ...
        for (let L = 0; L < S.length; L++) {
          ...
          D === 35 || D === 63 ? (_ === void 0 && (_ = S.substr(0, L)), (_ += p[D])) : _ !== void 0 && (_ += S[L]);
        }
        return _ !== void 0 ? _ : S;
      }
      function y(S, _) {
      ...
      function A(S, _) {
        ...
        return (W && ((D += "?"), (D += L(W, !1, !1))), F && ((D += "#"), (D += _ ? F : x(F, !1, !1))), D);
      }
      function I(S) {
        try {
  ...
  function Fc(t, e) {
    try {
      ...
      return (
        ...
        n.scheme === "file" && n.fragment && !(t.startsWith(e.uri) && t.charCodeAt(e.uri.length) === Wc)
  ...
  function Za(t, e, n) {
    ...
    return r !== z.EOS ? { start: e.positionAt(i.getTokenOffset()), end: e.positionAt(i.getTokenEnd()) } : null;
  }
  function Oc(t, e) {
    const n = [],
      i = Ka(t, e);
  ...
  function jc(t, e, n, i) {
    ...
    if ((a.push({ range: l, newText: n }), s.endTagStart)) {
      const u = { start: t.positionAt(s.endTagStart + 2), end: t.positionAt(s.endTagStart + 2 + s.tag.length) };
  ...
  function to(t, e, n) {
    ...
    return r.endTagStart &&
      ((r.start + 1 <= i && i <= r.start + 1 + s) || (r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + s))
      ? [
            ...
            if (w)
              if (w[1]) l.push({ startLine: m, tagName: "" });
                ...
                if (p >= 0) {
                  ...
                  l.length = p;
                  const T = m;
                  ((m = x.startLine), T > m && u !== m && c({ startLine: m, endLine: T, kind: cn.Region }));
                }
              }
            else {
      ...
      return !s.startTagEnd || !s.endTagStart
        ...
        : (a.unshift([s.start, s.end]),
          s.start < r && r < s.startTagEnd
            ? (a.unshift([s.start + 1, s.startTagEnd - 1]), (a = this.getAttributeLevelRanges(e, s, r).concat(a)), a)
    ...
    *   To learn about this declaration in Firefox for Mobile, see [this article](https://developer.mozilla.org/en-US/docs/Mobile/Viewport_meta_tag "Mobile/Viewport meta tag").`,
      ...
      },
      {
        ...
        attributes: [
          ...
          {
            name: "ononline",
            description: { kind: "markdown", value: "Function to call when network communication has been restored." },
          },
          { name: "onpagehide" },
          { name: "onpageshow" },
          {
...
Default mode, which indicates no preference for the decoding mode. The browser decides what is best for the user.`,
          ...
          },
          {
            name: "loading",
            valueSet: "loading",
            description: { kind: "markdown", value: "Indicates how the browser should load the image." },
          },
          {
            name: "referrerpolicy",
...
The resource should be downloaded after other higher-priority page resources.`,
      ...
      },
      {
        ...
        attributes: [
          ...
          {
            name: "type",
            description: { kind: "markdown", value: "The MIME type to use to select the plug-in to instantiate." },
          },
          {
            name: "width",
            description: {
...
**Note:** Do not use this attribute, as it is non-standard and only implemented in some versions of Microsoft Internet Explorer: The [\`<th>\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/th "The HTML <th> element defines a cell as header of a group of table cells. The exact nature of this group is defined by the scope and headers attributes.") element should be styled using [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS). To create a similar effect use the [\`background-color\`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-color "The background-color CSS property sets the background color of an element.") property in [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS) instead.`,
      ...
      },
      {
        ...
        attributes: [
          ...
          {
            name: "name",
            description: { kind: "markdown", value: "The name of the button, which is submitted with the form data." },
          },
          {
            name: "type",
            valueSet: "bt",
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
  ...
  class Yc {
    ...
    setDataProviders(e, n) {
      ((this.dataProviders = []), e && this.dataProviders.push(new Oa("html5", Qc)), this.dataProviders.push(...n));
    }
    getDataProviders() {
  ...
  class nh {
    constructor(e, n) {
      ((this._ctx = e), (this._languageSettings = n.languageSettings), (this._languageId = n.languageId));
    ...
    async doComplete(e, n) {
      ...
      return Promise.resolve(
        this._languageService.doComplete(i, n, r, this._languageSettings && this._languageSettings.suggest),
      );
    }
    async format(e, n, i) {
    ...
    _getTextDocument(e) {
      ...
      for (let i of n) if (i.uri.toString() === e) return Ai.create(e, this._languageId, i.version, i.getValue());
      return null;
    }
  }
  self.onmessage = () => {
