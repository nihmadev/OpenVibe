...
` +
  ...
  (function (t) {
    ...
    function* L(w, y, A = w.length) {
      for (
        y < -w.length && (y = 0), y < 0 && (y += w.length), A < 0 ? (A += w.length) : A > w.length && (A = w.length);
        y < A;
        y++
      )
        yield w[y];
      ...
      if (e.prev !== j.Undefined && e.next !== j.Undefined) {
        ...
        e.prev === j.Undefined && e.next === j.Undefined
          ...
          : e.next === j.Undefined
            ...
            : e.prev === j.Undefined && ((this._first = this._first.next), (this._first.prev = j.Undefined));
      this._size -= 1;
    }
    *[Symbol.iterator]() {
      let e = this._first;
  ...
  class yt {
    ...
    constructor(e) {
      ((this._now = e === !1 ? Date.now : Qs), (this._startTime = this._now()), (this._stopTime = -1));
    }
    stop() {
...
`),
      ...
      e.length === 0
        ...
        : (n = t.replace(/\{(\d+)\}/g, (r, s) => {
            ...
            return (
              typeof l == "string"
                ? (o = l)
                : (typeof l == "number" || typeof l == "boolean" || l === void 0 || l === null) && (o = String(l)),
              o
            );
          })),
  ...
  ((ge.ambiguousCharacterData = new Zt(() =>
    ...
    (ge._locales = new Zt(() => Object.keys(ge.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")))));
  let rt = ge;
  const Ze = class Ze {
    static getRawData() {
      return JSON.parse(
    ...
    static getData() {
      return (this._data || (this._data = new Set([...Object.values(Ze.getRawData())].flat())), this._data);
    }
  ...
  class Ci {
    ...
    async sendMessage(e, n, r) {
      ...
      return new Promise((i, l) => {
        ((this._pendingReplies[s] = { resolve: i, reject: l }), this._send(new Ni(this._workerId, s, e, n, r)));
      });
    }
    listen(e, n, r) {
      let s = null;
          ...
          typeof i == "string" &&
            ...
            (Bn(i)
              ...
              : In(i)
                ...
                : i.charCodeAt(0) === 36 && (s[i] = async (...l) => (await n?.(), this.sendMessage(e, i, l)))),
          s[i]
        ),
      };
  ...
  class Ei {
    ...
    _handleMessage(e, n, r) {
      ...
      const i = s[n];
      if (typeof i != "function") return Promise.reject(new Error(`Missing method ${n} on worker thread channel ${e}`));
      try {
    ...
    _handleEvent(e, n, r) {
      ...
      if (Bn(n)) {
        const i = s[n];
        if (typeof i != "function") throw new Error(`Missing dynamic event ${n} on request handler.`);
        const l = i.call(s, r);
        if (typeof l != "function") throw new Error(`Missing dynamic event ${n} on request handler.`);
        return l;
      }
      if (In(n)) {
        const i = s[n];
  ...
  class Hn {
    ...
    MarkNextChange() {
      ((this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
        this.m_changes.push(
          new Le(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
        ),
        (this.m_originalCount = 0),
        (this.m_modifiedCount = 0),
        (this.m_originalStart = 1073741824),
  ...
  class ve {
    ...
    ComputeRecursionPoint(e, n, r, s, i, l, o) {
      let u = 0,
        ...
        m = 0,
        p = 0;
      (e--, r--, (i[0] = 0), (l[0] = 0), (this.m_forwardHistory = []), (this.m_reverseHistory = []));
      const b = n - e + (s - r),
        d = b + 1,
        x = new Int32Array(d),
        N = new Int32Array(d),
      ...
      for (let y = 1; y <= b / 2 + 1; y++) {
        let A = 0,
          D = 0;
        ((h = this.ClipDiagonalBound(v - y, y, v, d)), (f = this.ClipDiagonalBound(v + y, y, v, d)));
        for (let _ = h; _ <= f; _ += 2) {
          (_ === h || (_ < f && x[_ - 1] < x[_ + 1]) ? (u = x[_ + 1]) : (u = x[_ - 1] + 1), (c = u - (_ - v) - E));
          const S = u;
          for (; u < n && c < s && this.ElementsAreEqual(u + 1, c + 1);) (u++, c++);
          if (((x[_] = u), u + c > A + D && ((A = u), (D = c)), !w && Math.abs(_ - L) <= y - 1 && u >= N[_]))
            return (
              (i[0] = u),
              (l[0] = c),
              S <= N[_] && y <= 1448 ? this.WALKTRACE(v, h, f, E, L, m, p, T, x, N, u, n, i, c, s, l, w, o) : null
            );
        }
        const V = (A - e + (D - r) - y) / 2;
        ...
        ((m = this.ClipDiagonalBound(L - y, y, L, d)), (p = this.ClipDiagonalBound(L + y, y, L, d)));
        for (let _ = m; _ <= p; _ += 2) {
          (_ === m || (_ < p && N[_ - 1] >= N[_ + 1]) ? (u = N[_ + 1] - 1) : (u = N[_ - 1]), (c = u - (_ - L) - T));
          const S = u;
          ...
          if (((N[_] = u), w && Math.abs(_ - v) <= y && u <= x[_]))
            return (
              (i[0] = u),
              (l[0] = c),
              S >= x[_] && y <= 1448 ? this.WALKTRACE(v, h, f, E, L, m, p, T, x, N, u, n, i, c, s, l, w, o) : null
            );
        }
        if (y <= 1447) {
      ...
      for (let n = e.length - 1; n >= 0; n--) {
        ...
        for (let f = 1; ; f++) {
          ...
          if (
            ...
            break;
          const d = (m === s && p === i ? 5 : 0) + this._boundaryScore(m, r.originalLength, p, r.modifiedLength);
          d > c && ((c = d), (u = f));
        }
      ...
      if (this._hasStrings)
        for (let n = 1, r = e.length; n < r; n++) {
          ...
          if (l < 5 && c < 20 && m < 20) {
            ...
            if (p) {
              const [b, d] = p;
              (b !== s.originalStart + s.originalLength || d !== s.modifiedStart + s.modifiedLength) &&
    ...
    ChangesOverlap(e, n, r) {
      if (
        (Ie.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"),
        Ie.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"),
  ...
  class C {
    constructor(e, n, r, s) {
      e > r || (e === r && n > s)
        ? ((this.startLineNumber = r), (this.startColumn = s), (this.endLineNumber = e), (this.endColumn = n))
        : ((this.startLineNumber = e), (this.startColumn = n), (this.endLineNumber = r), (this.endColumn = s));
    }
    isEmpty() {
    ...
    delta(e) {
      return new C(this.startLineNumber + e, this.startColumn, this.endLineNumber + e, this.endColumn);
    }
    isSingleLine() {
  ...
  function Ii(t) {
    return !t || typeof t.getLineCount != "function" || typeof t.getLineContent != "function" ? [] : Lt.computeLinks(t);
  }
  const Vt = class Vt {
    constructor() {
  ...
  class Nt {
    ...
    get onCancellationRequested() {
      return this._isCancelled ? zn : (this._emitter || (this._emitter = new fe()), this._emitter.event);
    }
    dispose() {
  ...
  function Rt(t, e, n, r) {
    ...
    for (let c = 0; c <= t.length; ++c) {
      ...
      if (r(u)) {
        if (!(l === c - 1 || o === 1))
          if (o === 2) {
            if (s.length < 2 || i !== 2 || s.charCodeAt(s.length - 1) !== ke || s.charCodeAt(s.length - 2) !== ke) {
              if (s.length > 2) {
          ...
          } else (s.length > 0 ? (s += `${n}${t.slice(l + 1, c)}`) : (s = t.slice(l + 1, c)), (i = c - l - 1));
        ((l = c), (o = 0));
      } else u === ke && o !== -1 ? ++o : (o = -1);
    }
    return s;
  ...
  const K = {
        ...
        for (let s = t.length - 1; s >= -1; s--) {
          ...
          if (s >= 0) {
            ...
            e.length === 0
              ? (i = At())
              : ((i = Wi[`=${e}`] || At()),
                (i === void 0 || (i.slice(0, 2).toLowerCase() !== e.toLowerCase() && i.charCodeAt(2) === te)) &&
                  (i = `${e}\\`));
          const l = i.length;
          let o = 0,
            u = "",
      ...
      relative(t, e) {
        ...
        if (m !== h) {
          ...
          (l > h && (t.charCodeAt(s + m) === te ? (f = m) : m === 2 && (f = 3)), f === -1 && (f = 0));
        }
        let p = "";
        for (m = s + f + 1; m <= i; ++m) (m === i || t.charCodeAt(m) === te) && (p += p.length === 0 ? ".." : "\\..");
        return ((o += f), p.length > 0 ? `${p}${r.slice(o, u)}` : (r.charCodeAt(o) === te && ++o, r.slice(o, u)));
      },
      toNamespacedPath(t) {
        ...
        } else if (we(e.charCodeAt(0)) && e.charCodeAt(1) === pe && e.charCodeAt(2) === te) return `\\\\?\\${e}`;
        return e;
      },
      dirname(t) {
        X(t, "path");
        ...
        } else we(s) && t.charCodeAt(1) === pe && ((n = e > 2 && I(t.charCodeAt(2)) ? 3 : 2), (r = n));
        let i = -1,
          l = !0;
        for (let o = e - 1; o >= r; --o)
          if (I(t.charCodeAt(o))) {
      ...
      extname(t) {
        ...
        return n === -1 || s === -1 || l === 0 || (l === 1 && n === s - 1 && n === r + 1) ? "" : t.slice(n, s);
      },
      format: On.bind(null, "\\"),
      parse(t) {
        X(t, "path");
    ...
    ne = {
      ...
      relative(t, e) {
        if ((X(t, "from"), X(e, "to"), t === e || ((t = ne.resolve(t)), (e = ne.resolve(e)), t === e))) return "";
        const n = 1,
          r = t.length,
          s = r - n,
          i = 1,
        ...
        let h = "";
        for (c = n + u + 1; c <= r; ++c) (c === r || t.charCodeAt(c) === Q) && (h += h.length === 0 ? ".." : "/..");
      ...
      extname(t) {
        ...
        return e === -1 || r === -1 || i === 0 || (i === 1 && e === r - 1 && e === n + 1) ? "" : t.slice(e, r);
      },
      format: On.bind(null, "/"),
      parse(t) {
        X(t, "path");
  ...
  function na(t, e) {
    ...
    if (t.scheme && !Ki.test(t.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (t.path) {
      if (t.authority) {
        if (!ea.test(t.path))
          throw new Error(
  ...
  class Me {
    ...
    static file(e) {
      ...
      if ((nt && (e = e.replace(/\\/g, ce)), e[0] === ce && e[1] === ce)) {
        ...
        r === -1 ? ((n = e.substring(2)), (e = ce)) : ((n = e.substring(2, r)), (e = e.substring(r) || ce));
      }
    ...
    static joinPath(e, ...n) {
      ...
      let r;
      return (
        nt && e.scheme === "file" ? (r = Me.file(K.join(cn(e, !0), ...n)).path) : (r = ne.join(e.path, ...n)),
        e.with({ path: r })
      );
    }
    toString(e = !1) {
    ...
    static revive(e) {
      if (e) {
        ...
        {
          const n = new $e(e);
          return ((n._formatted = e.external ?? null), (n._fsPath = e._sep === Xn ? (e.fsPath ?? null) : null), n);
        }
      } else return e;
    }
  }
  ...
  function aa(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const r = t.charCodeAt(n);
      r === 35 || r === 63 ? (e === void 0 && (e = t.substr(0, n)), (e += Qn[r])) : e !== void 0 && (e += t[n]);
    }
    return e !== void 0 ? e : t;
  }
  function cn(t, e) {
  ...
  function hn(t, e) {
    ...
    return (o && ((r += "?"), (r += n(o, !1, !1))), u && ((r += "#"), (r += e ? u : Jn(u, !1, !1))), r);
  }
  function Yn(t) {
    try {
  ...
  class se extends C {
    ...
    static liftSelection(e) {
      return new se(e.selectionStartLineNumber, e.selectionStartColumn, e.positionLineNumber, e.positionColumn);
    }
  ...
  (function (t) {
    ...
    function n(l) {
      let o = e.get(l);
      return (o || (console.info("No codicon found for CompletionItemKind " + l), (o = M.symbolProperty)), o);
    }
    t.toIcon = n;
    function r(l) {
      switch (l) {
  ...
  (function (t) {
    ...
    function n(i) {
      let l = e.get(i);
      return (l || (console.info("No codicon found for SymbolKind " + i), (l = M.symbolProperty)), l);
    }
    t.toIcon = n;
    const r = new Map();
    (r.set(0, 20),
    ...
    function s(i) {
      let l = r.get(i);
      return (l === void 0 && (console.info("No completion kind found for SymbolKind " + i), (l = 20)), l);
    }
    ...
    touch(e, n) {
      ...
      if (!(n !== 1 && n !== 2)) {
        if (n === 1) {
          ...
          const r = e.next,
            s = e.previous;
          (e === this._tail ? ((s.next = void 0), (this._tail = s)) : ((r.previous = s), (s.next = r)),
            (e.previous = void 0),
            (e.next = this._head),
          ...
          const r = e.next,
            s = e.previous;
          (e === this._head ? ((r.previous = void 0), (this._head = r)) : ((r.previous = s), (s.next = r)),
            (e.next = void 0),
  ...
  function pn(t, e, n, r, s) {
    ...
    if (u) {
      const c = { word: u[0], startColumn: r + 1 + u.index, endColumn: r + 1 + u.index + u[0].length };
      ...
      switch (r.shouldHighlightNonBasicASCII(e, null)) {
        ...
        case 3: {
          const i = e.codePointAt(0),
            ...
            o = rt.getLocales().filter((u) => !rt.getInstance(new Set([...n.allowedLocales, u])).isAmbiguous(i));
  ...
  class fs {
    ...
    getCandidateCodePoints() {
      ...
      const e = new Set();
      if (this.options.invisibleCharacters) for (const n of st.codePoints) ms(String.fromCodePoint(n)) || e.add(n);
      ...
      if (n)
        for (const l of n) {
          const o = l.codePointAt(0),
            u = Li(l);
          ((s = s || u), !u && !this.ambiguousCharacters.isAmbiguous(o) && !st.isInvisibleCharacter(o) && (i = !0));
        }
      return !s && i
        ? 0
...
` ||
  ...
  class B {
    ...
    constructor(e, n) {
      if (((this.start = e), (this.endExclusive = n), e > n)) throw new Y(`Invalid range: ${this.toString()}`);
    }
    get isEmpty() {
    ...
    joinRightTouching(e) {
      if (this.endExclusive !== e.start) throw new Y(`Invalid join: ${this.toString()} and ${e.toString()}`);
  ...
  class de {
      ...
      for (; r < this._normalizedRanges.length || s < e._normalizedRanges.length;) {
        ...
        i === null
          ...
          : i.endLineNumberExclusive >= l.startLineNumber
            ? (i = new $(i.startLineNumber, Math.max(i.endLineNumberExclusive, l.endLineNumberExclusive)))
            : (n.push(i), (i = l));
      }
    ...
    subtractFrom(e) {
      ...
      for (let l = n; l < r; l++) {
        ...
        (o.startLineNumber > i && s.push(new $(i, o.startLineNumber)), (i = o.endLineNumberExclusive));
      }
...
`,
  ...
  class ae {
    ...
    toRangeMapping2(e, n) {
      if (gs(this.original.endLineNumberExclusive, e) && gs(this.modified.endLineNumberExclusive, n))
        return new le(
          new C(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1),
          new C(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1),
        );
  ...
  function bs(t, e, n, r = !1) {
    ...
    for (const i of Ea(
      t.map((l) => qa(l, e, n)),
      (l, o) => l.original.intersectsOrTouches(o.original) || l.modified.intersectsOrTouches(o.modified),
    )) {
      const l = i[0],
        o = i[i.length - 1];
      s.push(
      ...
      for (const u of i.changes) {
        ...
        let f = new xe(
          ...
          u.charChanges?.map(
            (m) =>
              new le(
                new C(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn),
                new C(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn),
              ),
          ),
        );
        (o &&
  ...
  class za {
    constructor(e, n, r) {
      ((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.continueCharDiff = xs(r.maxComputationTime === 0 ? 0 : Math.min(r.maxComputationTime, 5e3))));
    }
    computeDiff() {
    ...
    _pushTrimWhitespaceCharChange(e, n, r, s, i, l, o) {
      ...
      let u;
      (this.shouldComputeCharChanges && (u = [new je(n, r, n, s, i, l, i, o)]), e.push(new ut(n, n, i, i, u)));
    }
    _mergeTrimWhitespaceCharChange(e, n, r, s, i, l, o) {
      ...
      return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0
        ...
        : c.originalEndLineNumber === n && c.modifiedEndLineNumber === i
          ? (this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new je(n, r, n, s, i, l, i, o)), !0)
          : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === i
            ? ((c.originalEndLineNumber = n),
              (c.modifiedEndLineNumber = i),
              this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new je(n, r, n, s, i, l, i, o)),
              !0)
            : !1;
    }
  }
        ...
        ka(e, (s, i) => {
          r.push(
            O.fromOffsetPairs(
              ...
              i ? i.getStarts() : new _e(n, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + n),
            ),
          );
        }),
        r
    ...
    compute(e, n, r = ct.instance, s) {
      ...
      for (let b = 0; b < e.length; b++)
        for (let d = 0; d < n.length; d++) {
          ...
          } else L === x ? (o.set(b, d, 0), l.set(b, d, 1)) : L === N && (o.set(b, d, 0), l.set(b, d, 2));
          i.set(b, d, L);
        }
      const u = [];
      let c = e.length,
        h = n.length;
      function f(b, d) {
        ((b + 1 !== c || d + 1 !== h) && u.push(new O(new B(b + 1, c), new B(d + 1, h))), (c = b), (h = d));
      }
      let m = e.length - 1,
        p = n.length - 1;
      for (; m >= 0 && p >= 0;) l.get(m, p) === 3 ? (f(m, p), m--, p--) : l.get(m, p) === 1 ? m-- : p--;
    ...
    compute(e, n, r = ct.instance) {
      ...
      e: for (;;) {
        ...
        for (h = d; h <= x; h += 2) {
          ...
          if ((c.set(h, T !== L ? new _s(q, L, E, T - L) : q), u.get(h) === s.length && u.get(h) - h === i.length))
            break e;
        }
      }
      let f = c.get(h);
  ...
  class Ft {
    constructor(e, n, r) {
      ...
      for (let s = this.range.startLineNumber; s <= this.range.endLineNumber; s++) {
        ...
        const u = s === this.range.endLineNumber ? Math.min(this.range.endColumn - 1 - l - o, i.length) : i.length;
    ...
    translateOffset(e, n = "right") {
      ...
      return new H(
        ...
        1 + this.lineStartOffsets[r] + s + (s === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[r]),
      );
    }
    translateRange(e) {
...
`).length >= 15 && Ya(f, (p) => p.length >= 2) >= 2
  ...
  function Za(t, e, n, r) {
    const s = [],
      i = t.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new Pt(u.original, e, u)),
      l = new Set(t.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new Pt(u.modified, n, u))),
      o = new Set();
    for (const u of i) {
      let c = -1,
        h;
      ...
      if (
        (c > 0.9 && h && (l.delete(h), s.push(new ae(u.range, h.range)), o.add(u.source), o.add(h.source)),
        !r.isValid())
      )
  ...
  function Ka(t, e, n, r, s, i) {
        ...
        (o.forEach(d, ({ range: v }) => {
          for (const E of p)
            if (
              ...
              ((E.originalLineRange = new $(E.originalLineRange.startLineNumber, v.endLineNumberExclusive)),
                (E.modifiedLineRange = new $(E.modifiedLineRange.startLineNumber, x.endLineNumberExclusive)),
                N.push(E));
              return;
            }
    ...
    for (let m = 0; m < l.length; m++) {
      const p = l[m],
        ...
        N = f.findLastMonotonous((q) => q.original.startLineNumber < p.original.endLineNumberExclusive),
      ...
      for (E = 0; E < x; E++) {
        ...
        if (q > r.length || w > s.length || c.contains(w) || h.contains(q) || !Ss(r[q - 1], s[w - 1], i)) break;
      }
      E > 0 &&
      ...
      (T > 0 &&
        (h.addRange(new $(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + T)),
        c.addRange(new $(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + T))),
        (E > 0 || T > 0) &&
          (l[m] = new ae(
  ...
  function Ss(t, e, n) {
    ...
    const s = new ys().compute(new Ft([t], new C(1, 1, 1, t.length), !1), new Ft([e], new C(1, 1, 1, e.length), !1), n);
    let i = 0;
      ...
      for (let o = 1; o < r.length; o++) {
        let h = function (m, p) {
          ...
          return (
            ...
            (m.seq1Range.length + m.seq2Range.length > 5 || p.seq1Range.length + p.seq2Range.length > 5)
          );
        };
        const u = r[o],
          c = l[l.length - 1];
...
`);
  ...
  class l1 {
    ...
    computeMoves(e, n, r, s, i, l, o, u) {
      return Ja(e, n, r, s, i, l).map((f) => {
        const m = this.refineDiff(n, r, new O(f.original.toOffsetRange(), f.modified.toOffsetRange()), l, o, u),
    ...
    refineDiff(e, n, r, s, i, l) {
      ...
      return (
        ...
        (m = a1(c, h, m)),
        {
          mappings: m.map((b) => new le(c.translateRange(b.seq1Range), h.translateRange(b.seq2Range))),
    ...
    static toRGBA(e) {
      ...
      if (r === 0) l = o = u = s;
        ...
        const c = s < 0.5 ? s * (1 + r) : s + r - s * r,
          h = 2 * s - c;
        ((l = oe._hue2rgb(h, c, n + 1 / 3)), (o = oe._hue2rgb(h, c, n)), (u = oe._hue2rgb(h, c, n - 1 / 3)));
      }
  ...
  const z = class z {
    ...
    equals(e) {
      return !!e && g.equals(this.rgba, e.rgba) && oe.equals(this.hsla, e.hsla) && Xe.equals(this.hsva, e.hsva);
    }
    ...
    makeOpaque(e) {
      ...
      const { r: n, g: r, b: s, a: i } = this.rgba;
      return new z(
        new g(e.rgba.r - i * (e.rgba.r - n), e.rgba.g - i * (e.rgba.g - r), e.rgba.b - i * (e.rgba.b - s), 1),
      );
    }
    toString() {
  ...
  function g1(t, e) {
    ...
    for (let s = 1; s <= r; s++) {
      ...
      if (l) {
        const o = { startLineNumber: s, startColumn: l[0].length + 1, endLineNumber: s, endColumn: i.length + 1 };
...
`) + 1,
      ...
      ((this._onReturn = n),
        ...
        queueMicrotask(async () => {
          const r = e({
            ...
            emitMany: (s) => {
              for (const i of s) this._producerConsumer.produce({ ok: !0, value: { done: !1, value: i } });
            },
  ...
  class y1 {
    ...
    getIndexOf(e) {
      ...
      let n = 0,
        ...
        l = 0;
      for (; n <= r;)
        if (((s = (n + (r - n) / 2) | 0), (i = this.prefixSum[s]), (l = i - this.values[s]), e < l)) r = s - 1;
        else if (e >= i) n = s + 1;
        else break;
      return new _1(s, e - l);
    }
  ...
  const Fe = class Fe {
    constructor(e = null) {
      ((this._foreignModule = e), (this._requestHandlerBrand = void 0), (this._workerTextModelSyncServer = new v1()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeMoreMinimalEdits(e, n, r) {
      ...
      for (let u = 1; u < n.length; u++)
        C.getEndPosition(n[o].range).equals(C.getStartPosition(n[u].range))
          ? ((n[o].range = C.fromPositions(C.getStartPosition(n[o].range), C.getEndPosition(n[u].range))),
            (n[o].text += n[u].text))
          : (o++, (n[o] = n[u]));
      n.length = o + 1;
      ...
      return (
        typeof l == "number" &&
          i.push({ eol: l, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }),
        i
      );
    }
      ...
      e: for (const u of e) {
        ...
        if (c) {
          for (const h of c.words(l))
            if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > Fe._suggestionsLimit)) break e;
        }
      }
