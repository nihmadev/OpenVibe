...
- **Удобства:** Слэш-команды (/help, /clear, /reset, /cwd, /model, /test, /exit), @-упоминания файлов, перетаскивание изображений в чат, клавиатурные сокращения, поиск по проекту (Ctrl+K), масштабирование окна, звуки завершения, 38 языков интерфейса, 17 тем
