...
const VIDEO_EXTENSIONS = new Set([
  "mp4", "webm", "ogg", "mov", "avi", "mkv", "wmv", "flv", "m4v", "3gp", "avi"
]);
    ...
    <div className="video-viewer">
      <div className="video-viewer__container">
        ...
        <div className="video-viewer__controls">
          ...
          <div
            ref={progressRef}
            className="video-viewer__progress"
            onClick={seek}
          >
            <div className="video-viewer__progress-track">
              <div
                className="video-viewer__progress-fill"
                style={{ width: `${progress}%` }}
              />
              <div
                className="video-viewer__progress-thumb"
                style={{ left: `${progress}%` }}
              />
            </div>
          </div>
          ...
          <div className="video-viewer__controls-row">
            ...
            >
              {muted || volume === 0 ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="11,5 6,9 2,9 2,15 6,15 11,19" /><line x1="23" y1="9" x2="17" y2="15" /><line x1="17" y1="9" x2="23" y2="15" /></svg>
              ) : volume < 0.5 ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="11,5 6,9 2,9 2,15 6,15 11,19" /><path d="M15.54 8.46a5 5 0 0 1 0 7.07" /></svg>
              ) : (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="11,5 6,9 2,9 2,15 6,15 11,19" /><path d="M15.54 8.46a5 5 0 0 1 0 7.07" /><path d="M19.07 4.93a10 10 0 0 1 0 14.14" /></svg>
              )}
            </button>
                ...
                <div className="video-viewer__speed-menu">
                  {[0.25, 0.5, 0.75, 1, 1.25, 1.5, 2].map((rate) => (
                    <button
                      key={rate}
                      className={
                        "video-viewer__speed-opt" +
                        (rate === playbackRate ? " video-viewer__speed-opt--active" : "")
                      }
            ...
            <button
              ...
              title="Fullscreen (F)"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3" /><path d="M21 8V5a2 2 0 0 0-2-2h-3" /><path d="M16 21h3a2 2 0 0 0 2-2v-3" /><path d="M3 16v3a2 2 0 0 0 2 2h3" /></svg>
            </button>
          </div>
        </div>
      </div>
