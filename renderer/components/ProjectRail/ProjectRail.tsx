    ...
    <div className="project-rail">
        ...
        {projects.map((p, i) => {
          ...
          return (
            <button
              key={p.id}
              className={
                "project-rail__tile" + (isActive ? " project-rail__tile--active" : "")
              }
              onClick={() => onPick(p.id)}
            ...
            >
              <span
                className="project-rail__avatar"
                style={{ "--avatar-bg": p.color } as React.CSSProperties}
              >
                {initial(p.name, i)}
              </span>
            </button>
      ...
      <div className="project-rail__bottom">
        <Tooltip text={t("settings")} side="right">
          <button
            className="project-rail__settings"
