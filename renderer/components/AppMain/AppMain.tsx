    ...
    <div className="app__body">
      ...
      <div className="app__content">
        <div className="layout">
          ...
          {/* File tree sidebar */}
          {fileTreeOpen && (
            <aside className="sidebar" style={{ flex: `0 1 ${ftreeWidth}px`, minWidth: 160, maxWidth: 500 }}>
              <FileTree
                cwd={cwd}
