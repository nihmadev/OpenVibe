...
export function describe(item: HistoryItem, t: TranslateFn): { verb: string; file: FileBadgeInfo | null; suffix: string } {
  ...
  switch (item.toolName) {
    ...
    case "write_file":
      return {
        verb: item.ok === false ? t("failedWrite") : pending ? t("writing") : t("created"),
        file,
        suffix: "",
      };
    case "edit_file":
