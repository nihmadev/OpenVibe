...
export function SessionList({
  ...
  return (
    <div
      className={
        "session-list" +
        (open ? " session-list--open" : "") +
        (isResizing ? " session-list--resizing" : "")
      }
      style={{
    ...
    >
      <div className="session-list__inner" style={{ width: `${localWidth}px` }}>
        <div
          className="session-list__resize-handle"
          onMouseDown={handleMouseDown}
        />

        <div className="session-list__head">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px", marginBottom: "12px", marginTop: "4px" }}>
            <div style={{ minWidth: 0 }}>
              <div className="session-list__name">
                {workspaceLabel}
              </div>
              <div className="session-list__path">
                {workspace}
              </div>
            </div>
          </div>
          ...
          <button
            className="session-list__newsession"
            onClick={onNew}
          >
            <svg
              width="14"
