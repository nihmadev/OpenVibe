export const PROVIDER_TEMPLATES = [
  ...
  { id: "google", name: "Google", icon: "google.svg", baseUrl: "https://generativelanguage.googleapis.com/v1beta/openai" },
  ...
  { id: "zai", name: "Z.ai", icon: "zai.svg", baseUrl: "https://api.zai.com/v1" },
